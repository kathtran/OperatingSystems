...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 97 08 00 	movl   $0x897,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 450:	0f b6 80 fc 0a 00 00 	movzbl 0xafc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5ad:	75 09                	jne    5b8 <printf+0x101>
          s = "(null)";
 5af:	c7 45 f4 b0 08 00 00 	movl   $0x8b0,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 679:	a1 18 0b 00 00       	mov    0xb18,%eax
...
free(void *ap)
{
 ...
 744:	a3 18 0b 00 00       	mov    %eax,0xb18
}
 749:	c9                   	leave  
 74a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 797:	e8 ce fe ff ff       	call   66a <free>
  return freep;
 79c:	a1 18 0b 00 00       	mov    0xb18,%eax
}
 7a1:	c9                   	leave  
 7a2:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7b5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7b8:	a1 18 0b 00 00       	mov    0xb18,%eax
 7bd:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7c0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7c4:	75 23                	jne    7e9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7c6:	c7 45 f0 10 0b 00 00 	movl   $0xb10,-0x10(%ebp)
 7cd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7d0:	a3 18 0b 00 00       	mov    %eax,0xb18
 7d5:	a1 18 0b 00 00       	mov    0xb18,%eax
 7da:	a3 10 0b 00 00       	mov    %eax,0xb10
    base.s.size = 0;
 7df:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 7e6:	00 00 00 
  }
 ...
 83c:	a3 18 0b 00 00       	mov    %eax,0xb18
      return (void*)(p + 1);
 ...
 847:	eb 38                	jmp    881 <malloc+0xde>
    ...
    if(p == freep)
 849:	a1 18 0b 00 00       	mov    0xb18,%eax
