...
setbuiltin(char *p)
{
  ...
  if (strncmp("uid", p, 3) == 0) {
    ...
    return (setuid(i));
     ...
     3ab:	e8 9e 0f 00 00       	call   134e <setuid>
  ...
  if (strncmp("gid", p, 3) == 0) {
    ...
    return (setgid(i));
     ...
     41c:	e8 35 0f 00 00       	call   1356 <setgid>
...
getbuiltin(char *p)
{
  ...
  if (strncmp("uid", p, 3) == 0) {
    ...
    printf(2, "%d\n", getuid());
     497:	e8 9a 0e 00 00       	call   1336 <getuid>
  ...
  if (strncmp("gid", p, 3) == 0) {
    ...
    printf(2, "%d\n", getgid());
     4da:	e8 5f 0e 00 00       	call   133e <getgid>
