...
main(int argc, char *argv[])
{
  ...
  1c:	c7 44 24 04 d9 08 00 	movl   $0x8d9,0x4(%esp)
  23:	00 
  24:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  2b:	e8 dd 04 00 00       	call   50d <printf>
    exit();
  30:	e8 18 03 00 00       	call   34d <exit>
  }

  char *months[] = {
  35:	c7 44 24 28 e6 08 00 	movl   $0x8e6,0x28(%esp)
  3c:	00 
  3d:	c7 44 24 2c ea 08 00 	movl   $0x8ea,0x2c(%esp)
  44:	00 
  45:	c7 44 24 30 ee 08 00 	movl   $0x8ee,0x30(%esp)
  4c:	00 
  4d:	c7 44 24 34 f2 08 00 	movl   $0x8f2,0x34(%esp)
  54:	00 
  55:	c7 44 24 38 f6 08 00 	movl   $0x8f6,0x38(%esp)
  5c:	00 
  5d:	c7 44 24 3c fa 08 00 	movl   $0x8fa,0x3c(%esp)
  64:	00 
  65:	c7 44 24 40 fe 08 00 	movl   $0x8fe,0x40(%esp)
  6c:	00 
  6d:	c7 44 24 44 02 09 00 	movl   $0x902,0x44(%esp)
  74:	00 
  75:	c7 44 24 48 06 09 00 	movl   $0x906,0x48(%esp)
  7c:	00 
  7d:	c7 44 24 4c 0a 09 00 	movl   $0x90a,0x4c(%esp)
  84:	00 
  85:	c7 44 24 50 0e 09 00 	movl   $0x90e,0x50(%esp)
  8c:	00 
  8d:	c7 44 24 54 12 09 00 	movl   $0x912,0x54(%esp)
  94:	00 
    "Oct",
    "Nov",
    "Dec"
  ...
  cc:	c7 44 24 04 16 09 00 	movl   $0x916,0x4(%esp)
  d3:	00 
  d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  db:	e8 2d 04 00 00       	call   50d <printf>
         months[r.month-1], r.day, r.hour, r.minute, r.second, r.year);
...
putc(int fd, char c)
{
 ...
 44e:	e8 1a ff ff ff       	call   36d <write>
}
 453:	c9                   	leave  
 454:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a6:	0f b6 80 7c 0b 00 00 	movzbl 0xb7c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 603:	75 09                	jne    60e <printf+0x101>
          s = "(null)";
 605:	c7 45 f4 2d 09 00 00 	movl   $0x92d,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6cf:	a1 98 0b 00 00       	mov    0xb98,%eax
...
free(void *ap)
{
 ...
 79a:	a3 98 0b 00 00       	mov    %eax,0xb98
}
 79f:	c9                   	leave  
 7a0:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7c0:	e8 10 fc ff ff       	call   3d5 <sbrk>
 ...
 7ed:	e8 ce fe ff ff       	call   6c0 <free>
  return freep;
 7f2:	a1 98 0b 00 00       	mov    0xb98,%eax
}
 7f7:	c9                   	leave  
 7f8:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 80b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 80e:	a1 98 0b 00 00       	mov    0xb98,%eax
 813:	89 45 f0             	mov    %eax,-0x10(%ebp)
 816:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 81a:	75 23                	jne    83f <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 81c:	c7 45 f0 90 0b 00 00 	movl   $0xb90,-0x10(%ebp)
 823:	8b 45 f0             	mov    -0x10(%ebp),%eax
 826:	a3 98 0b 00 00       	mov    %eax,0xb98
 82b:	a1 98 0b 00 00       	mov    0xb98,%eax
 830:	a3 90 0b 00 00       	mov    %eax,0xb90
    base.s.size = 0;
 835:	c7 05 94 0b 00 00 00 	movl   $0x0,0xb94
 83c:	00 00 00 
  }
 ...
 892:	a3 98 0b 00 00       	mov    %eax,0xb98
      return (void*)(p + 1);
 ...
 89d:	eb 38                	jmp    8d7 <malloc+0xde>
    ...
    if(p == freep)
 89f:	a1 98 0b 00 00       	mov    0xb98,%eax
