...
8010003a:	c7 44 24 04 34 8a 10 	movl   $0x80108a34,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
80100049:	e8 6a 52 00 00       	call   801052b8 <initlock>
...
801000bd:	e8 17 52 00 00       	call   801052d9 <acquire>
...
80100104:	e8 32 52 00 00       	call   8010533b <release>
        return b;
...
8010011f:	e8 03 4c 00 00       	call   80104d27 <sleep>
      goto loop;
...
8010017c:	e8 ba 51 00 00       	call   8010533b <release>
      return b;
...
80100198:	c7 04 24 3b 8a 10 80 	movl   $0x80108a3b,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 4c 8a 10 80 	movl   $0x80108a4c,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 53 8a 10 80 	movl   $0x80108a53,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
8010023c:	e8 98 50 00 00       	call   801052d9 <acquire>
...
8010029d:	e8 61 4b 00 00       	call   80104e03 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
801002a9:	e8 8d 50 00 00       	call   8010533b <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 19 4f 00 00       	call   801052d9 <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 5a 8a 10 80 	movl   $0x80108a5a,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec 63 8a 10 80 	movl   $0x80108a63,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 03 4e 00 00       	call   8010533b <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 6a 8a 10 80 	movl   $0x80108a6a,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 79 8a 10 80 	movl   $0x80108a79,(%esp)
...
8010058f:	e8 f6 4d 00 00       	call   8010538a <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 7b 8a 10 80 	movl   $0x80108a7b,(%esp)
...
80100699:	c7 04 24 7f 8a 10 80 	movl   $0x80108a7f,(%esp)
...
801006cd:	e8 2a 4f 00 00       	call   801055fc <memmove>
    pos -= 80;
...
801006fc:	e8 2c 4e 00 00       	call   8010552d <memset>
  }
...
801007dc:	e8 f8 4a 00 00       	call   801052d9 <acquire>
  while((c = getc()) >= 0){
...
80100917:	e8 e7 44 00 00       	call   80104e03 <wakeup>
        }
      }
      break;
...
80100938:	e8 fe 49 00 00       	call   8010533b <release>
  if(doprocdump) {
8010093d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80100941:	74 05                	je     80100948 <consoleintr+0x180>
    procdump();  // now call procdump() wo. cons.lock held
80100943:	e8 61 45 00 00       	call   80104ea9 <procdump>
  }
}
80100948:	c9                   	leave  
80100949:	c3                   	ret    
...
80100968:	e8 6c 49 00 00       	call   801052d9 <acquire>
  while(n > 0){
...
80100988:	e8 ae 49 00 00       	call   8010533b <release>
        ilock(ip);
...
801009b1:	e8 71 43 00 00       	call   80104d27 <sleep>
...
80100a2d:	e8 09 49 00 00       	call   8010533b <release>
  ilock(ip);
...
80100a61:	e8 73 48 00 00       	call   801052d9 <acquire>
  for(i = 0; i < n; i++)
...
80100a9b:	e8 9b 48 00 00       	call   8010533b <release>
  ilock(ip);
...
80100ab6:	c7 44 24 04 92 8a 10 	movl   $0x80108a92,0x4(%esp)
80100abd:	80 
80100abe:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100ac5:	e8 ee 47 00 00       	call   801052b8 <initlock>
...
80100b89:	e9 69 03 00 00       	jmp    80100ef7 <exec+0x3ed>
  ...
  if((pgdir = setupkvm()) == 0)
80100b8e:	e8 34 76 00 00       	call   801081c7 <setupkvm>
...
80100c2f:	e8 61 79 00 00       	call   80108595 <allocuvm>
...
80100c6d:	e8 38 78 00 00       	call   801084aa <loaduvm>
...
80100cdb:	e8 b5 78 00 00       	call   80108595 <allocuvm>
...
80100d00:	e8 c0 7a 00 00       	call   801087c5 <clearpteu>
  sp = sz;
...
80100d36:	e8 5c 4a 00 00       	call   80105797 <strlen>
...
80100d5f:	e8 33 4a 00 00       	call   80105797 <strlen>
...
80100d8f:	e8 f6 7b 00 00       	call   8010898a <copyout>
...
80100e36:	e8 4f 7b 00 00       	call   8010898a <copyout>
...
80100e8e:	e8 ba 48 00 00       	call   8010574d <safestrcpy>
...
80100ee0:	e8 d3 73 00 00       	call   801082b8 <switchuvm>
  freevm(oldpgdir);
80100ee5:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ee8:	89 04 24             	mov    %eax,(%esp)
80100eeb:	e8 3b 78 00 00       	call   8010872b <freevm>
  return 0;
...
80100f03:	e8 23 78 00 00       	call   8010872b <freevm>
  if(ip){
...
80100f2b:	c7 44 24 04 9a 8a 10 	movl   $0x80108a9a,0x4(%esp)
80100f32:	80 
80100f33:	c7 04 24 40 18 11 80 	movl   $0x80111840,(%esp)
80100f3a:	e8 79 43 00 00       	call   801052b8 <initlock>
}
80100f3f:	c9                   	leave  
80100f40:	c3                   	ret    
...
80100f4e:	e8 86 43 00 00       	call   801052d9 <acquire>
...
80100f77:	e8 bf 43 00 00       	call   8010533b <release>
      return f;
...
80100f95:	e8 a1 43 00 00       	call   8010533b <release>
  return 0;
...
80100fae:	e8 26 43 00 00       	call   801052d9 <acquire>
  if(f->ref < 1)
...
80100fbb:	7f 0c                	jg     80100fc9 <filedup+0x28>
    panic("filedup");
80100fbd:	c7 04 24 a1 8a 10 80 	movl   $0x80108aa1,(%esp)
...
80100fdf:	e8 57 43 00 00       	call   8010533b <release>
  return f;
...
80100ff6:	e8 de 42 00 00       	call   801052d9 <acquire>
  if(f->ref < 1)
...
80101003:	7f 0c                	jg     80101011 <fileclose+0x28>
    panic("fileclose");
80101005:	c7 04 24 a9 8a 10 80 	movl   $0x80108aa9,(%esp)
...
80101031:	e8 05 43 00 00       	call   8010533b <release>
...
8010107b:	e8 bb 42 00 00       	call   8010533b <release>
...
801011ba:	eb 0c                	jmp    801011c8 <fileread+0xba>
  ...
  panic("fileread");
801011bc:	c7 04 24 b3 8a 10 80 	movl   $0x80108ab3,(%esp)
...
801012c8:	c7 04 24 bc 8a 10 80 	movl   $0x80108abc,(%esp)
...
801012f8:	eb 0c                	jmp    80101306 <filewrite+0x13c>
  ...
  panic("filewrite");
801012fa:	c7 04 24 cc 8a 10 80 	movl   $0x80108acc,(%esp)
...
80101340:	e8 b7 42 00 00       	call   801055fc <memmove>
  brelse(bp);
...
80101386:	e8 a2 41 00 00       	call   8010552d <memset>
  log_write(bp);
...
801014d3:	c7 04 24 d8 8a 10 80 	movl   $0x80108ad8,(%esp)
...
80101562:	c7 04 24 ee 8a 10 80 	movl   $0x80108aee,(%esp)
...
801015b5:	c7 44 24 04 01 8b 10 	movl   $0x80108b01,0x4(%esp)
801015bc:	80 
801015bd:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801015c4:	e8 ef 3c 00 00       	call   801052b8 <initlock>
  readsb(dev, &sb);
...
80101629:	c7 04 24 08 8b 10 80 	movl   $0x80108b08,(%esp)
...
801016ac:	e8 7c 3e 00 00       	call   8010552d <memset>
      dip->type = type;
...
80101704:	c7 04 24 5b 8b 10 80 	movl   $0x80108b5b,(%esp)
...
801017b3:	e8 44 3e 00 00       	call   801055fc <memmove>
  log_write(bp);
...
801017dd:	e8 f7 3a 00 00       	call   801052d9 <acquire>
...
80101827:	e8 0f 3b 00 00       	call   8010533b <release>
      return ip;
...
8010185a:	c7 04 24 6d 8b 10 80 	movl   $0x80108b6d,(%esp)
...
80101898:	e8 9e 3a 00 00       	call   8010533b <release>
...
801018af:	e8 25 3a 00 00       	call   801052d9 <acquire>
  ip->ref++;
...
801018ca:	e8 6c 3a 00 00       	call   8010533b <release>
  return ip;
...
801018e8:	7f 0c                	jg     801018f6 <ilock+0x22>
    panic("ilock");
801018ea:	c7 04 24 7d 8b 10 80 	movl   $0x80108b7d,(%esp)
801018f1:	e8 44 ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801018f6:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801018fd:	e8 d7 39 00 00       	call   801052d9 <acquire>
...
80101912:	e8 10 34 00 00       	call   80104d27 <sleep>
...
8010193c:	e8 fa 39 00 00       	call   8010533b <release>
...
801019ed:	e8 0a 3c 00 00       	call   801055fc <memmove>
    brelse(bp);
...
80101a18:	75 0c                	jne    80101a26 <ilock+0x152>
      panic("ilock: no type");
80101a1a:	c7 04 24 83 8b 10 80 	movl   $0x80108b83,(%esp)
...
80101a49:	7f 0c                	jg     80101a57 <iunlock+0x2f>
    panic("iunlock");
80101a4b:	c7 04 24 92 8b 10 80 	movl   $0x80108b92,(%esp)
80101a52:	e8 e3 ea ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
80101a57:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80101a5e:	e8 76 38 00 00       	call   801052d9 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a7a:	e8 84 33 00 00       	call   80104e03 <wakeup>
  release(&icache.lock);
80101a7f:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80101a86:	e8 b0 38 00 00       	call   8010533b <release>
}
80101a8b:	c9                   	leave  
80101a8c:	c3                   	ret    
...
80101a9a:	e8 3a 38 00 00       	call   801052d9 <acquire>
...
80101ad6:	74 0c                	je     80101ae4 <iput+0x57>
      panic("iput busy");
80101ad8:	c7 04 24 9a 8b 10 80 	movl   $0x80108b9a,(%esp)
...
80101afc:	e8 3a 38 00 00       	call   8010533b <release>
    itrunc(ip);
...
80101b27:	e8 ad 37 00 00       	call   801052d9 <acquire>
    ip->flags = 0;
...
80101b3c:	e8 c2 32 00 00       	call   80104e03 <wakeup>
  }
  ip->ref--;
...
80101b57:	e8 df 37 00 00       	call   8010533b <release>
}
80101b5c:	c9                   	leave  
80101b5d:	c3                   	ret    
...
80101c77:	c7 04 24 a4 8b 10 80 	movl   $0x80108ba4,(%esp)
...
80101f18:	e8 df 36 00 00       	call   801055fc <memmove>
    brelse(bp);
...
80102077:	e8 80 35 00 00       	call   801055fc <memmove>
    log_write(bp);
...
801020f5:	e8 a5 35 00 00       	call   8010569f <strncmp>
}
801020fa:	c9                   	leave  
801020fb:	c3                   	ret    
...
8010210f:	c7 04 24 b7 8b 10 80 	movl   $0x80108bb7,(%esp)
...
8010214b:	74 0c                	je     80102159 <dirlookup+0x5d>
      panic("dirlink read");
8010214d:	c7 04 24 c9 8b 10 80 	movl   $0x80108bc9,(%esp)
...
80102230:	74 0c                	je     8010223e <dirlink+0x79>
      panic("dirlink read");
80102232:	c7 04 24 c9 8b 10 80 	movl   $0x80108bc9,(%esp)
...
80102277:	e8 79 34 00 00       	call   801056f5 <strncpy>
  de.inum = inum;
...
801022a7:	74 0c                	je     801022b5 <dirlink+0xf0>
    panic("dirlink");
801022a9:	c7 04 24 d6 8b 10 80 	movl   $0x80108bd6,(%esp)
...
8010232e:	e8 c9 32 00 00       	call   801055fc <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
80102349:	e8 ae 32 00 00       	call   801055fc <memmove>
    name[len] = 0;
...
80102598:	c7 44 24 04 de 8b 10 	movl   $0x80108bde,0x4(%esp)
8010259f:	80 
801025a0:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
801025a7:	e8 0c 2d 00 00       	call   801052b8 <initlock>
  picenable(IRQ_IDE);
...
80102642:	75 0c                	jne    80102650 <idestart+0x18>
    panic("idestart");
80102644:	c7 04 24 e2 8b 10 80 	movl   $0x80108be2,(%esp)
...
8010265d:	c7 04 24 eb 8b 10 80 	movl   $0x80108beb,(%esp)
...
80102685:	c7 04 24 e2 8b 10 80 	movl   $0x80108be2,(%esp)
...
801027a1:	e8 33 2b 00 00       	call   801052d9 <acquire>
  if((b = idequeue) == 0){
...
801027bb:	e8 7b 2b 00 00       	call   8010533b <release>
...
8010282e:	e8 d0 25 00 00       	call   80104e03 <wakeup>
...
80102850:	e8 e6 2a 00 00       	call   8010533b <release>
}
80102855:	c9                   	leave  
80102856:	c3                   	ret    
...
80102869:	c7 04 24 fd 8b 10 80 	movl   $0x80108bfd,(%esp)
...
80102882:	c7 04 24 11 8c 10 80 	movl   $0x80108c11,(%esp)
...
8010290f:	e8 13 24 00 00       	call   80104d27 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
80102928:	e8 0e 2a 00 00       	call   8010533b <release>
}
8010292d:	c9                   	leave  
8010292e:	c3                   	ret    
...
801029b6:	c7 04 24 44 8c 10 80 	movl   $0x80108c44,(%esp)
...
80102a70:	c7 44 24 04 76 8c 10 	movl   $0x80108c76,0x4(%esp)
80102a77:	80 
80102a78:	c7 04 24 40 32 11 80 	movl   $0x80113240,(%esp)
80102a7f:	e8 34 28 00 00       	call   801052b8 <initlock>
  kmem.use_lock = 0;
...
80102b11:	81 7d 08 7c 66 11 80 	cmpl   $0x8011667c,0x8(%ebp)
...
80102b2a:	76 0c                	jbe    80102b38 <kfree+0x39>
    panic("kfree");
80102b2c:	c7 04 24 7b 8c 10 80 	movl   $0x80108c7b,(%esp)
...
80102b4e:	e8 da 29 00 00       	call   8010552d <memset>
...
80102b63:	e8 71 27 00 00       	call   801052d9 <acquire>
  r = (struct run*)v;
...
80102b91:	e8 a5 27 00 00       	call   8010533b <release>
}
80102b96:	c9                   	leave  
80102b97:	c3                   	ret    
...
80102bae:	e8 26 27 00 00       	call   801052d9 <acquire>
  r = kmem.freelist;
...
80102bdb:	e8 5b 27 00 00       	call   8010533b <release>
  return (char*)r;
...
80102f5b:	c7 04 24 84 8c 10 80 	movl   $0x80108c84,(%esp)
...
801031be:	e8 e1 23 00 00       	call   801055a4 <memcmp>
...
801032be:	c7 44 24 04 b0 8c 10 	movl   $0x80108cb0,0x4(%esp)
801032c5:	80 
801032c6:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
801032cd:	e8 e6 1f 00 00       	call   801052b8 <initlock>
  readsb(dev, &sb);
...
80103377:	e8 80 22 00 00       	call   801055fc <memmove>
...
801034c9:	e8 0b 1e 00 00       	call   801052d9 <acquire>
  while(1){
    if(log.committing){
...
801034e6:	e8 3c 18 00 00       	call   80104d27 <sleep>
...
8010351a:	e8 08 18 00 00       	call   80104d27 <sleep>
...
80103535:	e8 01 1e 00 00       	call   8010533b <release>
      break;
...
80103554:	e8 80 1d 00 00       	call   801052d9 <acquire>
  log.outstanding -= 1;
...
8010356f:	c7 04 24 b4 8c 10 80 	movl   $0x80108cb4,(%esp)
...
8010359e:	e8 60 18 00 00       	call   80104e03 <wakeup>
  }
  release(&log.lock);
801035a3:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
801035aa:	e8 8c 1d 00 00       	call   8010533b <release>
...
8010365e:	e8 99 1f 00 00       	call   801055fc <memmove>
...
801036e9:	c7 04 24 c3 8c 10 80 	movl   $0x80108cc3,(%esp)
...
801036fe:	c7 04 24 d9 8c 10 80 	movl   $0x80108cd9,(%esp)
80103705:	e8 30 ce ff ff       	call   8010053a <panic>

  acquire(&log.lock);
8010370a:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
80103711:	e8 c3 1b 00 00       	call   801052d9 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103788:	e8 ae 1b 00 00       	call   8010533b <release>
}
8010378d:	c9                   	leave  
8010378e:	c3                   	ret    
...
80103804:	c7 04 24 f4 8c 10 80 	movl   $0x80108cf4,(%esp)
...
8010381f:	e8 42 37 00 00       	call   80106f66 <uartinit>
  pinit();         // process table
80103824:	e8 6a 0b 00 00       	call   80104393 <pinit>
  tvinit();        // trap vectors
80103829:	e8 ea 32 00 00       	call   80106b18 <tvinit>
  binit();         // buffer cache
...
80103846:	e8 18 32 00 00       	call   80106a63 <timerinit>
...
80103864:	e8 98 0c 00 00       	call   80104501 <userinit>
...
80103871:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
80103874:	e8 22 4a 00 00       	call   8010829b <switchkvm>
  seginit();
80103879:	e8 99 43 00 00       	call   80107c17 <seginit>
  lapicinit();
...
8010389e:	c7 04 24 0b 8d 10 80 	movl   $0x80108d0b,(%esp)
801038a5:	e8 f6 ca ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
801038aa:	e8 dd 33 00 00       	call   80106c8c <idtinit>
...
801038ca:	e8 b8 12 00 00       	call   80104b87 <scheduler>
...
801038fc:	e8 fb 1c 00 00       	call   801055fc <memmove>
...
80103a7d:	00 
80103a7e:	c7 44 24 04 1c 8d 10 	movl   $0x80108d1c,0x4(%esp)
80103a85:	80 
80103a86:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a89:	89 04 24             	mov    %eax,(%esp)
80103a8c:	e8 13 1b 00 00       	call   801055a4 <memcmp>
...
80103bbe:	00 
80103bbf:	c7 44 24 04 21 8d 10 	movl   $0x80108d21,0x4(%esp)
80103bc6:	80 
80103bc7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103bca:	89 04 24             	mov    %eax,(%esp)
80103bcd:	e8 d2 19 00 00       	call   801055a4 <memcmp>
...
80103c9b:	8b 04 85 64 8d 10 80 	mov    -0x7fef729c(,%eax,4),%eax
...
80103cd4:	c7 04 24 26 8d 10 80 	movl   $0x80108d26,(%esp)
...
80103d67:	c7 04 24 44 8d 10 80 	movl   $0x80108d44,(%esp)
...
80104060:	c7 44 24 04 78 8d 10 	movl   $0x80108d78,0x4(%esp)
80104067:	80 
80104068:	89 04 24             	mov    %eax,(%esp)
8010406b:	e8 48 12 00 00       	call   801052b8 <initlock>
  (*f0)->type = FD_PIPE;
...
80104117:	e8 bd 11 00 00       	call   801052d9 <acquire>
  if(writable){
...
8010413a:	e8 c4 0c 00 00       	call   80104e03 <wakeup>
...
80104159:	e8 a5 0c 00 00       	call   80104e03 <wakeup>
  }
...
8010417e:	e8 b8 11 00 00       	call   8010533b <release>
    kfree((char*)p);
...
80104196:	e8 a0 11 00 00       	call   8010533b <release>
}
8010419b:	c9                   	leave  
8010419c:	c3                   	ret    
...
801041a9:	e8 2b 11 00 00       	call   801052d9 <acquire>
  for(i = 0; i < n; i++){
...
801041dc:	e8 5a 11 00 00       	call   8010533b <release>
        return -1;
...
801041f6:	e8 08 0c 00 00       	call   80104e03 <wakeup>
...
8010420e:	e8 14 0b 00 00       	call   80104d27 <sleep>
{
  int i;
...
80104277:	e8 87 0b 00 00       	call   80104e03 <wakeup>
  release(&p->lock);
8010427c:	8b 45 08             	mov    0x8(%ebp),%eax
8010427f:	89 04 24             	mov    %eax,(%esp)
80104282:	e8 b4 10 00 00       	call   8010533b <release>
  return n;
...
80104299:	e8 3b 10 00 00       	call   801052d9 <acquire>
...
801042b3:	e8 83 10 00 00       	call   8010533b <release>
      return -1;
...
801042d5:	e8 4d 0a 00 00       	call   80104d27 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80104364:	e8 9a 0a 00 00       	call   80104e03 <wakeup>
  release(&p->lock);
80104369:	8b 45 08             	mov    0x8(%ebp),%eax
8010436c:	89 04 24             	mov    %eax,(%esp)
8010436f:	e8 c7 0f 00 00       	call   8010533b <release>
  return i;
...
80104399:	c7 44 24 04 7d 8d 10 	movl   $0x80108d7d,0x4(%esp)
801043a0:	80 
801043a1:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801043a8:	e8 0b 0f 00 00       	call   801052b8 <initlock>
}
801043ad:	c9                   	leave  
801043ae:	c3                   	ret    
...
801043bc:	e8 18 0f 00 00       	call   801052d9 <acquire>
#ifdef USE_CS333_SCHEDULER
  p = ptable.pFreeList;
801043c1:	a1 c0 5d 11 80       	mov    0x80115dc0,%eax
801043c6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if (p) {
801043c9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801043cd:	74 1d                	je     801043ec <allocproc+0x3d>
    p = ptable.pFreeList->next;
801043cf:	a1 c0 5d 11 80       	mov    0x80115dc0,%eax
801043d4:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801043da:	89 45 f4             	mov    %eax,-0xc(%ebp)
    p->next = 0;
801043dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043e0:	c7 80 88 00 00 00 00 	movl   $0x0,0x88(%eax)
801043e7:	00 00 00 
    goto found;
801043ea:	eb 3b                	jmp    80104427 <allocproc+0x78>
  }
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801043ec:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
801043f3:	eb 13                	jmp    80104408 <allocproc+0x59>
    if(p->state == UNUSED)
801043f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043f8:	8b 40 0c             	mov    0xc(%eax),%eax
801043fb:	85 c0                	test   %eax,%eax
801043fd:	75 02                	jne    80104401 <allocproc+0x52>
      goto found;
801043ff:	eb 26                	jmp    80104427 <allocproc+0x78>
  if (p) {
    p = ptable.pFreeList->next;
    p->next = 0;
    goto found;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104401:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80104408:	81 7d f4 b4 5d 11 80 	cmpl   $0x80115db4,-0xc(%ebp)
8010440f:	72 e4                	jb     801043f5 <allocproc+0x46>
    if(p->state == UNUSED)
      goto found;
#endif
  release(&ptable.lock);
80104411:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104418:	e8 1e 0f 00 00       	call   8010533b <release>
  return 0;
8010441d:	b8 00 00 00 00       	mov    $0x0,%eax
80104422:	e9 d8 00 00 00       	jmp    801044ff <allocproc+0x150>
...
8010442a:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
  p->pid = nextpid++;
80104431:	a1 08 c0 10 80       	mov    0x8010c008,%eax
80104436:	8d 50 01             	lea    0x1(%eax),%edx
80104439:	89 15 08 c0 10 80    	mov    %edx,0x8010c008
8010443f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104442:	89 42 10             	mov    %eax,0x10(%edx)
  release(&ptable.lock);
80104445:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
8010444c:	e8 ea 0e 00 00       	call   8010533b <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80104451:	e8 42 e7 ff ff       	call   80102b98 <kalloc>
80104456:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104459:	89 42 08             	mov    %eax,0x8(%edx)
8010445c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010445f:	8b 40 08             	mov    0x8(%eax),%eax
80104462:	85 c0                	test   %eax,%eax
80104464:	75 34                	jne    8010449a <allocproc+0xeb>
    p->state = UNUSED;
80104466:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104469:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  #ifdef USE_CS333_SCHEDULER
    acquire(&ptable.lock);
80104470:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104477:	e8 5d 0e 00 00       	call   801052d9 <acquire>
    putOnFreeList(p);
8010447c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010447f:	89 04 24             	mov    %eax,(%esp)
80104482:	e8 88 0c 00 00       	call   8010510f <putOnFreeList>
    release(&ptable.lock);
80104487:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
8010448e:	e8 a8 0e 00 00       	call   8010533b <release>
  #endif
    return 0;
80104493:	b8 00 00 00 00       	mov    $0x0,%eax
80104498:	eb 65                	jmp    801044ff <allocproc+0x150>
  }
...
801044b2:	89 50 24             	mov    %edx,0x24(%eax)
...
801044b9:	ba d3 6a 10 80       	mov    $0x80106ad3,%edx
...
801044cd:	89 50 28             	mov    %edx,0x28(%eax)
  memset(p->context, 0, sizeof *p->context);
801044d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044d3:	8b 40 28             	mov    0x28(%eax),%eax
...
801044e9:	e8 3f 10 00 00       	call   8010552d <memset>
  p->context->eip = (uint)forkret;
801044ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044f1:	8b 40 28             	mov    0x28(%eax),%eax
801044f4:	ba e8 4c 10 80       	mov    $0x80104ce8,%edx
...
80104504:	83 ec 28             	sub    $0x28,%esp
  ...
  int i;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104507:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
8010450e:	eb 1c                	jmp    8010452c <userinit+0x2b>
    if(p->state == UNUSED) {
80104510:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104513:	8b 40 0c             	mov    0xc(%eax),%eax
80104516:	85 c0                	test   %eax,%eax
80104518:	75 0b                	jne    80104525 <userinit+0x24>
      putOnFreeList(p);
8010451a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010451d:	89 04 24             	mov    %eax,(%esp)
80104520:	e8 ea 0b 00 00       	call   8010510f <putOnFreeList>
  struct proc *p;
  extern char _binary_initcode_start[], _binary_initcode_size[];
  ...
  int i;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104525:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
8010452c:	81 7d f4 b4 5d 11 80 	cmpl   $0x80115db4,-0xc(%ebp)
80104533:	72 db                	jb     80104510 <userinit+0xf>
    if(p->state == UNUSED) {
      putOnFreeList(p);
    }
  }
  ptable.TimeToReset = CountToReset;
80104535:	a1 04 c0 10 80       	mov    0x8010c004,%eax
8010453a:	a3 c4 5d 11 80       	mov    %eax,0x80115dc4
  for (i = 0; i < 3; i++)
8010453f:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104546:	eb 17                	jmp    8010455f <userinit+0x5e>
    ptable.pReadyList[i] = 0;
80104548:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010454b:	05 0c 09 00 00       	add    $0x90c,%eax
80104550:	c7 04 85 84 39 11 80 	movl   $0x0,-0x7feec67c(,%eax,4)
80104557:	00 00 00 00 
    if(p->state == UNUSED) {
      putOnFreeList(p);
    }
  }
  ptable.TimeToReset = CountToReset;
  for (i = 0; i < 3; i++)
8010455b:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
8010455f:	83 7d f0 02          	cmpl   $0x2,-0x10(%ebp)
80104563:	7e e3                	jle    80104548 <userinit+0x47>
    ptable.pReadyList[i] = 0;
#endif
  
  p = allocproc();
80104565:	e8 45 fe ff ff       	call   801043af <allocproc>
8010456a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
8010456d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104570:	a3 68 c6 10 80       	mov    %eax,0x8010c668
  if((p->pgdir = setupkvm()) == 0)
80104575:	e8 4d 3c 00 00       	call   801081c7 <setupkvm>
8010457a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010457d:	89 42 04             	mov    %eax,0x4(%edx)
80104580:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104583:	8b 40 04             	mov    0x4(%eax),%eax
80104586:	85 c0                	test   %eax,%eax
80104588:	75 0c                	jne    80104596 <userinit+0x95>
    panic("userinit: out of memory?");
8010458a:	c7 04 24 84 8d 10 80 	movl   $0x80108d84,(%esp)
80104591:	e8 a4 bf ff ff       	call   8010053a <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80104596:	ba 2c 00 00 00       	mov    $0x2c,%edx
8010459b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010459e:	8b 40 04             	mov    0x4(%eax),%eax
801045a1:	89 54 24 08          	mov    %edx,0x8(%esp)
801045a5:	c7 44 24 04 00 c5 10 	movl   $0x8010c500,0x4(%esp)
801045ac:	80 
801045ad:	89 04 24             	mov    %eax,(%esp)
801045b0:	e8 6a 3e 00 00       	call   8010841f <inituvm>
  p->sz = PGSIZE;
801045b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045b8:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
801045be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045c1:	8b 40 24             	mov    0x24(%eax),%eax
801045c4:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
801045cb:	00 
801045cc:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801045d3:	00 
801045d4:	89 04 24             	mov    %eax,(%esp)
801045d7:	e8 51 0f 00 00       	call   8010552d <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
801045dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045df:	8b 40 24             	mov    0x24(%eax),%eax
801045e2:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
801045e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045eb:	8b 40 24             	mov    0x24(%eax),%eax
801045ee:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
801045f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045f7:	8b 40 24             	mov    0x24(%eax),%eax
801045fa:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045fd:	8b 52 24             	mov    0x24(%edx),%edx
80104600:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104604:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80104608:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010460b:	8b 40 24             	mov    0x24(%eax),%eax
8010460e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104611:	8b 52 24             	mov    0x24(%edx),%edx
80104614:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104618:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
8010461c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010461f:	8b 40 24             	mov    0x24(%eax),%eax
80104622:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80104629:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010462c:	8b 40 24             	mov    0x24(%eax),%eax
8010462f:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80104636:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104639:	8b 40 24             	mov    0x24(%eax),%eax
8010463c:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  // Initialize UID and GID
  p->uid = UID_DEFAULT;
80104643:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104646:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  p->gid = GID_DEFAULT;
8010464d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104650:	c7 40 18 00 00 00 00 	movl   $0x0,0x18(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
80104657:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010465a:	83 c0 78             	add    $0x78,%eax
8010465d:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104664:	00 
80104665:	c7 44 24 04 9d 8d 10 	movl   $0x80108d9d,0x4(%esp)
8010466c:	80 
8010466d:	89 04 24             	mov    %eax,(%esp)
80104670:	e8 d8 10 00 00       	call   8010574d <safestrcpy>
  p->cwd = namei("/");
80104675:	c7 04 24 a6 8d 10 80 	movl   $0x80108da6,(%esp)
8010467c:	e8 04 de ff ff       	call   80102485 <namei>
80104681:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104684:	89 42 74             	mov    %eax,0x74(%edx)
...
80104694:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
8010469a:	8d 90 0c 09 00 00    	lea    0x90c(%eax),%edx
801046a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046a3:	89 04 95 84 39 11 80 	mov    %eax,-0x7feec67c(,%edx,4)
  p->next = 0;
801046aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046ad:	c7 80 88 00 00 00 00 	movl   $0x0,0x88(%eax)
801046b4:	00 00 00 
  p->priority = 1;
801046b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046ba:	c7 80 8c 00 00 00 01 	movl   $0x1,0x8c(%eax)
801046c1:	00 00 00 
#endif
}
801046c4:	c9                   	leave  
...
80104728:	89 54 24 08          	mov    %edx,0x8(%esp)
8010472c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010472f:	89 54 24 04          	mov    %edx,0x4(%esp)
80104733:	89 04 24             	mov    %eax,(%esp)
80104736:	e8 34 3f 00 00       	call   8010866f <deallocuvm>
8010473b:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010473e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104742:	75 07                	jne    8010474b <growproc+0x85>
      return -1;
80104744:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104749:	eb 1e                	jmp    80104769 <growproc+0xa3>
  }
  proc->sz = sz;
8010474b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104751:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104754:	89 10                	mov    %edx,(%eax)
  switchuvm(proc);
80104756:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010475c:	89 04 24             	mov    %eax,(%esp)
8010475f:	e8 54 3b 00 00       	call   801082b8 <switchuvm>
  return 0;
...
80104771:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
80104774:	e8 36 fc ff ff       	call   801043af <allocproc>
...
80104787:	e9 b1 01 00 00       	jmp    8010493d <fork+0x1d2>
...
801047a4:	e8 62 40 00 00       	call   8010880b <copyuvm>
801047a9:	8b 55 e0             	mov    -0x20(%ebp),%edx
801047ac:	89 42 04             	mov    %eax,0x4(%edx)
801047af:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047b2:	8b 40 04             	mov    0x4(%eax),%eax
801047b5:	85 c0                	test   %eax,%eax
801047b7:	75 4f                	jne    80104808 <fork+0x9d>
    kfree(np->kstack);
801047b9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047bc:	8b 40 08             	mov    0x8(%eax),%eax
801047bf:	89 04 24             	mov    %eax,(%esp)
801047c2:	e8 38 e3 ff ff       	call   80102aff <kfree>
    np->kstack = 0;
801047c7:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047ca:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
801047d1:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047d4:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
#ifdef USE_CS333_SCHEDULER
    acquire(&ptable.lock);
801047db:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801047e2:	e8 f2 0a 00 00       	call   801052d9 <acquire>
    putOnFreeList(np);
801047e7:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047ea:	89 04 24             	mov    %eax,(%esp)
801047ed:	e8 1d 09 00 00       	call   8010510f <putOnFreeList>
    release(&ptable.lock);
801047f2:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801047f9:	e8 3d 0b 00 00       	call   8010533b <release>
#endif
    return -1;
801047fe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104803:	e9 35 01 00 00       	jmp    8010493d <fork+0x1d2>
  }
  np->sz = proc->sz;
80104808:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010480e:	8b 10                	mov    (%eax),%edx
80104810:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104813:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
80104815:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010481c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010481f:	89 50 20             	mov    %edx,0x20(%eax)
  *np->tf = *proc->tf;
80104822:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104825:	8b 50 24             	mov    0x24(%eax),%edx
80104828:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010482e:	8b 40 24             	mov    0x24(%eax),%eax
80104831:	89 c3                	mov    %eax,%ebx
80104833:	b8 13 00 00 00       	mov    $0x13,%eax
80104838:	89 d7                	mov    %edx,%edi
8010483a:	89 de                	mov    %ebx,%esi
8010483c:	89 c1                	mov    %eax,%ecx
8010483e:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Copy UID and GID and PPID over
  np->uid = proc->uid;
80104840:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104846:	8b 50 14             	mov    0x14(%eax),%edx
80104849:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010484c:	89 50 14             	mov    %edx,0x14(%eax)
  np->gid = proc->gid;
8010484f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104855:	8b 50 18             	mov    0x18(%eax),%edx
80104858:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010485b:	89 50 18             	mov    %edx,0x18(%eax)
  np->ppid = proc->pid;
8010485e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104864:	8b 40 10             	mov    0x10(%eax),%eax
80104867:	89 c2                	mov    %eax,%edx
80104869:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010486c:	89 50 1c             	mov    %edx,0x1c(%eax)

  np->priority = 1;
8010486f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104872:	c7 80 8c 00 00 00 01 	movl   $0x1,0x8c(%eax)
80104879:	00 00 00 

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
8010487c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010487f:	8b 40 24             	mov    0x24(%eax),%eax
80104882:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
80104889:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104890:	eb 3d                	jmp    801048cf <fork+0x164>
    if(proc->ofile[i])
80104892:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104898:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010489b:	83 c2 0c             	add    $0xc,%edx
8010489e:	8b 44 90 04          	mov    0x4(%eax,%edx,4),%eax
801048a2:	85 c0                	test   %eax,%eax
801048a4:	74 25                	je     801048cb <fork+0x160>
      np->ofile[i] = filedup(proc->ofile[i]);
801048a6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048ac:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801048af:	83 c2 0c             	add    $0xc,%edx
801048b2:	8b 44 90 04          	mov    0x4(%eax,%edx,4),%eax
801048b6:	89 04 24             	mov    %eax,(%esp)
801048b9:	e8 e3 c6 ff ff       	call   80100fa1 <filedup>
801048be:	8b 55 e0             	mov    -0x20(%ebp),%edx
801048c1:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801048c4:	83 c1 0c             	add    $0xc,%ecx
801048c7:	89 44 8a 04          	mov    %eax,0x4(%edx,%ecx,4)
  np->priority = 1;
  ...
  for(i = 0; i < NOFILE; i++)
801048cb:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
801048cf:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
801048d3:	7e bd                	jle    80104892 <fork+0x127>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
801048d5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048db:	8b 40 74             	mov    0x74(%eax),%eax
801048de:	89 04 24             	mov    %eax,(%esp)
801048e1:	e8 bc cf ff ff       	call   801018a2 <idup>
801048e6:	8b 55 e0             	mov    -0x20(%ebp),%edx
801048e9:	89 42 74             	mov    %eax,0x74(%edx)

  safestrcpy(np->name, proc->name, sizeof(proc->name));
801048ec:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048f2:	8d 50 78             	lea    0x78(%eax),%edx
801048f5:	8b 45 e0             	mov    -0x20(%ebp),%eax
801048f8:	83 c0 78             	add    $0x78,%eax
801048fb:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104902:	00 
80104903:	89 54 24 04          	mov    %edx,0x4(%esp)
80104907:	89 04 24             	mov    %eax,(%esp)
8010490a:	e8 3e 0e 00 00       	call   8010574d <safestrcpy>
 
  pid = np->pid;
8010490f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104912:	8b 40 10             	mov    0x10(%eax),%eax
80104915:	89 45 dc             	mov    %eax,-0x24(%ebp)

  // lock to force the compiler to emit the np->state write last.
  acquire(&ptable.lock);
80104918:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
8010491f:	e8 b5 09 00 00       	call   801052d9 <acquire>
  np->state = RUNNABLE;
80104924:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104927:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  release(&ptable.lock);
8010492e:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104935:	e8 01 0a 00 00       	call   8010533b <release>
  
  return pid;
8010493a:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
8010493d:	83 c4 2c             	add    $0x2c,%esp
80104940:	5b                   	pop    %ebx
80104941:	5e                   	pop    %esi
80104942:	5f                   	pop    %edi
80104943:	5d                   	pop    %ebp
...
80104948:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int fd;

  if(proc == initproc)
8010494b:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104952:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104957:	39 c2                	cmp    %eax,%edx
80104959:	75 0c                	jne    80104967 <exit+0x22>
    panic("init exiting");
8010495b:	c7 04 24 a8 8d 10 80 	movl   $0x80108da8,(%esp)
80104962:	e8 d3 bb ff ff       	call   8010053a <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104967:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
8010496e:	eb 44                	jmp    801049b4 <exit+0x6f>
    if(proc->ofile[fd]){
80104970:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104976:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104979:	83 c2 0c             	add    $0xc,%edx
8010497c:	8b 44 90 04          	mov    0x4(%eax,%edx,4),%eax
80104980:	85 c0                	test   %eax,%eax
80104982:	74 2c                	je     801049b0 <exit+0x6b>
      fileclose(proc->ofile[fd]);
80104984:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010498a:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010498d:	83 c2 0c             	add    $0xc,%edx
80104990:	8b 44 90 04          	mov    0x4(%eax,%edx,4),%eax
80104994:	89 04 24             	mov    %eax,(%esp)
80104997:	e8 4d c6 ff ff       	call   80100fe9 <fileclose>
      proc->ofile[fd] = 0;
8010499c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049a2:	8b 55 f0             	mov    -0x10(%ebp),%edx
801049a5:	83 c2 0c             	add    $0xc,%edx
801049a8:	c7 44 90 04 00 00 00 	movl   $0x0,0x4(%eax,%edx,4)
801049af:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
801049b0:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
801049b4:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
801049b8:	7e b6                	jle    80104970 <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
801049ba:	e8 fd ea ff ff       	call   801034bc <begin_op>
  iput(proc->cwd);
801049bf:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049c5:	8b 40 74             	mov    0x74(%eax),%eax
801049c8:	89 04 24             	mov    %eax,(%esp)
801049cb:	e8 bd d0 ff ff       	call   80101a8d <iput>
  end_op();
801049d0:	e8 6b eb ff ff       	call   80103540 <end_op>
  proc->cwd = 0;
801049d5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049db:	c7 40 74 00 00 00 00 	movl   $0x0,0x74(%eax)

  acquire(&ptable.lock);
801049e2:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
801049e9:	e8 eb 08 00 00       	call   801052d9 <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
801049ee:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049f4:	8b 40 20             	mov    0x20(%eax),%eax
801049f7:	89 04 24             	mov    %eax,(%esp)
801049fa:	e8 c3 03 00 00       	call   80104dc2 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049ff:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104a06:	eb 3b                	jmp    80104a43 <exit+0xfe>
    if(p->parent == proc){
80104a08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a0b:	8b 50 20             	mov    0x20(%eax),%edx
80104a0e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a14:	39 c2                	cmp    %eax,%edx
80104a16:	75 24                	jne    80104a3c <exit+0xf7>
      p->parent = initproc;
80104a18:	8b 15 68 c6 10 80    	mov    0x8010c668,%edx
80104a1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a21:	89 50 20             	mov    %edx,0x20(%eax)
      if(p->state == ZOMBIE)
80104a24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a27:	8b 40 0c             	mov    0xc(%eax),%eax
80104a2a:	83 f8 05             	cmp    $0x5,%eax
80104a2d:	75 0d                	jne    80104a3c <exit+0xf7>
        wakeup1(initproc);
80104a2f:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104a34:	89 04 24             	mov    %eax,(%esp)
80104a37:	e8 86 03 00 00       	call   80104dc2 <wakeup1>
...
80104a43:	81 7d f4 b4 5d 11 80 	cmpl   $0x80115db4,-0xc(%ebp)
80104a4a:	72 bc                	jb     80104a08 <exit+0xc3>
        wakeup1(initproc);
    }
  }
...
80104a52:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104a59:	e8 88 01 00 00       	call   80104be6 <sched>
  panic("zombie exit");
80104a5e:	c7 04 24 b5 8d 10 80 	movl   $0x80108db5,(%esp)
80104a65:	e8 d0 ba ff ff       	call   8010053a <panic>
...
80104a6d:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid;

  acquire(&ptable.lock);
80104a70:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104a77:	e8 5d 08 00 00       	call   801052d9 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104a7c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a83:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104a8a:	e9 a8 00 00 00       	jmp    80104b37 <wait+0xcd>
      if(p->parent != proc)
80104a8f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a92:	8b 50 20             	mov    0x20(%eax),%edx
80104a95:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a9b:	39 c2                	cmp    %eax,%edx
80104a9d:	74 05                	je     80104aa4 <wait+0x3a>
        continue;
80104a9f:	e9 8c 00 00 00       	jmp    80104b30 <wait+0xc6>
      havekids = 1;
...
80104ab4:	75 7a                	jne    80104b30 <wait+0xc6>
        // Found one.
        pid = p->pid;
...
80104ac8:	e8 32 e0 ff ff       	call   80102aff <kfree>
        p->kstack = 0;
...
80104ae0:	e8 46 3c 00 00       	call   8010872b <freevm>
        p->state = UNUSED;
...
80104af5:	e8 15 06 00 00       	call   8010510f <putOnFreeList>
#endif
        p->pid = 0;
80104afa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104afd:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104b04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b07:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
        p->name[0] = 0;
80104b0e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b11:	c6 40 78 00          	movb   $0x0,0x78(%eax)
        p->killed = 0;
80104b15:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b18:	c7 40 30 00 00 00 00 	movl   $0x0,0x30(%eax)
        release(&ptable.lock);
80104b1f:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104b26:	e8 10 08 00 00       	call   8010533b <release>
        return pid;
80104b2b:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104b2e:	eb 55                	jmp    80104b85 <wait+0x11b>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b30:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80104b37:	81 7d f4 b4 5d 11 80 	cmpl   $0x80115db4,-0xc(%ebp)
80104b3e:	0f 82 4b ff ff ff    	jb     80104a8f <wait+0x25>
        return pid;
      }
    }
...
80104b44:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104b48:	74 0d                	je     80104b57 <wait+0xed>
80104b4a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b50:	8b 40 30             	mov    0x30(%eax),%eax
80104b53:	85 c0                	test   %eax,%eax
80104b55:	74 13                	je     80104b6a <wait+0x100>
      release(&ptable.lock);
80104b57:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104b5e:	e8 d8 07 00 00       	call   8010533b <release>
      return -1;
80104b63:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b68:	eb 1b                	jmp    80104b85 <wait+0x11b>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104b6a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b70:	c7 44 24 04 80 39 11 	movl   $0x80113980,0x4(%esp)
80104b77:	80 
80104b78:	89 04 24             	mov    %eax,(%esp)
80104b7b:	e8 a7 01 00 00       	call   80104d27 <sleep>
  }
80104b80:	e9 f7 fe ff ff       	jmp    80104a7c <wait+0x12>
}
80104b85:	c9                   	leave  
80104b86:	c3                   	ret    
...
80104ba5:	eb 28                	jmp    80104bcf <scheduler+0x48>
      if(p->state != RUNNABLE) // not scheduling if not runnable
80104ba7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104baa:	8b 40 0c             	mov    0xc(%eax),%eax
80104bad:	83 f8 03             	cmp    $0x3,%eax
80104bb0:	74 02                	je     80104bb4 <scheduler+0x2d>
        continue;
80104bb2:	eb 14                	jmp    80104bc8 <scheduler+0x41>
...
80104bb7:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104bbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bc0:	89 04 24             	mov    %eax,(%esp)
80104bc3:	e8 f0 36 00 00       	call   801082b8 <switchuvm>
    // Enable interrupts on this processor.
    sti();
    ...
    acquire(&ptable.lock);  // get lock for table
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){  // p incremented by size (int=4;char=1)
80104bc8:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80104bcf:	81 7d f4 b4 5d 11 80 	cmpl   $0x80115db4,-0xc(%ebp)
80104bd6:	72 cf                	jb     80104ba7 <scheduler+0x20>
      // and then reacquire it before jumping back to us.
      proc = p; // set to process we just hit
      switchuvm(p);
...
80104bd8:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104bdf:	e8 57 07 00 00       	call   8010533b <release>
  }
80104be4:	eb a7                	jmp    80104b8d <scheduler+0x6>
...
80104be9:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
80104bec:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104bf3:	e8 0b 08 00 00       	call   80105403 <holding>
80104bf8:	85 c0                	test   %eax,%eax
80104bfa:	75 0c                	jne    80104c08 <sched+0x22>
    panic("sched ptable.lock");
80104bfc:	c7 04 24 c1 8d 10 80 	movl   $0x80108dc1,(%esp)
80104c03:	e8 32 b9 ff ff       	call   8010053a <panic>
  if(cpu->ncli != 1)
80104c08:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c0e:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104c14:	83 f8 01             	cmp    $0x1,%eax
80104c17:	74 0c                	je     80104c25 <sched+0x3f>
    panic("sched locks");
80104c19:	c7 04 24 d3 8d 10 80 	movl   $0x80108dd3,(%esp)
...
80104c2e:	83 f8 04             	cmp    $0x4,%eax
80104c31:	75 0c                	jne    80104c3f <sched+0x59>
    panic("sched running");
80104c33:	c7 04 24 df 8d 10 80 	movl   $0x80108ddf,(%esp)
80104c3a:	e8 fb b8 ff ff       	call   8010053a <panic>
  if(readeflags()&FL_IF)
80104c3f:	e8 39 f7 ff ff       	call   8010437d <readeflags>
80104c44:	25 00 02 00 00       	and    $0x200,%eax
80104c49:	85 c0                	test   %eax,%eax
80104c4b:	74 0c                	je     80104c59 <sched+0x73>
    panic("sched interruptible");
80104c4d:	c7 04 24 ed 8d 10 80 	movl   $0x80108ded,(%esp)
80104c54:	e8 e1 b8 ff ff       	call   8010053a <panic>
...
80104c68:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c6e:	8b 40 04             	mov    0x4(%eax),%eax
80104c71:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104c78:	83 c2 28             	add    $0x28,%edx
80104c7b:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c7f:	89 14 24             	mov    %edx,(%esp)
80104c82:	e8 37 0b 00 00       	call   801057be <swtch>
  cpu->intena = intena;
80104c87:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c8d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104c90:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104c96:	c9                   	leave  
80104c97:	c3                   	ret    
...
80104c9e:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ca5:	e8 2f 06 00 00       	call   801052d9 <acquire>
  proc->state = RUNNABLE;
80104caa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cb0:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
#ifdef USE_CS333_SCHEDULER
  putOnReadyList(proc, proc->priority);
80104cb7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cbd:	8b 90 8c 00 00 00    	mov    0x8c(%eax),%edx
80104cc3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cc9:	89 54 24 04          	mov    %edx,0x4(%esp)
80104ccd:	89 04 24             	mov    %eax,(%esp)
80104cd0:	e8 56 04 00 00       	call   8010512b <putOnReadyList>
#endif
  sched();
80104cd5:	e8 0c ff ff ff       	call   80104be6 <sched>
  release(&ptable.lock);
80104cda:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104ce1:	e8 55 06 00 00       	call   8010533b <release>
}
80104ce6:	c9                   	leave  
80104ce7:	c3                   	ret    
...
80104ceb:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104cee:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104cf5:	e8 41 06 00 00       	call   8010533b <release>

  if (first) {
80104cfa:	a1 24 c0 10 80       	mov    0x8010c024,%eax
80104cff:	85 c0                	test   %eax,%eax
80104d01:	74 22                	je     80104d25 <forkret+0x3d>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104d03:	c7 05 24 c0 10 80 00 	movl   $0x0,0x8010c024
80104d0a:	00 00 00 
    iinit(ROOTDEV);
80104d0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104d14:	e8 93 c8 ff ff       	call   801015ac <iinit>
    initlog(ROOTDEV);
80104d19:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104d20:	e8 93 e5 ff ff       	call   801032b8 <initlog>
  }
...
80104d35:	75 0c                	jne    80104d43 <sleep+0x1c>
    panic("sleep");
80104d37:	c7 04 24 01 8e 10 80 	movl   $0x80108e01,(%esp)
80104d3e:	e8 f7 b7 ff ff       	call   8010053a <panic>

  if(lk == 0)
80104d43:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104d47:	75 0c                	jne    80104d55 <sleep+0x2e>
    panic("sleep without lk");
80104d49:	c7 04 24 07 8e 10 80 	movl   $0x80108e07,(%esp)
80104d50:	e8 e5 b7 ff ff       	call   8010053a <panic>
...
80104d55:	81 7d 0c 80 39 11 80 	cmpl   $0x80113980,0xc(%ebp)
80104d5c:	74 17                	je     80104d75 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104d5e:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104d65:	e8 6f 05 00 00       	call   801052d9 <acquire>
    release(lk);
80104d6a:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d6d:	89 04 24             	mov    %eax,(%esp)
80104d70:	e8 c6 05 00 00       	call   8010533b <release>
  }
...
80104d7e:	89 50 2c             	mov    %edx,0x2c(%eax)
  proc->state = SLEEPING;
80104d81:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d87:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104d8e:	e8 53 fe ff ff       	call   80104be6 <sched>

  // Tidy up.
  proc->chan = 0;
80104d93:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d99:	c7 40 2c 00 00 00 00 	movl   $0x0,0x2c(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104da0:	81 7d 0c 80 39 11 80 	cmpl   $0x80113980,0xc(%ebp)
80104da7:	74 17                	je     80104dc0 <sleep+0x99>
    release(&ptable.lock);
80104da9:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104db0:	e8 86 05 00 00       	call   8010533b <release>
    acquire(lk);
80104db5:	8b 45 0c             	mov    0xc(%ebp),%eax
80104db8:	89 04 24             	mov    %eax,(%esp)
80104dbb:	e8 19 05 00 00       	call   801052d9 <acquire>
  }
}
80104dc0:	c9                   	leave  
80104dc1:	c3                   	ret    
...
80104dc5:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104dc8:	c7 45 fc b4 39 11 80 	movl   $0x801139b4,-0x4(%ebp)
80104dcf:	eb 27                	jmp    80104df8 <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
80104dd1:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104dd4:	8b 40 0c             	mov    0xc(%eax),%eax
80104dd7:	83 f8 02             	cmp    $0x2,%eax
80104dda:	75 15                	jne    80104df1 <wakeup1+0x2f>
80104ddc:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104ddf:	8b 40 2c             	mov    0x2c(%eax),%eax
80104de2:	3b 45 08             	cmp    0x8(%ebp),%eax
80104de5:	75 0a                	jne    80104df1 <wakeup1+0x2f>
      p->state = RUNNABLE;
...
80104df8:	81 7d fc b4 5d 11 80 	cmpl   $0x80115db4,-0x4(%ebp)
80104dff:	72 d0                	jb     80104dd1 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80104e01:	c9                   	leave  
...
80104e06:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104e09:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e10:	e8 c4 04 00 00       	call   801052d9 <acquire>
  wakeup1(chan);
80104e15:	8b 45 08             	mov    0x8(%ebp),%eax
80104e18:	89 04 24             	mov    %eax,(%esp)
80104e1b:	e8 a2 ff ff ff       	call   80104dc2 <wakeup1>
  release(&ptable.lock);
80104e20:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e27:	e8 0f 05 00 00       	call   8010533b <release>
}
80104e2c:	c9                   	leave  
80104e2d:	c3                   	ret    
...
80104e31:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  acquire(&ptable.lock);
80104e34:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e3b:	e8 99 04 00 00       	call   801052d9 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e40:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104e47:	eb 44                	jmp    80104e8d <kill+0x5f>
    if(p->pid == pid){
80104e49:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e4c:	8b 40 10             	mov    0x10(%eax),%eax
80104e4f:	3b 45 08             	cmp    0x8(%ebp),%eax
80104e52:	75 32                	jne    80104e86 <kill+0x58>
      p->killed = 1;
80104e54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e57:	c7 40 30 01 00 00 00 	movl   $0x1,0x30(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104e5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e61:	8b 40 0c             	mov    0xc(%eax),%eax
80104e64:	83 f8 02             	cmp    $0x2,%eax
80104e67:	75 0a                	jne    80104e73 <kill+0x45>
        p->state = RUNNABLE;
80104e69:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e6c:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104e73:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e7a:	e8 bc 04 00 00       	call   8010533b <release>
      return 0;
80104e7f:	b8 00 00 00 00       	mov    $0x0,%eax
80104e84:	eb 21                	jmp    80104ea7 <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e86:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
80104e8d:	81 7d f4 b4 5d 11 80 	cmpl   $0x80115db4,-0xc(%ebp)
80104e94:	72 b3                	jb     80104e49 <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80104e96:	c7 04 24 80 39 11 80 	movl   $0x80113980,(%esp)
80104e9d:	e8 99 04 00 00       	call   8010533b <release>
  return -1;
...
80104ead:	83 ec 64             	sub    $0x64,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104eb0:	c7 45 f0 b4 39 11 80 	movl   $0x801139b4,-0x10(%ebp)
80104eb7:	e9 ed 00 00 00       	jmp    80104fa9 <procdump+0x100>
    if(p->state == UNUSED)
80104ebc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ebf:	8b 40 0c             	mov    0xc(%eax),%eax
80104ec2:	85 c0                	test   %eax,%eax
80104ec4:	75 05                	jne    80104ecb <procdump+0x22>
      continue;
80104ec6:	e9 d7 00 00 00       	jmp    80104fa2 <procdump+0xf9>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104ecb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ece:	8b 40 0c             	mov    0xc(%eax),%eax
80104ed1:	83 f8 05             	cmp    $0x5,%eax
80104ed4:	77 23                	ja     80104ef9 <procdump+0x50>
...
80104ee5:	74 12                	je     80104ef9 <procdump+0x50>
...
80104ef7:	eb 07                	jmp    80104f00 <procdump+0x57>
    else
      state = "???";
80104ef9:	c7 45 ec 42 8e 10 80 	movl   $0x80108e42,-0x14(%ebp)
    cprintf("%d %d %d %s %s", p->pid, p->uid, p->gid, state, p->name);
80104f00:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f03:	8d 58 78             	lea    0x78(%eax),%ebx
80104f06:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f09:	8b 48 18             	mov    0x18(%eax),%ecx
80104f0c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f0f:	8b 50 14             	mov    0x14(%eax),%edx
80104f12:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f15:	8b 40 10             	mov    0x10(%eax),%eax
80104f18:	89 5c 24 14          	mov    %ebx,0x14(%esp)
80104f1c:	8b 5d ec             	mov    -0x14(%ebp),%ebx
80104f1f:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80104f23:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80104f27:	89 54 24 08          	mov    %edx,0x8(%esp)
80104f2b:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f2f:	c7 04 24 46 8e 10 80 	movl   $0x80108e46,(%esp)
80104f36:	e8 65 b4 ff ff       	call   801003a0 <cprintf>
    if(p->state == SLEEPING){
80104f3b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f3e:	8b 40 0c             	mov    0xc(%eax),%eax
80104f41:	83 f8 02             	cmp    $0x2,%eax
80104f44:	75 50                	jne    80104f96 <procdump+0xed>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104f46:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f49:	8b 40 28             	mov    0x28(%eax),%eax
80104f4c:	8b 40 0c             	mov    0xc(%eax),%eax
80104f4f:	83 c0 08             	add    $0x8,%eax
80104f52:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104f55:	89 54 24 04          	mov    %edx,0x4(%esp)
80104f59:	89 04 24             	mov    %eax,(%esp)
80104f5c:	e8 29 04 00 00       	call   8010538a <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104f61:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104f68:	eb 1b                	jmp    80104f85 <procdump+0xdc>
        cprintf(" %p", pc[i]);
80104f6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f6d:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104f71:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f75:	c7 04 24 55 8e 10 80 	movl   $0x80108e55,(%esp)
80104f7c:	e8 1f b4 ff ff       	call   801003a0 <cprintf>
    else
      state = "???";
    cprintf("%d %d %d %s %s", p->pid, p->uid, p->gid, state, p->name);
    if(p->state == SLEEPING){
...
80104f85:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104f89:	7f 0b                	jg     80104f96 <procdump+0xed>
80104f8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f8e:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104f92:	85 c0                	test   %eax,%eax
80104f94:	75 d4                	jne    80104f6a <procdump+0xc1>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104f96:	c7 04 24 59 8e 10 80 	movl   $0x80108e59,(%esp)
80104f9d:	e8 fe b3 ff ff       	call   801003a0 <cprintf>
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104fa2:	81 45 f0 90 00 00 00 	addl   $0x90,-0x10(%ebp)
80104fa9:	81 7d f0 b4 5d 11 80 	cmpl   $0x80115db4,-0x10(%ebp)
80104fb0:	0f 82 06 ff ff ff    	jb     80104ebc <procdump+0x13>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104fb6:	83 c4 64             	add    $0x64,%esp
80104fb9:	5b                   	pop    %ebx
80104fba:	5d                   	pop    %ebp
80104fbb:	c3                   	ret    

80104fbc <getProcInfo>:
...
80104fbf:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  char *state;
  int i = 0;
80104fc2:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

  for(p = ptable.proc; p <&ptable.proc[NPROC] && i <= count; p++){
80104fc9:	c7 45 f4 b4 39 11 80 	movl   $0x801139b4,-0xc(%ebp)
80104fd0:	e9 20 01 00 00       	jmp    801050f5 <getProcInfo+0x139>

    if(p->state == SLEEPING || p->state == RUNNABLE || p->state == RUNNING) {
80104fd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fd8:	8b 40 0c             	mov    0xc(%eax),%eax
80104fdb:	83 f8 02             	cmp    $0x2,%eax
80104fde:	74 1a                	je     80104ffa <getProcInfo+0x3e>
80104fe0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fe3:	8b 40 0c             	mov    0xc(%eax),%eax
80104fe6:	83 f8 03             	cmp    $0x3,%eax
80104fe9:	74 0f                	je     80104ffa <getProcInfo+0x3e>
80104feb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fee:	8b 40 0c             	mov    0xc(%eax),%eax
80104ff1:	83 f8 04             	cmp    $0x4,%eax
80104ff4:	0f 85 f4 00 00 00    	jne    801050ee <getProcInfo+0x132>
      table[i].pid = p->pid;
80104ffa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ffd:	c1 e0 02             	shl    $0x2,%eax
80105000:	89 c2                	mov    %eax,%edx
80105002:	c1 e2 04             	shl    $0x4,%edx
80105005:	29 c2                	sub    %eax,%edx
80105007:	8b 45 0c             	mov    0xc(%ebp),%eax
8010500a:	01 c2                	add    %eax,%edx
8010500c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010500f:	8b 40 10             	mov    0x10(%eax),%eax
80105012:	89 02                	mov    %eax,(%edx)
      table[i].uid = p->uid;
80105014:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105017:	c1 e0 02             	shl    $0x2,%eax
8010501a:	89 c2                	mov    %eax,%edx
8010501c:	c1 e2 04             	shl    $0x4,%edx
8010501f:	29 c2                	sub    %eax,%edx
80105021:	8b 45 0c             	mov    0xc(%ebp),%eax
80105024:	01 c2                	add    %eax,%edx
80105026:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105029:	8b 40 14             	mov    0x14(%eax),%eax
8010502c:	89 42 04             	mov    %eax,0x4(%edx)
      table[i].gid = p->gid;
8010502f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105032:	c1 e0 02             	shl    $0x2,%eax
80105035:	89 c2                	mov    %eax,%edx
80105037:	c1 e2 04             	shl    $0x4,%edx
8010503a:	29 c2                	sub    %eax,%edx
8010503c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010503f:	01 c2                	add    %eax,%edx
80105041:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105044:	8b 40 18             	mov    0x18(%eax),%eax
80105047:	89 42 08             	mov    %eax,0x8(%edx)
      table[i].ppid = p->ppid;
8010504a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010504d:	c1 e0 02             	shl    $0x2,%eax
80105050:	89 c2                	mov    %eax,%edx
80105052:	c1 e2 04             	shl    $0x4,%edx
80105055:	29 c2                	sub    %eax,%edx
80105057:	8b 45 0c             	mov    0xc(%ebp),%eax
8010505a:	01 c2                	add    %eax,%edx
8010505c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010505f:	8b 40 1c             	mov    0x1c(%eax),%eax
80105062:	89 42 0c             	mov    %eax,0xc(%edx)
      state = states[p->state];
80105065:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105068:	8b 40 0c             	mov    0xc(%eax),%eax
8010506b:	8b 04 85 0c c0 10 80 	mov    -0x7fef3ff4(,%eax,4),%eax
80105072:	89 45 ec             	mov    %eax,-0x14(%ebp)
      safestrcpy(table[i].state, state, sizeof(state));
80105075:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105078:	c1 e0 02             	shl    $0x2,%eax
8010507b:	89 c2                	mov    %eax,%edx
8010507d:	c1 e2 04             	shl    $0x4,%edx
80105080:	29 c2                	sub    %eax,%edx
80105082:	8b 45 0c             	mov    0xc(%ebp),%eax
80105085:	01 d0                	add    %edx,%eax
80105087:	8d 50 10             	lea    0x10(%eax),%edx
8010508a:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105091:	00 
80105092:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105095:	89 44 24 04          	mov    %eax,0x4(%esp)
80105099:	89 14 24             	mov    %edx,(%esp)
8010509c:	e8 ac 06 00 00       	call   8010574d <safestrcpy>
      table[i].sz = p->sz;
801050a1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801050a4:	c1 e0 02             	shl    $0x2,%eax
801050a7:	89 c2                	mov    %eax,%edx
801050a9:	c1 e2 04             	shl    $0x4,%edx
801050ac:	29 c2                	sub    %eax,%edx
801050ae:	8b 45 0c             	mov    0xc(%ebp),%eax
801050b1:	01 c2                	add    %eax,%edx
801050b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050b6:	8b 00                	mov    (%eax),%eax
801050b8:	89 42 24             	mov    %eax,0x24(%edx)
      safestrcpy(table[i].name, p->name, sizeof(p->name));
801050bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050be:	8d 50 78             	lea    0x78(%eax),%edx
801050c1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801050c4:	c1 e0 02             	shl    $0x2,%eax
801050c7:	89 c1                	mov    %eax,%ecx
801050c9:	c1 e1 04             	shl    $0x4,%ecx
801050cc:	29 c1                	sub    %eax,%ecx
801050ce:	8b 45 0c             	mov    0xc(%ebp),%eax
801050d1:	01 c8                	add    %ecx,%eax
801050d3:	83 c0 28             	add    $0x28,%eax
801050d6:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801050dd:	00 
801050de:	89 54 24 04          	mov    %edx,0x4(%esp)
801050e2:	89 04 24             	mov    %eax,(%esp)
801050e5:	e8 63 06 00 00       	call   8010574d <safestrcpy>

      i++;
801050ea:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
{
  struct proc *p;
  char *state;
  int i = 0;
  ...
  for(p = ptable.proc; p <&ptable.proc[NPROC] && i <= count; p++){
801050ee:	81 45 f4 90 00 00 00 	addl   $0x90,-0xc(%ebp)
801050f5:	81 7d f4 b4 5d 11 80 	cmpl   $0x80115db4,-0xc(%ebp)
801050fc:	73 0c                	jae    8010510a <getProcInfo+0x14e>
801050fe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105101:	3b 45 08             	cmp    0x8(%ebp),%eax
80105104:	0f 8e cb fe ff ff    	jle    80104fd5 <getProcInfo+0x19>
      i++;
    }
...
80105112:	8b 15 c0 5d 11 80    	mov    0x80115dc0,%edx
80105118:	8b 45 08             	mov    0x8(%ebp),%eax
8010511b:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
  ptable.pFreeList = p;
80105121:	8b 45 08             	mov    0x8(%ebp),%eax
80105124:	a3 c0 5d 11 80       	mov    %eax,0x80115dc0
}
80105129:	5d                   	pop    %ebp
8010512a:	c3                   	ret    

8010512b <putOnReadyList>:
...
80105131:	05 0c 09 00 00       	add    $0x90c,%eax
80105136:	8b 14 85 84 39 11 80 	mov    -0x7feec67c(,%eax,4),%edx
8010513d:	8b 45 08             	mov    0x8(%ebp),%eax
80105140:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
  ptable.pReadyList[priority] = p;
80105146:	8b 45 0c             	mov    0xc(%ebp),%eax
80105149:	8d 90 0c 09 00 00    	lea    0x90c(%eax),%edx
8010514f:	8b 45 08             	mov    0x8(%ebp),%eax
80105152:	89 04 95 84 39 11 80 	mov    %eax,-0x7feec67c(,%edx,4)
}
80105159:	5d                   	pop    %ebp
8010515a:	c3                   	ret    

8010515b <removeFromReadyList>:
...
80105164:	05 0c 09 00 00       	add    $0x90c,%eax
80105169:	8b 04 85 84 39 11 80 	mov    -0x7feec67c(,%eax,4),%eax
80105170:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if (current == p) {
80105173:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105176:	3b 45 08             	cmp    0x8(%ebp),%eax
80105179:	75 1b                	jne    80105196 <removeFromReadyList+0x3b>
    ptable.pReadyList[priority] = p->next;
8010517b:	8b 45 08             	mov    0x8(%ebp),%eax
8010517e:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80105184:	8b 55 0c             	mov    0xc(%ebp),%edx
80105187:	81 c2 0c 09 00 00    	add    $0x90c,%edx
8010518d:	89 04 95 84 39 11 80 	mov    %eax,-0x7feec67c(,%edx,4)
    return;
80105194:	eb 3e                	jmp    801051d4 <removeFromReadyList+0x79>
  }
  while (current->next) {
80105196:	eb 2f                	jmp    801051c7 <removeFromReadyList+0x6c>
    if (current->next == p) {
80105198:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010519b:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801051a1:	3b 45 08             	cmp    0x8(%ebp),%eax
801051a4:	75 21                	jne    801051c7 <removeFromReadyList+0x6c>
      current = p->next->next;
801051a6:	8b 45 08             	mov    0x8(%ebp),%eax
801051a9:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801051af:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801051b5:	89 45 fc             	mov    %eax,-0x4(%ebp)
      p->next = 0;
801051b8:	8b 45 08             	mov    0x8(%ebp),%eax
801051bb:	c7 80 88 00 00 00 00 	movl   $0x0,0x88(%eax)
801051c2:	00 00 00 
      return;
801051c5:	eb 0d                	jmp    801051d4 <removeFromReadyList+0x79>
  current = ptable.pReadyList[priority];
  if (current == p) {
    ptable.pReadyList[priority] = p->next;
    return;
...
801051ca:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801051d0:	85 c0                	test   %eax,%eax
801051d2:	75 c4                	jne    80105198 <removeFromReadyList+0x3d>
      current = p->next->next;
      p->next = 0;
      return;
    }
...
801051d9:	83 ec 18             	sub    $0x18,%esp
  ...
  for (p = ptable.proc; p <&ptable.proc[NPROC]; p++) {
801051dc:	c7 45 fc b4 39 11 80 	movl   $0x801139b4,-0x4(%ebp)
801051e3:	e9 86 00 00 00       	jmp    8010526e <setpq+0x98>
    if (pid == p->pid) {
801051e8:	8b 45 fc             	mov    -0x4(%ebp),%eax
801051eb:	8b 40 10             	mov    0x10(%eax),%eax
801051ee:	3b 45 08             	cmp    0x8(%ebp),%eax
801051f1:	75 74                	jne    80105267 <setpq+0x91>
      if (p->state == RUNNABLE) {
801051f3:	8b 45 fc             	mov    -0x4(%ebp),%eax
801051f6:	8b 40 0c             	mov    0xc(%eax),%eax
801051f9:	83 f8 03             	cmp    $0x3,%eax
801051fc:	75 69                	jne    80105267 <setpq+0x91>
        if (priority == p->priority) 
801051fe:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105201:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80105207:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010520a:	75 07                	jne    80105213 <setpq+0x3d>
          return 1;
8010520c:	b8 01 00 00 00       	mov    $0x1,%eax
80105211:	eb 6d                	jmp    80105280 <setpq+0xaa>
        else if (priority > p->priority || priority < p->priority) {
80105213:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105216:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
8010521c:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010521f:	7c 0e                	jl     8010522f <setpq+0x59>
80105221:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105224:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
8010522a:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010522d:	7e 2c                	jle    8010525b <setpq+0x85>
          removeFromReadyList(p, p->priority);
8010522f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105232:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80105238:	89 44 24 04          	mov    %eax,0x4(%esp)
8010523c:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010523f:	89 04 24             	mov    %eax,(%esp)
80105242:	e8 14 ff ff ff       	call   8010515b <removeFromReadyList>
...
80105254:	e8 d2 fe ff ff       	call   8010512b <putOnReadyList>
80105259:	eb 0c                	jmp    80105267 <setpq+0x91>
        } 
        else 
          p->priority = priority;
8010525b:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010525e:	8b 55 0c             	mov    0xc(%ebp),%edx
80105261:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
int
setpq(int pid, int priority)
{
  struct proc *p;
  ...
  for (p = ptable.proc; p <&ptable.proc[NPROC]; p++) {
80105267:	81 45 fc 90 00 00 00 	addl   $0x90,-0x4(%ebp)
8010526e:	81 7d fc b4 5d 11 80 	cmpl   $0x80115db4,-0x4(%ebp)
80105275:	0f 82 6d ff ff ff    	jb     801051e8 <setpq+0x12>
        else 
          p->priority = priority;
      }
    }
  ...
  return 1;
8010527b:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105280:	c9                   	leave  
80105281:	c3                   	ret    
...
801052a1:	83 ec 10             	sub    $0x10,%esp
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
801052a4:	8b 55 08             	mov    0x8(%ebp),%edx
801052a7:	8b 45 0c             	mov    0xc(%ebp),%eax
801052aa:	8b 4d 08             	mov    0x8(%ebp),%ecx
801052ad:	f0 87 02             	lock xchg %eax,(%edx)
...
801052df:	e8 49 01 00 00       	call   8010542d <pushcli>
  if(holding(lk))
801052e4:	8b 45 08             	mov    0x8(%ebp),%eax
801052e7:	89 04 24             	mov    %eax,(%esp)
801052ea:	e8 14 01 00 00       	call   80105403 <holding>
801052ef:	85 c0                	test   %eax,%eax
801052f1:	74 0c                	je     801052ff <acquire+0x26>
    panic("acquire");
801052f3:	c7 04 24 5b 8e 10 80 	movl   $0x80108e5b,(%esp)
801052fa:	e8 3b b2 ff ff       	call   8010053a <panic>
...
80105303:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010530a:	00 
8010530b:	89 04 24             	mov    %eax,(%esp)
8010530e:	e8 8b ff ff ff       	call   8010529e <xchg>
80105313:	85 c0                	test   %eax,%eax
80105315:	75 e9                	jne    80105300 <acquire+0x27>
    ;
...
80105334:	e8 51 00 00 00       	call   8010538a <getcallerpcs>
}
80105339:	c9                   	leave  
8010533a:	c3                   	ret    
...
80105347:	e8 b7 00 00 00       	call   80105403 <holding>
8010534c:	85 c0                	test   %eax,%eax
8010534e:	75 0c                	jne    8010535c <release+0x21>
    panic("release");
80105350:	c7 04 24 63 8e 10 80 	movl   $0x80108e63,(%esp)
80105357:	e8 de b1 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
8010535c:	8b 45 08             	mov    0x8(%ebp),%eax
8010535f:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80105366:	8b 45 08             	mov    0x8(%ebp),%eax
80105369:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80105373:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010537a:	00 
8010537b:	89 04 24             	mov    %eax,(%esp)
8010537e:	e8 1b ff ff ff       	call   8010529e <xchg>

  popcli();
80105383:	e8 e9 00 00 00       	call   80105471 <popcli>
}
80105388:	c9                   	leave  
80105389:	c3                   	ret    

8010538a <getcallerpcs>:
...
801053a0:	eb 38                	jmp    801053da <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801053a2:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
801053a6:	74 38                	je     801053e0 <getcallerpcs+0x56>
801053a8:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
801053af:	76 2f                	jbe    801053e0 <getcallerpcs+0x56>
801053b1:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
801053b5:	74 29                	je     801053e0 <getcallerpcs+0x56>
      break;
...
801053de:	7e c2                	jle    801053a2 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801053e0:	eb 19                	jmp    801053fb <getcallerpcs+0x71>
    pcs[i] = 0;
...
801053ff:	7e e1                	jle    801053e2 <getcallerpcs+0x58>
    pcs[i] = 0;
}
80105401:	c9                   	leave  
80105402:	c3                   	ret    
...
8010540d:	74 17                	je     80105426 <holding+0x23>
8010540f:	8b 45 08             	mov    0x8(%ebp),%eax
80105412:	8b 50 08             	mov    0x8(%eax),%edx
80105415:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010541b:	39 c2                	cmp    %eax,%edx
8010541d:	75 07                	jne    80105426 <holding+0x23>
8010541f:	b8 01 00 00 00       	mov    $0x1,%eax
80105424:	eb 05                	jmp    8010542b <holding+0x28>
...
80105430:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105433:	e8 4a fe ff ff       	call   80105282 <readeflags>
80105438:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
8010543b:	e8 52 fe ff ff       	call   80105292 <cli>
  if(cpu->ncli++ == 0)
80105440:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80105447:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
8010544d:	8d 48 01             	lea    0x1(%eax),%ecx
80105450:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
80105456:	85 c0                	test   %eax,%eax
80105458:	75 15                	jne    8010546f <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
8010545a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105460:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105463:	81 e2 00 02 00 00    	and    $0x200,%edx
80105469:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
8010546f:	c9                   	leave  
80105470:	c3                   	ret    
...
80105474:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105477:	e8 06 fe ff ff       	call   80105282 <readeflags>
8010547c:	25 00 02 00 00       	and    $0x200,%eax
80105481:	85 c0                	test   %eax,%eax
80105483:	74 0c                	je     80105491 <popcli+0x20>
    panic("popcli - interruptible");
80105485:	c7 04 24 6b 8e 10 80 	movl   $0x80108e6b,(%esp)
8010548c:	e8 a9 b0 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
80105491:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105497:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010549d:	83 ea 01             	sub    $0x1,%edx
801054a0:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801054a6:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801054ac:	85 c0                	test   %eax,%eax
801054ae:	79 0c                	jns    801054bc <popcli+0x4b>
    panic("popcli");
801054b0:	c7 04 24 82 8e 10 80 	movl   $0x80108e82,(%esp)
801054b7:	e8 7e b0 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
801054bc:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801054c2:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801054c8:	85 c0                	test   %eax,%eax
801054ca:	75 15                	jne    801054e1 <popcli+0x70>
801054cc:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801054d2:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801054d8:	85 c0                	test   %eax,%eax
801054da:	74 05                	je     801054e1 <popcli+0x70>
    sti();
801054dc:	e8 b7 fd ff ff       	call   80105298 <sti>
}
801054e1:	c9                   	leave  
801054e2:	c3                   	ret    
...
801054e8:	8b 4d 08             	mov    0x8(%ebp),%ecx
801054eb:	8b 55 10             	mov    0x10(%ebp),%edx
801054ee:	8b 45 0c             	mov    0xc(%ebp),%eax
801054f1:	89 cb                	mov    %ecx,%ebx
801054f3:	89 df                	mov    %ebx,%edi
801054f5:	89 d1                	mov    %edx,%ecx
801054f7:	fc                   	cld    
801054f8:	f3 aa                	rep stos %al,%es:(%edi)
801054fa:	89 ca                	mov    %ecx,%edx
801054fc:	89 fb                	mov    %edi,%ebx
801054fe:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80105536:	83 e0 03             	and    $0x3,%eax
80105539:	85 c0                	test   %eax,%eax
8010553b:	75 49                	jne    80105586 <memset+0x59>
8010553d:	8b 45 10             	mov    0x10(%ebp),%eax
80105540:	83 e0 03             	and    $0x3,%eax
80105543:	85 c0                	test   %eax,%eax
80105545:	75 3f                	jne    80105586 <memset+0x59>
    c &= 0xFF;
80105547:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010554e:	8b 45 10             	mov    0x10(%ebp),%eax
80105551:	c1 e8 02             	shr    $0x2,%eax
80105554:	89 c2                	mov    %eax,%edx
80105556:	8b 45 0c             	mov    0xc(%ebp),%eax
80105559:	c1 e0 18             	shl    $0x18,%eax
8010555c:	89 c1                	mov    %eax,%ecx
8010555e:	8b 45 0c             	mov    0xc(%ebp),%eax
80105561:	c1 e0 10             	shl    $0x10,%eax
80105564:	09 c1                	or     %eax,%ecx
80105566:	8b 45 0c             	mov    0xc(%ebp),%eax
80105569:	c1 e0 08             	shl    $0x8,%eax
8010556c:	09 c8                	or     %ecx,%eax
8010556e:	0b 45 0c             	or     0xc(%ebp),%eax
80105571:	89 54 24 08          	mov    %edx,0x8(%esp)
80105575:	89 44 24 04          	mov    %eax,0x4(%esp)
80105579:	8b 45 08             	mov    0x8(%ebp),%eax
8010557c:	89 04 24             	mov    %eax,(%esp)
8010557f:	e8 84 ff ff ff       	call   80105508 <stosl>
80105584:	eb 19                	jmp    8010559f <memset+0x72>
  } else
    stosb(dst, c, n);
...
8010559a:	e8 44 ff ff ff       	call   801054e3 <stosb>
  return dst;
...
801055b3:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801055b6:	eb 30                	jmp    801055e8 <memcmp+0x44>
    if(*s1 != *s2)
801055b8:	8b 45 fc             	mov    -0x4(%ebp),%eax
801055bb:	0f b6 10             	movzbl (%eax),%edx
801055be:	8b 45 f8             	mov    -0x8(%ebp),%eax
801055c1:	0f b6 00             	movzbl (%eax),%eax
801055c4:	38 c2                	cmp    %al,%dl
801055c6:	74 18                	je     801055e0 <memcmp+0x3c>
      return *s1 - *s2;
801055c8:	8b 45 fc             	mov    -0x4(%ebp),%eax
801055cb:	0f b6 00             	movzbl (%eax),%eax
801055ce:	0f b6 d0             	movzbl %al,%edx
801055d1:	8b 45 f8             	mov    -0x8(%ebp),%eax
801055d4:	0f b6 00             	movzbl (%eax),%eax
801055d7:	0f b6 c0             	movzbl %al,%eax
801055da:	29 c2                	sub    %eax,%edx
801055dc:	89 d0                	mov    %edx,%eax
801055de:	eb 1a                	jmp    801055fa <memcmp+0x56>
    s1++, s2++;
801055e0:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801055e4:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
...
801055f3:	75 c3                	jne    801055b8 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105614:	73 3d                	jae    80105653 <memmove+0x57>
...
80105621:	76 30                	jbe    80105653 <memmove+0x57>
    s += n;
...
8010562c:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
8010562f:	eb 13                	jmp    80105644 <memmove+0x48>
      *--d = *--s;
80105631:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80105635:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
...
8010564f:	75 e0                	jne    80105631 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105651:	eb 26                	jmp    80105679 <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80105653:	eb 17                	jmp    8010566c <memmove+0x70>
      *d++ = *s++;
80105655:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105658:	8d 50 01             	lea    0x1(%eax),%edx
8010565b:	89 55 f8             	mov    %edx,-0x8(%ebp)
8010565e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105661:	8d 4a 01             	lea    0x1(%edx),%ecx
80105664:	89 4d fc             	mov    %ecx,-0x4(%ebp)
80105667:	0f b6 12             	movzbl (%edx),%edx
8010566a:	88 10                	mov    %dl,(%eax)
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
8010566f:	8d 50 ff             	lea    -0x1(%eax),%edx
80105672:	89 55 10             	mov    %edx,0x10(%ebp)
80105675:	85 c0                	test   %eax,%eax
80105677:	75 dc                	jne    80105655 <memmove+0x59>
      *d++ = *s++;
...
80105684:	8b 45 10             	mov    0x10(%ebp),%eax
80105687:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105698:	e8 5f ff ff ff       	call   801055fc <memmove>
}
8010569d:	c9                   	leave  
8010569e:	c3                   	ret    
...
801056a0:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801056a2:	eb 0c                	jmp    801056b0 <strncmp+0x11>
    n--, p++, q++;
801056a4:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801056a8:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801056ac:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
801056ce:	74 d4                	je     801056a4 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801056d0:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801056d4:	75 07                	jne    801056dd <strncmp+0x3e>
    return 0;
801056d6:	b8 00 00 00 00       	mov    $0x0,%eax
801056db:	eb 16                	jmp    801056f3 <strncmp+0x54>
...
80105705:	8d 50 ff             	lea    -0x1(%eax),%edx
80105708:	89 55 10             	mov    %edx,0x10(%ebp)
8010570b:	85 c0                	test   %eax,%eax
8010570d:	7e 1e                	jle    8010572d <strncpy+0x38>
8010570f:	8b 45 08             	mov    0x8(%ebp),%eax
80105712:	8d 50 01             	lea    0x1(%eax),%edx
80105715:	89 55 08             	mov    %edx,0x8(%ebp)
80105718:	8b 55 0c             	mov    0xc(%ebp),%edx
8010571b:	8d 4a 01             	lea    0x1(%edx),%ecx
8010571e:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105721:	0f b6 12             	movzbl (%edx),%edx
80105724:	88 10                	mov    %dl,(%eax)
80105726:	0f b6 00             	movzbl (%eax),%eax
80105729:	84 c0                	test   %al,%al
8010572b:	75 d5                	jne    80105702 <strncpy+0xd>
    ;
  while(n-- > 0)
8010572d:	eb 0c                	jmp    8010573b <strncpy+0x46>
    *s++ = 0;
8010572f:	8b 45 08             	mov    0x8(%ebp),%eax
80105732:	8d 50 01             	lea    0x1(%eax),%edx
80105735:	89 55 08             	mov    %edx,0x8(%ebp)
...
8010573e:	8d 50 ff             	lea    -0x1(%eax),%edx
80105741:	89 55 10             	mov    %edx,0x10(%ebp)
80105744:	85 c0                	test   %eax,%eax
80105746:	7f e7                	jg     8010572f <strncpy+0x3a>
    *s++ = 0;
  return os;
...
8010575d:	7f 05                	jg     80105764 <safestrcpy+0x17>
    return os;
8010575f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105762:	eb 31                	jmp    80105795 <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
80105764:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105768:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010576c:	7e 1e                	jle    8010578c <safestrcpy+0x3f>
8010576e:	8b 45 08             	mov    0x8(%ebp),%eax
80105771:	8d 50 01             	lea    0x1(%eax),%edx
80105774:	89 55 08             	mov    %edx,0x8(%ebp)
80105777:	8b 55 0c             	mov    0xc(%ebp),%edx
8010577a:	8d 4a 01             	lea    0x1(%edx),%ecx
8010577d:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105780:	0f b6 12             	movzbl (%edx),%edx
80105783:	88 10                	mov    %dl,(%eax)
80105785:	0f b6 00             	movzbl (%eax),%eax
80105788:	84 c0                	test   %al,%al
8010578a:	75 d8                	jne    80105764 <safestrcpy+0x17>
    ;
  *s = 0;
8010578c:	8b 45 08             	mov    0x8(%ebp),%eax
8010578f:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
8010579a:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
8010579d:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801057a4:	eb 04                	jmp    801057aa <strlen+0x13>
801057a6:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801057aa:	8b 55 fc             	mov    -0x4(%ebp),%edx
801057ad:	8b 45 08             	mov    0x8(%ebp),%eax
801057b0:	01 d0                	add    %edx,%eax
801057b2:	0f b6 00             	movzbl (%eax),%eax
801057b5:	84 c0                	test   %al,%al
801057b7:	75 ed                	jne    801057a6 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801057be:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801057c2:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801057c9:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801057ca:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801057cc:	89 d4                	mov    %edx,%esp
...
801057de:	3b 45 08             	cmp    0x8(%ebp),%eax
801057e1:	76 12                	jbe    801057f5 <fetchint+0x22>
801057e3:	8b 45 08             	mov    0x8(%ebp),%eax
801057e6:	8d 50 04             	lea    0x4(%eax),%edx
801057e9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057ef:	8b 00                	mov    (%eax),%eax
801057f1:	39 c2                	cmp    %eax,%edx
801057f3:	76 07                	jbe    801057fc <fetchint+0x29>
    return -1;
801057f5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057fa:	eb 0f                	jmp    8010580b <fetchint+0x38>
  *ip = *(int*)(addr);
801057fc:	8b 45 08             	mov    0x8(%ebp),%eax
801057ff:	8b 10                	mov    (%eax),%edx
...
8010581b:	3b 45 08             	cmp    0x8(%ebp),%eax
8010581e:	77 07                	ja     80105827 <fetchstr+0x1a>
    return -1;
80105820:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105825:	eb 46                	jmp    8010586d <fetchstr+0x60>
  *pp = (char*)addr;
80105827:	8b 55 08             	mov    0x8(%ebp),%edx
8010582a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010582d:	89 10                	mov    %edx,(%eax)
  ep = (char*)proc->sz;
8010582f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105835:	8b 00                	mov    (%eax),%eax
...
80105842:	eb 1c                	jmp    80105860 <fetchstr+0x53>
    if(*s == 0)
80105844:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105847:	0f b6 00             	movzbl (%eax),%eax
8010584a:	84 c0                	test   %al,%al
8010584c:	75 0e                	jne    8010585c <fetchstr+0x4f>
      return s - *pp;
8010584e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105851:	8b 45 0c             	mov    0xc(%ebp),%eax
80105854:	8b 00                	mov    (%eax),%eax
80105856:	29 c2                	sub    %eax,%edx
80105858:	89 d0                	mov    %edx,%eax
8010585a:	eb 11                	jmp    8010586d <fetchstr+0x60>
...
80105863:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105866:	72 dc                	jb     80105844 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
8010587b:	8b 40 24             	mov    0x24(%eax),%eax
8010587e:	8b 50 44             	mov    0x44(%eax),%edx
80105881:	8b 45 08             	mov    0x8(%ebp),%eax
80105884:	c1 e0 02             	shl    $0x2,%eax
80105887:	01 d0                	add    %edx,%eax
80105889:	8d 50 04             	lea    0x4(%eax),%edx
8010588c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010588f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105893:	89 14 24             	mov    %edx,(%esp)
80105896:	e8 38 ff ff ff       	call   801057d3 <fetchint>
}
8010589b:	c9                   	leave  
8010589c:	c3                   	ret    
...
80105902:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
80105905:	8d 45 fc             	lea    -0x4(%ebp),%eax
80105908:	89 44 24 04          	mov    %eax,0x4(%esp)
8010590c:	8b 45 08             	mov    0x8(%ebp),%eax
8010590f:	89 04 24             	mov    %eax,(%esp)
80105912:	e8 58 ff ff ff       	call   8010586f <argint>
80105917:	85 c0                	test   %eax,%eax
80105919:	79 07                	jns    80105922 <argstr+0x23>
    return -1;
8010591b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105920:	eb 12                	jmp    80105934 <argstr+0x35>
  return fetchstr(addr, pp);
80105922:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105925:	8b 55 0c             	mov    0xc(%ebp),%edx
80105928:	89 54 24 04          	mov    %edx,0x4(%esp)
8010592c:	89 04 24             	mov    %eax,(%esp)
8010592f:	e8 d9 fe ff ff       	call   8010580d <fetchstr>
}
80105934:	c9                   	leave  
80105935:	c3                   	ret    
...
8010593a:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
8010593d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105943:	8b 40 24             	mov    0x24(%eax),%eax
80105946:	8b 40 1c             	mov    0x1c(%eax),%eax
80105949:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
8010594c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105950:	7e 30                	jle    80105982 <syscall+0x4c>
80105952:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105955:	83 f8 1d             	cmp    $0x1d,%eax
80105958:	77 28                	ja     80105982 <syscall+0x4c>
8010595a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010595d:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105964:	85 c0                	test   %eax,%eax
80105966:	74 1a                	je     80105982 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105968:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010596e:	8b 58 24             	mov    0x24(%eax),%ebx
80105971:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105974:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
8010597b:	ff d0                	call   *%eax
8010597d:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105980:	eb 3d                	jmp    801059bf <syscall+0x89>
    cprintf("%s -> %d\n",
            syscall, proc->tf->eax);
    #endif
  } else {
...
80105988:	8d 48 78             	lea    0x78(%eax),%ecx
8010598b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105991:	8b 40 10             	mov    0x10(%eax),%eax
80105994:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105997:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010599b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010599f:	89 44 24 04          	mov    %eax,0x4(%esp)
801059a3:	c7 04 24 89 8e 10 80 	movl   $0x80108e89,(%esp)
801059aa:	e8 f1 a9 ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801059af:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059b5:	8b 40 24             	mov    0x24(%eax),%eax
801059b8:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
801059bf:	83 c4 24             	add    $0x24,%esp
801059c2:	5b                   	pop    %ebx
801059c3:	5d                   	pop    %ebp
801059c4:	c3                   	ret    
...
801059ce:	89 44 24 04          	mov    %eax,0x4(%esp)
801059d2:	8b 45 08             	mov    0x8(%ebp),%eax
801059d5:	89 04 24             	mov    %eax,(%esp)
801059d8:	e8 92 fe ff ff       	call   8010586f <argint>
801059dd:	85 c0                	test   %eax,%eax
801059df:	79 07                	jns    801059e8 <argfd+0x23>
    return -1;
801059e1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059e6:	eb 50                	jmp    80105a38 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
801059e8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059eb:	85 c0                	test   %eax,%eax
801059ed:	78 21                	js     80105a10 <argfd+0x4b>
801059ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059f2:	83 f8 0f             	cmp    $0xf,%eax
801059f5:	7f 19                	jg     80105a10 <argfd+0x4b>
801059f7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059fd:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105a00:	83 c2 0c             	add    $0xc,%edx
80105a03:	8b 44 90 04          	mov    0x4(%eax,%edx,4),%eax
80105a07:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a0a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a0e:	75 07                	jne    80105a17 <argfd+0x52>
    return -1;
80105a10:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a15:	eb 21                	jmp    80105a38 <argfd+0x73>
  if(pfd)
80105a17:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105a1b:	74 08                	je     80105a25 <argfd+0x60>
    *pfd = fd;
80105a1d:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105a20:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a23:	89 10                	mov    %edx,(%eax)
  if(pf)
80105a25:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a29:	74 08                	je     80105a33 <argfd+0x6e>
    *pf = f;
80105a2b:	8b 45 10             	mov    0x10(%ebp),%eax
...
80105a3d:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105a40:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105a47:	eb 30                	jmp    80105a79 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105a49:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a4f:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105a52:	83 c2 0c             	add    $0xc,%edx
80105a55:	8b 44 90 04          	mov    0x4(%eax,%edx,4),%eax
80105a59:	85 c0                	test   %eax,%eax
80105a5b:	75 18                	jne    80105a75 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105a5d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a63:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105a66:	8d 4a 0c             	lea    0xc(%edx),%ecx
80105a69:	8b 55 08             	mov    0x8(%ebp),%edx
80105a6c:	89 54 88 04          	mov    %edx,0x4(%eax,%ecx,4)
      return fd;
80105a70:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105a73:	eb 0f                	jmp    80105a84 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
...
80105a79:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105a7d:	7e ca                	jle    80105a49 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105a93:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105a9a:	00 
80105a9b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105aa2:	e8 1e ff ff ff       	call   801059c5 <argfd>
80105aa7:	85 c0                	test   %eax,%eax
80105aa9:	79 07                	jns    80105ab2 <sys_dup+0x2c>
    return -1;
80105aab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ab0:	eb 29                	jmp    80105adb <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105ab2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ab5:	89 04 24             	mov    %eax,(%esp)
80105ab8:	e8 7d ff ff ff       	call   80105a3a <fdalloc>
80105abd:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ac0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ac4:	79 07                	jns    80105acd <sys_dup+0x47>
    return -1;
80105ac6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105acb:	eb 0e                	jmp    80105adb <sys_dup+0x55>
  filedup(f);
80105acd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ad0:	89 04 24             	mov    %eax,(%esp)
80105ad3:	e8 c9 b4 ff ff       	call   80100fa1 <filedup>
  return fd;
...
80105ae0:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105ae6:	89 44 24 08          	mov    %eax,0x8(%esp)
80105aea:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105af1:	00 
80105af2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105af9:	e8 c7 fe ff ff       	call   801059c5 <argfd>
80105afe:	85 c0                	test   %eax,%eax
80105b00:	78 35                	js     80105b37 <sys_read+0x5a>
80105b02:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105b05:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b09:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105b10:	e8 5a fd ff ff       	call   8010586f <argint>
80105b15:	85 c0                	test   %eax,%eax
80105b17:	78 1e                	js     80105b37 <sys_read+0x5a>
80105b19:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b1c:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b20:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105b23:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b27:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105b2e:	e8 6a fd ff ff       	call   8010589d <argptr>
80105b33:	85 c0                	test   %eax,%eax
80105b35:	79 07                	jns    80105b3e <sys_read+0x61>
    return -1;
80105b37:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b3c:	eb 19                	jmp    80105b57 <sys_read+0x7a>
  return fileread(f, p, n);
80105b3e:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105b41:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105b44:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b47:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105b4b:	89 54 24 04          	mov    %edx,0x4(%esp)
80105b4f:	89 04 24             	mov    %eax,(%esp)
80105b52:	e8 b7 b5 ff ff       	call   8010110e <fileread>
}
80105b57:	c9                   	leave  
80105b58:	c3                   	ret    
...
80105b5c:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105b62:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b66:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b6d:	00 
80105b6e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105b75:	e8 4b fe ff ff       	call   801059c5 <argfd>
80105b7a:	85 c0                	test   %eax,%eax
80105b7c:	78 35                	js     80105bb3 <sys_write+0x5a>
80105b7e:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105b81:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b85:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105b8c:	e8 de fc ff ff       	call   8010586f <argint>
80105b91:	85 c0                	test   %eax,%eax
80105b93:	78 1e                	js     80105bb3 <sys_write+0x5a>
...
80105ba3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105baa:	e8 ee fc ff ff       	call   8010589d <argptr>
80105baf:	85 c0                	test   %eax,%eax
80105bb1:	79 07                	jns    80105bba <sys_write+0x61>
    return -1;
80105bb3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bb8:	eb 19                	jmp    80105bd3 <sys_write+0x7a>
  return filewrite(f, p, n);
80105bba:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105bbd:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105bc0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bc3:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105bc7:	89 54 24 04          	mov    %edx,0x4(%esp)
80105bcb:	89 04 24             	mov    %eax,(%esp)
80105bce:	e8 f7 b5 ff ff       	call   801011ca <filewrite>
}
80105bd3:	c9                   	leave  
80105bd4:	c3                   	ret    
...
80105bd8:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
  
  if(argfd(0, &fd, &f) < 0)
80105bdb:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105bde:	89 44 24 08          	mov    %eax,0x8(%esp)
80105be2:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105be5:	89 44 24 04          	mov    %eax,0x4(%esp)
80105be9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105bf0:	e8 d0 fd ff ff       	call   801059c5 <argfd>
80105bf5:	85 c0                	test   %eax,%eax
80105bf7:	79 07                	jns    80105c00 <sys_close+0x2b>
    return -1;
80105bf9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bfe:	eb 24                	jmp    80105c24 <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105c00:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c06:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105c09:	83 c2 0c             	add    $0xc,%edx
80105c0c:	c7 44 90 04 00 00 00 	movl   $0x0,0x4(%eax,%edx,4)
80105c13:	00 
  fileclose(f);
80105c14:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c17:	89 04 24             	mov    %eax,(%esp)
80105c1a:	e8 ca b3 ff ff       	call   80100fe9 <fileclose>
  return 0;
...
80105c33:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105c3a:	00 
80105c3b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105c42:	e8 7e fd ff ff       	call   801059c5 <argfd>
80105c47:	85 c0                	test   %eax,%eax
80105c49:	78 1f                	js     80105c6a <sys_fstat+0x44>
80105c4b:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105c52:	00 
80105c53:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105c56:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105c61:	e8 37 fc ff ff       	call   8010589d <argptr>
80105c66:	85 c0                	test   %eax,%eax
80105c68:	79 07                	jns    80105c71 <sys_fstat+0x4b>
    return -1;
80105c6a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c6f:	eb 12                	jmp    80105c83 <sys_fstat+0x5d>
  return filestat(f, st);
80105c71:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105c74:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c77:	89 54 24 04          	mov    %edx,0x4(%esp)
80105c7b:	89 04 24             	mov    %eax,(%esp)
80105c7e:	e8 3c b4 ff ff       	call   801010bf <filestat>
}
80105c83:	c9                   	leave  
80105c84:	c3                   	ret    
...
80105c88:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105c8b:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105c8e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c92:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105c99:	e8 61 fc ff ff       	call   801058ff <argstr>
80105c9e:	85 c0                	test   %eax,%eax
80105ca0:	78 17                	js     80105cb9 <sys_link+0x34>
80105ca2:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105ca5:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ca9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105cb0:	e8 4a fc ff ff       	call   801058ff <argstr>
80105cb5:	85 c0                	test   %eax,%eax
80105cb7:	79 0a                	jns    80105cc3 <sys_link+0x3e>
    return -1;
80105cb9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cbe:	e9 42 01 00 00       	jmp    80105e05 <sys_link+0x180>

  begin_op();
80105cc3:	e8 f4 d7 ff ff       	call   801034bc <begin_op>
  if((ip = namei(old)) == 0){
80105cc8:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105ccb:	89 04 24             	mov    %eax,(%esp)
80105cce:	e8 b2 c7 ff ff       	call   80102485 <namei>
80105cd3:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105cd6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105cda:	75 0f                	jne    80105ceb <sys_link+0x66>
    end_op();
80105cdc:	e8 5f d8 ff ff       	call   80103540 <end_op>
    return -1;
80105ce1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ce6:	e9 1a 01 00 00       	jmp    80105e05 <sys_link+0x180>
  }

  ilock(ip);
80105ceb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cee:	89 04 24             	mov    %eax,(%esp)
80105cf1:	e8 de bb ff ff       	call   801018d4 <ilock>
  if(ip->type == T_DIR){
80105cf6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cf9:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105cfd:	66 83 f8 01          	cmp    $0x1,%ax
80105d01:	75 1a                	jne    80105d1d <sys_link+0x98>
    iunlockput(ip);
80105d03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d06:	89 04 24             	mov    %eax,(%esp)
80105d09:	e8 50 be ff ff       	call   80101b5e <iunlockput>
    end_op();
80105d0e:	e8 2d d8 ff ff       	call   80103540 <end_op>
    return -1;
80105d13:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d18:	e9 e8 00 00 00       	jmp    80105e05 <sys_link+0x180>
  }

  ip->nlink++;
80105d1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d20:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105d24:	8d 50 01             	lea    0x1(%eax),%edx
...
80105deb:	e8 22 b9 ff ff       	call   80101712 <iupdate>
  iunlockput(ip);
80105df0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105df3:	89 04 24             	mov    %eax,(%esp)
80105df6:	e8 63 bd ff ff       	call   80101b5e <iunlockput>
  end_op();
80105dfb:	e8 40 d7 ff ff       	call   80103540 <end_op>
  return -1;
...
80105e0d:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105e14:	eb 4b                	jmp    80105e61 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105e16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e19:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105e20:	00 
80105e21:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e25:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105e28:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e2c:	8b 45 08             	mov    0x8(%ebp),%eax
80105e2f:	89 04 24             	mov    %eax,(%esp)
80105e32:	e8 b0 bf ff ff       	call   80101de7 <readi>
80105e37:	83 f8 10             	cmp    $0x10,%eax
80105e3a:	74 0c                	je     80105e48 <isdirempty+0x41>
      panic("isdirempty: readi");
80105e3c:	c7 04 24 a5 8e 10 80 	movl   $0x80108ea5,(%esp)
80105e43:	e8 f2 a6 ff ff       	call   8010053a <panic>
    if(de.inum != 0)
80105e48:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105e4c:	66 85 c0             	test   %ax,%ax
80105e4f:	74 07                	je     80105e58 <isdirempty+0x51>
      return 0;
80105e51:	b8 00 00 00 00       	mov    $0x0,%eax
80105e56:	eb 1b                	jmp    80105e73 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105e5b:	83 c0 10             	add    $0x10,%eax
80105e5e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e61:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105e64:	8b 45 08             	mov    0x8(%ebp),%eax
80105e67:	8b 40 18             	mov    0x18(%eax),%eax
80105e6a:	39 c2                	cmp    %eax,%edx
80105e6c:	72 a8                	jb     80105e16 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
80105e6e:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105e73:	c9                   	leave  
80105e74:	c3                   	ret    
...
80105e78:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105e7b:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105e7e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e82:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105e89:	e8 71 fa ff ff       	call   801058ff <argstr>
80105e8e:	85 c0                	test   %eax,%eax
80105e90:	79 0a                	jns    80105e9c <sys_unlink+0x27>
    return -1;
80105e92:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e97:	e9 af 01 00 00       	jmp    8010604b <sys_unlink+0x1d6>

  begin_op();
80105e9c:	e8 1b d6 ff ff       	call   801034bc <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105ea1:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105ea4:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105ea7:	89 54 24 04          	mov    %edx,0x4(%esp)
80105eab:	89 04 24             	mov    %eax,(%esp)
80105eae:	e8 f4 c5 ff ff       	call   801024a7 <nameiparent>
80105eb3:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105eb6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105eba:	75 0f                	jne    80105ecb <sys_unlink+0x56>
    end_op();
80105ebc:	e8 7f d6 ff ff       	call   80103540 <end_op>
    return -1;
80105ec1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ec6:	e9 80 01 00 00       	jmp    8010604b <sys_unlink+0x1d6>
  }

  ilock(dp);
80105ecb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ece:	89 04 24             	mov    %eax,(%esp)
80105ed1:	e8 fe b9 ff ff       	call   801018d4 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105ed6:	c7 44 24 04 b7 8e 10 	movl   $0x80108eb7,0x4(%esp)
80105edd:	80 
80105ede:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105ee1:	89 04 24             	mov    %eax,(%esp)
80105ee4:	e8 f1 c1 ff ff       	call   801020da <namecmp>
80105ee9:	85 c0                	test   %eax,%eax
80105eeb:	0f 84 45 01 00 00    	je     80106036 <sys_unlink+0x1c1>
80105ef1:	c7 44 24 04 b9 8e 10 	movl   $0x80108eb9,0x4(%esp)
80105ef8:	80 
80105ef9:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105efc:	89 04 24             	mov    %eax,(%esp)
80105eff:	e8 d6 c1 ff ff       	call   801020da <namecmp>
80105f04:	85 c0                	test   %eax,%eax
80105f06:	0f 84 2a 01 00 00    	je     80106036 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105f0c:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105f0f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f13:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105f16:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f1a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f1d:	89 04 24             	mov    %eax,(%esp)
80105f20:	e8 d7 c1 ff ff       	call   801020fc <dirlookup>
80105f25:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f28:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f2c:	75 05                	jne    80105f33 <sys_unlink+0xbe>
    goto bad;
80105f2e:	e9 03 01 00 00       	jmp    80106036 <sys_unlink+0x1c1>
  ilock(ip);
80105f33:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f36:	89 04 24             	mov    %eax,(%esp)
80105f39:	e8 96 b9 ff ff       	call   801018d4 <ilock>

  if(ip->nlink < 1)
80105f3e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f41:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f45:	66 85 c0             	test   %ax,%ax
80105f48:	7f 0c                	jg     80105f56 <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105f4a:	c7 04 24 bc 8e 10 80 	movl   $0x80108ebc,(%esp)
80105f51:	e8 e4 a5 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105f56:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f59:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105f5d:	66 83 f8 01          	cmp    $0x1,%ax
80105f61:	75 1f                	jne    80105f82 <sys_unlink+0x10d>
80105f63:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f66:	89 04 24             	mov    %eax,(%esp)
80105f69:	e8 99 fe ff ff       	call   80105e07 <isdirempty>
80105f6e:	85 c0                	test   %eax,%eax
80105f70:	75 10                	jne    80105f82 <sys_unlink+0x10d>
    iunlockput(ip);
80105f72:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f75:	89 04 24             	mov    %eax,(%esp)
80105f78:	e8 e1 bb ff ff       	call   80101b5e <iunlockput>
    goto bad;
80105f7d:	e9 b4 00 00 00       	jmp    80106036 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105f82:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105f89:	00 
80105f8a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105f91:	00 
80105f92:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105f95:	89 04 24             	mov    %eax,(%esp)
80105f98:	e8 90 f5 ff ff       	call   8010552d <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105f9d:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105fa0:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105fa7:	00 
80105fa8:	89 44 24 08          	mov    %eax,0x8(%esp)
80105fac:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105faf:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fb6:	89 04 24             	mov    %eax,(%esp)
80105fb9:	e8 8d bf ff ff       	call   80101f4b <writei>
80105fbe:	83 f8 10             	cmp    $0x10,%eax
80105fc1:	74 0c                	je     80105fcf <sys_unlink+0x15a>
    panic("unlink: writei");
80105fc3:	c7 04 24 ce 8e 10 80 	movl   $0x80108ece,(%esp)
80105fca:	e8 6b a5 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80105fcf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fd2:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105fd6:	66 83 f8 01          	cmp    $0x1,%ax
80105fda:	75 1c                	jne    80105ff8 <sys_unlink+0x183>
    dp->nlink--;
80105fdc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fdf:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105fe3:	8d 50 ff             	lea    -0x1(%eax),%edx
80105fe6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fe9:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105fed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ff0:	89 04 24             	mov    %eax,(%esp)
80105ff3:	e8 1a b7 ff ff       	call   80101712 <iupdate>
  }
  iunlockput(dp);
80105ff8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ffb:	89 04 24             	mov    %eax,(%esp)
80105ffe:	e8 5b bb ff ff       	call   80101b5e <iunlockput>
...
8010601a:	e8 f3 b6 ff ff       	call   80101712 <iupdate>
  iunlockput(ip);
8010601f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106022:	89 04 24             	mov    %eax,(%esp)
80106025:	e8 34 bb ff ff       	call   80101b5e <iunlockput>

  end_op();
8010602a:	e8 11 d5 ff ff       	call   80103540 <end_op>

  return 0;
8010602f:	b8 00 00 00 00       	mov    $0x0,%eax
80106034:	eb 15                	jmp    8010604b <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80106036:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106039:	89 04 24             	mov    %eax,(%esp)
8010603c:	e8 1d bb ff ff       	call   80101b5e <iunlockput>
  end_op();
80106041:	e8 fa d4 ff ff       	call   80103540 <end_op>
  return -1;
...
80106050:	83 ec 48             	sub    $0x48,%esp
80106053:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106056:	8b 55 10             	mov    0x10(%ebp),%edx
80106059:	8b 45 14             	mov    0x14(%ebp),%eax
8010605c:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106060:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80106064:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80106068:	8d 45 de             	lea    -0x22(%ebp),%eax
8010606b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010606f:	8b 45 08             	mov    0x8(%ebp),%eax
80106072:	89 04 24             	mov    %eax,(%esp)
80106075:	e8 2d c4 ff ff       	call   801024a7 <nameiparent>
8010607a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010607d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106081:	75 0a                	jne    8010608d <create+0x40>
    return 0;
80106083:	b8 00 00 00 00       	mov    $0x0,%eax
80106088:	e9 7e 01 00 00       	jmp    8010620b <create+0x1be>
  ilock(dp);
8010608d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106090:	89 04 24             	mov    %eax,(%esp)
80106093:	e8 3c b8 ff ff       	call   801018d4 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80106098:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010609b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010609f:	8d 45 de             	lea    -0x22(%ebp),%eax
801060a2:	89 44 24 04          	mov    %eax,0x4(%esp)
801060a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060a9:	89 04 24             	mov    %eax,(%esp)
801060ac:	e8 4b c0 ff ff       	call   801020fc <dirlookup>
801060b1:	89 45 f0             	mov    %eax,-0x10(%ebp)
801060b4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060b8:	74 47                	je     80106101 <create+0xb4>
    iunlockput(dp);
801060ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060bd:	89 04 24             	mov    %eax,(%esp)
801060c0:	e8 99 ba ff ff       	call   80101b5e <iunlockput>
    ilock(ip);
801060c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060c8:	89 04 24             	mov    %eax,(%esp)
801060cb:	e8 04 b8 ff ff       	call   801018d4 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801060d0:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801060d5:	75 15                	jne    801060ec <create+0x9f>
801060d7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060da:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801060de:	66 83 f8 02          	cmp    $0x2,%ax
801060e2:	75 08                	jne    801060ec <create+0x9f>
      return ip;
801060e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060e7:	e9 1f 01 00 00       	jmp    8010620b <create+0x1be>
    iunlockput(ip);
801060ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060ef:	89 04 24             	mov    %eax,(%esp)
801060f2:	e8 67 ba ff ff       	call   80101b5e <iunlockput>
    return 0;
801060f7:	b8 00 00 00 00       	mov    $0x0,%eax
801060fc:	e9 0a 01 00 00       	jmp    8010620b <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80106101:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80106105:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106108:	8b 00                	mov    (%eax),%eax
8010610a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010610e:	89 04 24             	mov    %eax,(%esp)
80106111:	e8 27 b5 ff ff       	call   8010163d <ialloc>
80106116:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106119:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010611d:	75 0c                	jne    8010612b <create+0xde>
    panic("create: ialloc");
8010611f:	c7 04 24 dd 8e 10 80 	movl   $0x80108edd,(%esp)
80106126:	e8 0f a4 ff ff       	call   8010053a <panic>

  ilock(ip);
8010612b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010612e:	89 04 24             	mov    %eax,(%esp)
80106131:	e8 9e b7 ff ff       	call   801018d4 <ilock>
  ip->major = major;
80106136:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106139:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
8010613d:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80106141:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106144:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80106148:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
8010614c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010614f:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106155:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106158:	89 04 24             	mov    %eax,(%esp)
8010615b:	e8 b2 b5 ff ff       	call   80101712 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106160:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106165:	75 6a                	jne    801061d1 <create+0x184>
    dp->nlink++;  // for ".."
80106167:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010616a:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010616e:	8d 50 01             	lea    0x1(%eax),%edx
80106171:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106174:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106178:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010617b:	89 04 24             	mov    %eax,(%esp)
8010617e:	e8 8f b5 ff ff       	call   80101712 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80106183:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106186:	8b 40 04             	mov    0x4(%eax),%eax
80106189:	89 44 24 08          	mov    %eax,0x8(%esp)
8010618d:	c7 44 24 04 b7 8e 10 	movl   $0x80108eb7,0x4(%esp)
80106194:	80 
80106195:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106198:	89 04 24             	mov    %eax,(%esp)
8010619b:	e8 25 c0 ff ff       	call   801021c5 <dirlink>
801061a0:	85 c0                	test   %eax,%eax
801061a2:	78 21                	js     801061c5 <create+0x178>
801061a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061a7:	8b 40 04             	mov    0x4(%eax),%eax
801061aa:	89 44 24 08          	mov    %eax,0x8(%esp)
801061ae:	c7 44 24 04 b9 8e 10 	movl   $0x80108eb9,0x4(%esp)
801061b5:	80 
801061b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061b9:	89 04 24             	mov    %eax,(%esp)
801061bc:	e8 04 c0 ff ff       	call   801021c5 <dirlink>
801061c1:	85 c0                	test   %eax,%eax
801061c3:	79 0c                	jns    801061d1 <create+0x184>
      panic("create dots");
801061c5:	c7 04 24 ec 8e 10 80 	movl   $0x80108eec,(%esp)
801061cc:	e8 69 a3 ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
801061d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061d4:	8b 40 04             	mov    0x4(%eax),%eax
801061d7:	89 44 24 08          	mov    %eax,0x8(%esp)
801061db:	8d 45 de             	lea    -0x22(%ebp),%eax
801061de:	89 44 24 04          	mov    %eax,0x4(%esp)
801061e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061e5:	89 04 24             	mov    %eax,(%esp)
801061e8:	e8 d8 bf ff ff       	call   801021c5 <dirlink>
801061ed:	85 c0                	test   %eax,%eax
801061ef:	79 0c                	jns    801061fd <create+0x1b0>
    panic("create: dirlink");
801061f1:	c7 04 24 f8 8e 10 80 	movl   $0x80108ef8,(%esp)
801061f8:	e8 3d a3 ff ff       	call   8010053a <panic>

  iunlockput(dp);
801061fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106200:	89 04 24             	mov    %eax,(%esp)
80106203:	e8 56 b9 ff ff       	call   80101b5e <iunlockput>
...
80106210:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106213:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106216:	89 44 24 04          	mov    %eax,0x4(%esp)
8010621a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106221:	e8 d9 f6 ff ff       	call   801058ff <argstr>
80106226:	85 c0                	test   %eax,%eax
80106228:	78 17                	js     80106241 <sys_open+0x34>
8010622a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010622d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106231:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106238:	e8 32 f6 ff ff       	call   8010586f <argint>
8010623d:	85 c0                	test   %eax,%eax
8010623f:	79 0a                	jns    8010624b <sys_open+0x3e>
    return -1;
80106241:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106246:	e9 5c 01 00 00       	jmp    801063a7 <sys_open+0x19a>

  begin_op();
8010624b:	e8 6c d2 ff ff       	call   801034bc <begin_op>

  if(omode & O_CREATE){
80106250:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106253:	25 00 02 00 00       	and    $0x200,%eax
80106258:	85 c0                	test   %eax,%eax
8010625a:	74 3b                	je     80106297 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
8010625c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010625f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106266:	00 
80106267:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010626e:	00 
8010626f:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80106276:	00 
80106277:	89 04 24             	mov    %eax,(%esp)
8010627a:	e8 ce fd ff ff       	call   8010604d <create>
8010627f:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80106282:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106286:	75 6b                	jne    801062f3 <sys_open+0xe6>
      end_op();
80106288:	e8 b3 d2 ff ff       	call   80103540 <end_op>
      return -1;
8010628d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106292:	e9 10 01 00 00       	jmp    801063a7 <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
80106297:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010629a:	89 04 24             	mov    %eax,(%esp)
8010629d:	e8 e3 c1 ff ff       	call   80102485 <namei>
801062a2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062a5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062a9:	75 0f                	jne    801062ba <sys_open+0xad>
      end_op();
801062ab:	e8 90 d2 ff ff       	call   80103540 <end_op>
      return -1;
801062b0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062b5:	e9 ed 00 00 00       	jmp    801063a7 <sys_open+0x19a>
    }
    ilock(ip);
801062ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062bd:	89 04 24             	mov    %eax,(%esp)
801062c0:	e8 0f b6 ff ff       	call   801018d4 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801062c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062c8:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801062cc:	66 83 f8 01          	cmp    $0x1,%ax
801062d0:	75 21                	jne    801062f3 <sys_open+0xe6>
801062d2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062d5:	85 c0                	test   %eax,%eax
801062d7:	74 1a                	je     801062f3 <sys_open+0xe6>
      iunlockput(ip);
801062d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062dc:	89 04 24             	mov    %eax,(%esp)
801062df:	e8 7a b8 ff ff       	call   80101b5e <iunlockput>
      end_op();
801062e4:	e8 57 d2 ff ff       	call   80103540 <end_op>
      return -1;
801062e9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062ee:	e9 b4 00 00 00       	jmp    801063a7 <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
801062f3:	e8 49 ac ff ff       	call   80100f41 <filealloc>
801062f8:	89 45 f0             	mov    %eax,-0x10(%ebp)
801062fb:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801062ff:	74 14                	je     80106315 <sys_open+0x108>
80106301:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106304:	89 04 24             	mov    %eax,(%esp)
80106307:	e8 2e f7 ff ff       	call   80105a3a <fdalloc>
8010630c:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010630f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106313:	79 28                	jns    8010633d <sys_open+0x130>
    if(f)
80106315:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106319:	74 0b                	je     80106326 <sys_open+0x119>
      fileclose(f);
8010631b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010631e:	89 04 24             	mov    %eax,(%esp)
80106321:	e8 c3 ac ff ff       	call   80100fe9 <fileclose>
    iunlockput(ip);
80106326:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106329:	89 04 24             	mov    %eax,(%esp)
8010632c:	e8 2d b8 ff ff       	call   80101b5e <iunlockput>
    end_op();
80106331:	e8 0a d2 ff ff       	call   80103540 <end_op>
    return -1;
80106336:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010633b:	eb 6a                	jmp    801063a7 <sys_open+0x19a>
  }
  iunlock(ip);
8010633d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106340:	89 04 24             	mov    %eax,(%esp)
80106343:	e8 e0 b6 ff ff       	call   80101a28 <iunlock>
  end_op();
80106348:	e8 f3 d1 ff ff       	call   80103540 <end_op>
...
80106384:	75 0a                	jne    80106390 <sys_open+0x183>
80106386:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106389:	83 e0 02             	and    $0x2,%eax
8010638c:	85 c0                	test   %eax,%eax
8010638e:	74 07                	je     80106397 <sys_open+0x18a>
80106390:	b8 01 00 00 00       	mov    $0x1,%eax
80106395:	eb 05                	jmp    8010639c <sys_open+0x18f>
...
801063a1:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
801063a4:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
801063a7:	c9                   	leave  
801063a8:	c3                   	ret    
...
801063ac:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801063af:	e8 08 d1 ff ff       	call   801034bc <begin_op>
...
801063c2:	e8 38 f5 ff ff       	call   801058ff <argstr>
801063c7:	85 c0                	test   %eax,%eax
801063c9:	78 2c                	js     801063f7 <sys_mkdir+0x4e>
801063cb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063ce:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801063d5:	00 
801063d6:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801063dd:	00 
801063de:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801063e5:	00 
801063e6:	89 04 24             	mov    %eax,(%esp)
801063e9:	e8 5f fc ff ff       	call   8010604d <create>
801063ee:	89 45 f4             	mov    %eax,-0xc(%ebp)
801063f1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801063f5:	75 0c                	jne    80106403 <sys_mkdir+0x5a>
    end_op();
801063f7:	e8 44 d1 ff ff       	call   80103540 <end_op>
    return -1;
801063fc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106401:	eb 15                	jmp    80106418 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106403:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106406:	89 04 24             	mov    %eax,(%esp)
80106409:	e8 50 b7 ff ff       	call   80101b5e <iunlockput>
  end_op();
...
8010641d:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_op();
80106420:	e8 97 d0 ff ff       	call   801034bc <begin_op>
  if((len=argstr(0, &path)) < 0 ||
80106425:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106428:	89 44 24 04          	mov    %eax,0x4(%esp)
8010642c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106433:	e8 c7 f4 ff ff       	call   801058ff <argstr>
80106438:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010643b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010643f:	78 5e                	js     8010649f <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80106441:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106444:	89 44 24 04          	mov    %eax,0x4(%esp)
80106448:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010644f:	e8 1b f4 ff ff       	call   8010586f <argint>
  char *path;
  int len;
  int major, minor;
...
80106456:	78 47                	js     8010649f <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106458:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010645b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010645f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106466:	e8 04 f4 ff ff       	call   8010586f <argint>
  int len;
  int major, minor;
...
8010646d:	78 30                	js     8010649f <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
8010646f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106472:	0f bf c8             	movswl %ax,%ecx
80106475:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106478:	0f bf d0             	movswl %ax,%edx
8010647b:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010647e:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106482:	89 54 24 08          	mov    %edx,0x8(%esp)
80106486:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010648d:	00 
8010648e:	89 04 24             	mov    %eax,(%esp)
80106491:	e8 b7 fb ff ff       	call   8010604d <create>
80106496:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106499:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010649d:	75 0c                	jne    801064ab <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
8010649f:	e8 9c d0 ff ff       	call   80103540 <end_op>
    return -1;
801064a4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064a9:	eb 15                	jmp    801064c0 <sys_mknod+0xa6>
  }
  iunlockput(ip);
801064ab:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064ae:	89 04 24             	mov    %eax,(%esp)
801064b1:	e8 a8 b6 ff ff       	call   80101b5e <iunlockput>
  end_op();
801064b6:	e8 85 d0 ff ff       	call   80103540 <end_op>
  return 0;
...
8010656a:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106573:	89 44 24 04          	mov    %eax,0x4(%esp)
80106577:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010657e:	e8 7c f3 ff ff       	call   801058ff <argstr>
80106583:	85 c0                	test   %eax,%eax
80106585:	78 1a                	js     801065a1 <sys_exec+0x3a>
80106587:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
8010658d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106591:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106598:	e8 d2 f2 ff ff       	call   8010586f <argint>
8010659d:	85 c0                	test   %eax,%eax
8010659f:	79 0a                	jns    801065ab <sys_exec+0x44>
    return -1;
801065a1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065a6:	e9 c8 00 00 00       	jmp    80106673 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
801065ab:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801065b2:	00 
801065b3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801065ba:	00 
801065bb:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801065c1:	89 04 24             	mov    %eax,(%esp)
801065c4:	e8 64 ef ff ff       	call   8010552d <memset>
  for(i=0;; i++){
801065c9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801065d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065d3:	83 f8 1f             	cmp    $0x1f,%eax
801065d6:	76 0a                	jbe    801065e2 <sys_exec+0x7b>
      return -1;
801065d8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065dd:	e9 91 00 00 00       	jmp    80106673 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801065e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065e5:	c1 e0 02             	shl    $0x2,%eax
801065e8:	89 c2                	mov    %eax,%edx
801065ea:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801065f0:	01 c2                	add    %eax,%edx
801065f2:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
801065f8:	89 44 24 04          	mov    %eax,0x4(%esp)
801065fc:	89 14 24             	mov    %edx,(%esp)
801065ff:	e8 cf f1 ff ff       	call   801057d3 <fetchint>
80106604:	85 c0                	test   %eax,%eax
80106606:	79 07                	jns    8010660f <sys_exec+0xa8>
      return -1;
80106608:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010660d:	eb 64                	jmp    80106673 <sys_exec+0x10c>
    if(uarg == 0){
8010660f:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106615:	85 c0                	test   %eax,%eax
80106617:	75 26                	jne    8010663f <sys_exec+0xd8>
      argv[i] = 0;
80106619:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010661c:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106623:	00 00 00 00 
      break;
80106627:	90                   	nop
    }
...
8010662b:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106631:	89 54 24 04          	mov    %edx,0x4(%esp)
80106635:	89 04 24             	mov    %eax,(%esp)
80106638:	e8 cd a4 ff ff       	call   80100b0a <exec>
8010663d:	eb 34                	jmp    80106673 <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
8010663f:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106645:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106648:	c1 e2 02             	shl    $0x2,%edx
8010664b:	01 c2                	add    %eax,%edx
8010664d:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106653:	89 54 24 04          	mov    %edx,0x4(%esp)
80106657:	89 04 24             	mov    %eax,(%esp)
8010665a:	e8 ae f1 ff ff       	call   8010580d <fetchstr>
8010665f:	85 c0                	test   %eax,%eax
80106661:	79 07                	jns    8010666a <sys_exec+0x103>
      return -1;
80106663:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106668:	eb 09                	jmp    80106673 <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
8010666a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
8010666e:	e9 5d ff ff ff       	jmp    801065d0 <sys_exec+0x69>
  return exec(path, argv);
}
80106673:	c9                   	leave  
80106674:	c3                   	ret    
...
80106678:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
8010667b:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106682:	00 
80106683:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106686:	89 44 24 04          	mov    %eax,0x4(%esp)
8010668a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106691:	e8 07 f2 ff ff       	call   8010589d <argptr>
80106696:	85 c0                	test   %eax,%eax
80106698:	79 0a                	jns    801066a4 <sys_pipe+0x2f>
    return -1;
8010669a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010669f:	e9 9b 00 00 00       	jmp    8010673f <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
801066a4:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801066a7:	89 44 24 04          	mov    %eax,0x4(%esp)
801066ab:	8d 45 e8             	lea    -0x18(%ebp),%eax
801066ae:	89 04 24             	mov    %eax,(%esp)
801066b1:	e8 12 d9 ff ff       	call   80103fc8 <pipealloc>
801066b6:	85 c0                	test   %eax,%eax
801066b8:	79 07                	jns    801066c1 <sys_pipe+0x4c>
    return -1;
801066ba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066bf:	eb 7e                	jmp    8010673f <sys_pipe+0xca>
  fd0 = -1;
801066c1:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801066c8:	8b 45 e8             	mov    -0x18(%ebp),%eax
801066cb:	89 04 24             	mov    %eax,(%esp)
801066ce:	e8 67 f3 ff ff       	call   80105a3a <fdalloc>
801066d3:	89 45 f4             	mov    %eax,-0xc(%ebp)
801066d6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801066da:	78 14                	js     801066f0 <sys_pipe+0x7b>
801066dc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801066df:	89 04 24             	mov    %eax,(%esp)
801066e2:	e8 53 f3 ff ff       	call   80105a3a <fdalloc>
801066e7:	89 45 f0             	mov    %eax,-0x10(%ebp)
801066ea:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801066ee:	79 37                	jns    80106727 <sys_pipe+0xb2>
    if(fd0 >= 0)
801066f0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801066f4:	78 14                	js     8010670a <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
801066f6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066fc:	8b 55 f4             	mov    -0xc(%ebp),%edx
801066ff:	83 c2 0c             	add    $0xc,%edx
80106702:	c7 44 90 04 00 00 00 	movl   $0x0,0x4(%eax,%edx,4)
80106709:	00 
    fileclose(rf);
8010670a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010670d:	89 04 24             	mov    %eax,(%esp)
80106710:	e8 d4 a8 ff ff       	call   80100fe9 <fileclose>
    fileclose(wf);
80106715:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106718:	89 04 24             	mov    %eax,(%esp)
8010671b:	e8 c9 a8 ff ff       	call   80100fe9 <fileclose>
    return -1;
80106720:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106725:	eb 18                	jmp    8010673f <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106727:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010672a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010672d:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
8010672f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106732:	8d 50 04             	lea    0x4(%eax),%edx
80106735:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106738:	89 02                	mov    %eax,(%edx)
  return 0;
...
80106744:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106747:	e8 1f e0 ff ff       	call   8010476b <fork>
}
8010674c:	c9                   	leave  
8010674d:	c3                   	ret    
...
80106751:	83 ec 08             	sub    $0x8,%esp
  exit();
80106754:	e8 ec e1 ff ff       	call   80104945 <exit>
...
80106763:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106766:	e8 ff e2 ff ff       	call   80104a6a <wait>
}
8010676b:	c9                   	leave  
8010676c:	c3                   	ret    
...
80106770:	83 ec 28             	sub    $0x28,%esp
  int pid;
...
80106781:	e8 e9 f0 ff ff       	call   8010586f <argint>
80106786:	85 c0                	test   %eax,%eax
80106788:	79 07                	jns    80106791 <sys_kill+0x24>
    return -1;
8010678a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010678f:	eb 0b                	jmp    8010679c <sys_kill+0x2f>
  return kill(pid);
80106791:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106794:	89 04 24             	mov    %eax,(%esp)
80106797:	e8 92 e6 ff ff       	call   80104e2e <kill>
}
8010679c:	c9                   	leave  
8010679d:	c3                   	ret    
...
801067a7:	8b 40 10             	mov    0x10(%eax),%eax
}
801067aa:	5d                   	pop    %ebp
801067ab:	c3                   	ret    
...
801067f9:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
801067fc:	8d 45 f0             	lea    -0x10(%ebp),%eax
801067ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80106803:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010680a:	e8 60 f0 ff ff       	call   8010586f <argint>
8010680f:	85 c0                	test   %eax,%eax
80106811:	79 07                	jns    8010681a <sys_sleep+0x24>
    return -1;
80106813:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106818:	eb 6c                	jmp    80106886 <sys_sleep+0x90>
  acquire(&tickslock);
8010681a:	c7 04 24 e0 5d 11 80 	movl   $0x80115de0,(%esp)
80106821:	e8 b3 ea ff ff       	call   801052d9 <acquire>
  ticks0 = ticks;
80106826:	a1 20 66 11 80       	mov    0x80116620,%eax
8010682b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
8010682e:	eb 34                	jmp    80106864 <sys_sleep+0x6e>
    if(proc->killed){
80106830:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106836:	8b 40 30             	mov    0x30(%eax),%eax
80106839:	85 c0                	test   %eax,%eax
8010683b:	74 13                	je     80106850 <sys_sleep+0x5a>
      release(&tickslock);
8010683d:	c7 04 24 e0 5d 11 80 	movl   $0x80115de0,(%esp)
80106844:	e8 f2 ea ff ff       	call   8010533b <release>
      return -1;
80106849:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010684e:	eb 36                	jmp    80106886 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106850:	c7 44 24 04 e0 5d 11 	movl   $0x80115de0,0x4(%esp)
80106857:	80 
80106858:	c7 04 24 20 66 11 80 	movl   $0x80116620,(%esp)
8010685f:	e8 c3 e4 ff ff       	call   80104d27 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106864:	a1 20 66 11 80       	mov    0x80116620,%eax
80106869:	2b 45 f4             	sub    -0xc(%ebp),%eax
8010686c:	89 c2                	mov    %eax,%edx
8010686e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106871:	39 c2                	cmp    %eax,%edx
80106873:	72 bb                	jb     80106830 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106875:	c7 04 24 e0 5d 11 80 	movl   $0x80115de0,(%esp)
8010687c:	e8 ba ea ff ff       	call   8010533b <release>
  return 0;
...
8010688b:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
8010688e:	c7 04 24 e0 5d 11 80 	movl   $0x80115de0,(%esp)
80106895:	e8 3f ea ff ff       	call   801052d9 <acquire>
  xticks = ticks;
8010689a:	a1 20 66 11 80       	mov    0x80116620,%eax
8010689f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801068a2:	c7 04 24 e0 5d 11 80 	movl   $0x80115de0,(%esp)
801068a9:	e8 8d ea ff ff       	call   8010533b <release>
  return xticks;
...
801068b9:	c7 44 24 08 18 00 00 	movl   $0x18,0x8(%esp)
801068c0:	00 
801068c1:	8d 45 f4             	lea    -0xc(%ebp),%eax
801068c4:	89 44 24 04          	mov    %eax,0x4(%esp)
801068c8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068cf:	e8 c9 ef ff ff       	call   8010589d <argptr>
801068d4:	85 c0                	test   %eax,%eax
801068d6:	79 07                	jns    801068df <sys_date+0x2c>
     return -1;
801068d8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068dd:	eb 10                	jmp    801068ef <sys_date+0x3c>
   cmostime(r);
801068df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068e2:	89 04 24             	mov    %eax,(%esp)
801068e5:	e8 6c c8 ff ff       	call   80103156 <cmostime>
   return 0;
...
801068fa:	8b 40 14             	mov    0x14(%eax),%eax
}
801068fd:	5d                   	pop    %ebp
801068fe:	c3                   	ret    
...
80106908:	8b 40 18             	mov    0x18(%eax),%eax
}
8010690b:	5d                   	pop    %ebp
8010690c:	c3                   	ret    

8010690d <sys_getppid>:
...
80106916:	8b 40 1c             	mov    0x1c(%eax),%eax
}
80106919:	5d                   	pop    %ebp
8010691a:	c3                   	ret    
...
8010692f:	e8 3b ef ff ff       	call   8010586f <argint>
80106934:	85 c0                	test   %eax,%eax
80106936:	79 07                	jns    8010693f <sys_setuid+0x24>
    return -1;
80106938:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010693d:	eb 11                	jmp    80106950 <sys_setuid+0x35>
  proc->uid = uid;
8010693f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106945:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106948:	89 50 14             	mov    %edx,0x14(%eax)
  return 0;
8010694b:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106950:	c9                   	leave  
80106951:	c3                   	ret    
...
80106955:	83 ec 28             	sub    $0x28,%esp
  int gid;

  if(argint(0, &gid) < 0)
80106958:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010695b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010695f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106966:	e8 04 ef ff ff       	call   8010586f <argint>
8010696b:	85 c0                	test   %eax,%eax
8010696d:	79 07                	jns    80106976 <sys_setgid+0x24>
    return -1;
8010696f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106974:	eb 11                	jmp    80106987 <sys_setgid+0x35>
  proc->gid = gid;
80106976:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010697c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010697f:	89 50 18             	mov    %edx,0x18(%eax)
  return 0;
...
8010699d:	e8 cd ee ff ff       	call   8010586f <argint>
801069a2:	85 c0                	test   %eax,%eax
801069a4:	78 1f                	js     801069c5 <sys_getprocs+0x3c>
801069a6:	c7 44 24 08 3c 00 00 	movl   $0x3c,0x8(%esp)
801069ad:	00 
801069ae:	8d 45 f0             	lea    -0x10(%ebp),%eax
801069b1:	89 44 24 04          	mov    %eax,0x4(%esp)
801069b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801069bc:	e8 dc ee ff ff       	call   8010589d <argptr>
801069c1:	85 c0                	test   %eax,%eax
801069c3:	79 07                	jns    801069cc <sys_getprocs+0x43>
    return -1;
801069c5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801069ca:	eb 12                	jmp    801069de <sys_getprocs+0x55>

  return getProcInfo(max, table);
801069cc:	8b 55 f0             	mov    -0x10(%ebp),%edx
801069cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069d2:	89 54 24 04          	mov    %edx,0x4(%esp)
801069d6:	89 04 24             	mov    %eax,(%esp)
801069d9:	e8 de e5 ff ff       	call   80104fbc <getProcInfo>
}
801069de:	c9                   	leave  
801069df:	c3                   	ret    

801069e0 <sys_setpriority>:
...
801069f4:	e8 76 ee ff ff       	call   8010586f <argint>
801069f9:	85 c0                	test   %eax,%eax
801069fb:	78 17                	js     80106a14 <sys_setpriority+0x34>
801069fd:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106a00:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106a0b:	e8 5f ee ff ff       	call   8010586f <argint>
80106a10:	85 c0                	test   %eax,%eax
80106a12:	79 07                	jns    80106a1b <sys_setpriority+0x3b>
    return -1;
80106a14:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a19:	eb 28                	jmp    80106a43 <sys_setpriority+0x63>
  if (priority < 0 || priority > 2)
80106a1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a1e:	85 c0                	test   %eax,%eax
80106a20:	78 08                	js     80106a2a <sys_setpriority+0x4a>
80106a22:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a25:	83 f8 02             	cmp    $0x2,%eax
80106a28:	7e 07                	jle    80106a31 <sys_setpriority+0x51>
    return -1;
80106a2a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a2f:	eb 12                	jmp    80106a43 <sys_setpriority+0x63>

  return setpq(pid, priority);
80106a31:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106a34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a37:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a3b:	89 04 24             	mov    %eax,(%esp)
80106a3e:	e8 93 e7 ff ff       	call   801051d6 <setpq>
}
80106a43:	c9                   	leave  
80106a44:	c3                   	ret    
...
80106a4b:	8b 55 08             	mov    0x8(%ebp),%edx
80106a4e:	8b 45 0c             	mov    0xc(%ebp),%eax
80106a51:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106a55:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106a58:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106a5c:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106a60:	ee                   	out    %al,(%dx)
}
80106a61:	c9                   	leave  
80106a62:	c3                   	ret    
...
80106a66:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
80106a69:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106a70:	00 
80106a71:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106a78:	e8 c8 ff ff ff       	call   80106a45 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106a7d:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106a84:	00 
80106a85:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106a8c:	e8 b4 ff ff ff       	call   80106a45 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106a91:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106a98:	00 
80106a99:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106aa0:	e8 a0 ff ff ff       	call   80106a45 <outb>
  picenable(IRQ_TIMER);
80106aa5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106aac:	e8 aa d3 ff ff       	call   80103e5b <picenable>
}
80106ab1:	c9                   	leave  
80106ab2:	c3                   	ret    
...
80106ab4:	06                   	push   %es
  pushl %fs
80106ab5:	0f a0                	push   %fs
  pushl %gs
80106ab7:	0f a8                	push   %gs
  pushal
80106ab9:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106aba:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106abe:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106ac0:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106ac2:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106ac6:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106ac8:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106aca:	54                   	push   %esp
  call trap
80106acb:	e8 d8 01 00 00       	call   80106ca8 <trap>
  addl $4, %esp
80106ad0:	83 c4 04             	add    $0x4,%esp
...
80106ad3:	61                   	popa   
  popl %gs
80106ad4:	0f a9                	pop    %gs
  popl %fs
80106ad6:	0f a1                	pop    %fs
  popl %es
80106ad8:	07                   	pop    %es
  popl %ds
80106ad9:	1f                   	pop    %ds
...
80106ae7:	83 e8 01             	sub    $0x1,%eax
80106aea:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106aee:	8b 45 08             	mov    0x8(%ebp),%eax
80106af1:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106af5:	8b 45 08             	mov    0x8(%ebp),%eax
80106af8:	c1 e8 10             	shr    $0x10,%eax
80106afb:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106aff:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106b02:	0f 01 18             	lidtl  (%eax)
}
80106b05:	c9                   	leave  
80106b06:	c3                   	ret    
...
80106b0d:	0f 20 d0             	mov    %cr2,%eax
80106b10:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
...
80106b1b:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106b1e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106b25:	e9 c3 00 00 00       	jmp    80106bed <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106b2a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b2d:	8b 04 85 b8 c0 10 80 	mov    -0x7fef3f48(,%eax,4),%eax
80106b34:	89 c2                	mov    %eax,%edx
80106b36:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b39:	66 89 14 c5 20 5e 11 	mov    %dx,-0x7feea1e0(,%eax,8)
80106b40:	80 
80106b41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b44:	66 c7 04 c5 22 5e 11 	movw   $0x8,-0x7feea1de(,%eax,8)
80106b4b:	80 08 00 
80106b4e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b51:	0f b6 14 c5 24 5e 11 	movzbl -0x7feea1dc(,%eax,8),%edx
80106b58:	80 
80106b59:	83 e2 e0             	and    $0xffffffe0,%edx
80106b5c:	88 14 c5 24 5e 11 80 	mov    %dl,-0x7feea1dc(,%eax,8)
80106b63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b66:	0f b6 14 c5 24 5e 11 	movzbl -0x7feea1dc(,%eax,8),%edx
80106b6d:	80 
80106b6e:	83 e2 1f             	and    $0x1f,%edx
80106b71:	88 14 c5 24 5e 11 80 	mov    %dl,-0x7feea1dc(,%eax,8)
80106b78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b7b:	0f b6 14 c5 25 5e 11 	movzbl -0x7feea1db(,%eax,8),%edx
80106b82:	80 
80106b83:	83 e2 f0             	and    $0xfffffff0,%edx
80106b86:	83 ca 0e             	or     $0xe,%edx
80106b89:	88 14 c5 25 5e 11 80 	mov    %dl,-0x7feea1db(,%eax,8)
80106b90:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b93:	0f b6 14 c5 25 5e 11 	movzbl -0x7feea1db(,%eax,8),%edx
80106b9a:	80 
80106b9b:	83 e2 ef             	and    $0xffffffef,%edx
80106b9e:	88 14 c5 25 5e 11 80 	mov    %dl,-0x7feea1db(,%eax,8)
80106ba5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ba8:	0f b6 14 c5 25 5e 11 	movzbl -0x7feea1db(,%eax,8),%edx
80106baf:	80 
80106bb0:	83 e2 9f             	and    $0xffffff9f,%edx
80106bb3:	88 14 c5 25 5e 11 80 	mov    %dl,-0x7feea1db(,%eax,8)
80106bba:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bbd:	0f b6 14 c5 25 5e 11 	movzbl -0x7feea1db(,%eax,8),%edx
80106bc4:	80 
80106bc5:	83 ca 80             	or     $0xffffff80,%edx
80106bc8:	88 14 c5 25 5e 11 80 	mov    %dl,-0x7feea1db(,%eax,8)
80106bcf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bd2:	8b 04 85 b8 c0 10 80 	mov    -0x7fef3f48(,%eax,4),%eax
80106bd9:	c1 e8 10             	shr    $0x10,%eax
80106bdc:	89 c2                	mov    %eax,%edx
80106bde:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106be1:	66 89 14 c5 26 5e 11 	mov    %dx,-0x7feea1da(,%eax,8)
80106be8:	80 
void
tvinit(void)
{
...
80106bed:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106bf4:	0f 8e 30 ff ff ff    	jle    80106b2a <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106bfa:	a1 b8 c1 10 80       	mov    0x8010c1b8,%eax
80106bff:	66 a3 20 60 11 80    	mov    %ax,0x80116020
80106c05:	66 c7 05 22 60 11 80 	movw   $0x8,0x80116022
80106c0c:	08 00 
80106c0e:	0f b6 05 24 60 11 80 	movzbl 0x80116024,%eax
80106c15:	83 e0 e0             	and    $0xffffffe0,%eax
80106c18:	a2 24 60 11 80       	mov    %al,0x80116024
80106c1d:	0f b6 05 24 60 11 80 	movzbl 0x80116024,%eax
80106c24:	83 e0 1f             	and    $0x1f,%eax
80106c27:	a2 24 60 11 80       	mov    %al,0x80116024
80106c2c:	0f b6 05 25 60 11 80 	movzbl 0x80116025,%eax
80106c33:	83 c8 0f             	or     $0xf,%eax
80106c36:	a2 25 60 11 80       	mov    %al,0x80116025
80106c3b:	0f b6 05 25 60 11 80 	movzbl 0x80116025,%eax
80106c42:	83 e0 ef             	and    $0xffffffef,%eax
80106c45:	a2 25 60 11 80       	mov    %al,0x80116025
80106c4a:	0f b6 05 25 60 11 80 	movzbl 0x80116025,%eax
80106c51:	83 c8 60             	or     $0x60,%eax
80106c54:	a2 25 60 11 80       	mov    %al,0x80116025
80106c59:	0f b6 05 25 60 11 80 	movzbl 0x80116025,%eax
80106c60:	83 c8 80             	or     $0xffffff80,%eax
80106c63:	a2 25 60 11 80       	mov    %al,0x80116025
80106c68:	a1 b8 c1 10 80       	mov    0x8010c1b8,%eax
80106c6d:	c1 e8 10             	shr    $0x10,%eax
80106c70:	66 a3 26 60 11 80    	mov    %ax,0x80116026
  
  initlock(&tickslock, "time");
80106c76:	c7 44 24 04 08 8f 10 	movl   $0x80108f08,0x4(%esp)
80106c7d:	80 
80106c7e:	c7 04 24 e0 5d 11 80 	movl   $0x80115de0,(%esp)
80106c85:	e8 2e e6 ff ff       	call   801052b8 <initlock>
}
80106c8a:	c9                   	leave  
80106c8b:	c3                   	ret    
...
80106c8f:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106c92:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106c99:	00 
80106c9a:	c7 04 24 20 5e 11 80 	movl   $0x80115e20,(%esp)
80106ca1:	e8 38 fe ff ff       	call   80106ade <lidt>
}
80106ca6:	c9                   	leave  
80106ca7:	c3                   	ret    
...
80106cae:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106cb1:	8b 45 08             	mov    0x8(%ebp),%eax
80106cb4:	8b 40 30             	mov    0x30(%eax),%eax
80106cb7:	83 f8 40             	cmp    $0x40,%eax
80106cba:	75 3f                	jne    80106cfb <trap+0x53>
    if(proc->killed)
80106cbc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106cc2:	8b 40 30             	mov    0x30(%eax),%eax
80106cc5:	85 c0                	test   %eax,%eax
80106cc7:	74 05                	je     80106cce <trap+0x26>
      exit();
80106cc9:	e8 77 dc ff ff       	call   80104945 <exit>
    proc->tf = tf;
80106cce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106cd4:	8b 55 08             	mov    0x8(%ebp),%edx
80106cd7:	89 50 24             	mov    %edx,0x24(%eax)
    syscall();
80106cda:	e8 57 ec ff ff       	call   80105936 <syscall>
    if(proc->killed)
80106cdf:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106ce5:	8b 40 30             	mov    0x30(%eax),%eax
80106ce8:	85 c0                	test   %eax,%eax
80106cea:	74 0a                	je     80106cf6 <trap+0x4e>
      exit();
80106cec:	e8 54 dc ff ff       	call   80104945 <exit>
    return;
80106cf1:	e9 2d 02 00 00       	jmp    80106f23 <trap+0x27b>
80106cf6:	e9 28 02 00 00       	jmp    80106f23 <trap+0x27b>
  }

  switch(tf->trapno){
80106cfb:	8b 45 08             	mov    0x8(%ebp),%eax
80106cfe:	8b 40 30             	mov    0x30(%eax),%eax
80106d01:	83 e8 20             	sub    $0x20,%eax
80106d04:	83 f8 1f             	cmp    $0x1f,%eax
80106d07:	0f 87 bc 00 00 00    	ja     80106dc9 <trap+0x121>
80106d0d:	8b 04 85 b0 8f 10 80 	mov    -0x7fef7050(,%eax,4),%eax
80106d14:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106d16:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106d1c:	0f b6 00             	movzbl (%eax),%eax
80106d1f:	84 c0                	test   %al,%al
80106d21:	75 31                	jne    80106d54 <trap+0xac>
      acquire(&tickslock);
80106d23:	c7 04 24 e0 5d 11 80 	movl   $0x80115de0,(%esp)
80106d2a:	e8 aa e5 ff ff       	call   801052d9 <acquire>
      ticks++;
80106d2f:	a1 20 66 11 80       	mov    0x80116620,%eax
80106d34:	83 c0 01             	add    $0x1,%eax
80106d37:	a3 20 66 11 80       	mov    %eax,0x80116620
      wakeup(&ticks);
80106d3c:	c7 04 24 20 66 11 80 	movl   $0x80116620,(%esp)
80106d43:	e8 bb e0 ff ff       	call   80104e03 <wakeup>
      release(&tickslock);
80106d48:	c7 04 24 e0 5d 11 80 	movl   $0x80115de0,(%esp)
80106d4f:	e8 e7 e5 ff ff       	call   8010533b <release>
    }
    lapiceoi();
80106d54:	e8 2d c2 ff ff       	call   80102f86 <lapiceoi>
    break;
80106d59:	e9 41 01 00 00       	jmp    80106e9f <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106d5e:	e8 31 ba ff ff       	call   80102794 <ideintr>
    lapiceoi();
80106d63:	e8 1e c2 ff ff       	call   80102f86 <lapiceoi>
    break;
80106d68:	e9 32 01 00 00       	jmp    80106e9f <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106d6d:	e8 e3 bf ff ff       	call   80102d55 <kbdintr>
    lapiceoi();
80106d72:	e8 0f c2 ff ff       	call   80102f86 <lapiceoi>
    break;
80106d77:	e9 23 01 00 00       	jmp    80106e9f <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106d7c:	e8 97 03 00 00       	call   80107118 <uartintr>
    lapiceoi();
80106d81:	e8 00 c2 ff ff       	call   80102f86 <lapiceoi>
    break;
80106d86:	e9 14 01 00 00       	jmp    80106e9f <trap+0x1f7>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106d8b:	8b 45 08             	mov    0x8(%ebp),%eax
80106d8e:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80106d91:	8b 45 08             	mov    0x8(%ebp),%eax
80106d94:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106d98:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106d9b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106da1:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106da4:	0f b6 c0             	movzbl %al,%eax
80106da7:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106dab:	89 54 24 08          	mov    %edx,0x8(%esp)
80106daf:	89 44 24 04          	mov    %eax,0x4(%esp)
80106db3:	c7 04 24 10 8f 10 80 	movl   $0x80108f10,(%esp)
80106dba:	e8 e1 95 ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106dbf:	e8 c2 c1 ff ff       	call   80102f86 <lapiceoi>
    break;
80106dc4:	e9 d6 00 00 00       	jmp    80106e9f <trap+0x1f7>
...
80106dd1:	74 11                	je     80106de4 <trap+0x13c>
...
80106de2:	75 46                	jne    80106e2a <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106de4:	e8 1e fd ff ff       	call   80106b07 <rcr2>
80106de9:	8b 55 08             	mov    0x8(%ebp),%edx
80106dec:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106def:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106df6:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106df9:	0f b6 ca             	movzbl %dl,%ecx
80106dfc:	8b 55 08             	mov    0x8(%ebp),%edx
80106dff:	8b 52 30             	mov    0x30(%edx),%edx
80106e02:	89 44 24 10          	mov    %eax,0x10(%esp)
80106e06:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106e0a:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106e0e:	89 54 24 04          	mov    %edx,0x4(%esp)
80106e12:	c7 04 24 34 8f 10 80 	movl   $0x80108f34,(%esp)
80106e19:	e8 82 95 ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106e1e:	c7 04 24 66 8f 10 80 	movl   $0x80108f66,(%esp)
80106e25:	e8 10 97 ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e2a:	e8 d8 fc ff ff       	call   80106b07 <rcr2>
80106e2f:	89 c2                	mov    %eax,%edx
80106e31:	8b 45 08             	mov    0x8(%ebp),%eax
80106e34:	8b 78 38             	mov    0x38(%eax),%edi
...
80106e3d:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e40:	0f b6 f0             	movzbl %al,%esi
80106e43:	8b 45 08             	mov    0x8(%ebp),%eax
80106e46:	8b 58 34             	mov    0x34(%eax),%ebx
80106e49:	8b 45 08             	mov    0x8(%ebp),%eax
80106e4c:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e4f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e55:	83 c0 78             	add    $0x78,%eax
...
80106e5b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e61:	8b 40 10             	mov    0x10(%eax),%eax
80106e64:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106e68:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106e6c:	89 74 24 14          	mov    %esi,0x14(%esp)
80106e70:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106e74:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106e78:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106e7b:	89 74 24 08          	mov    %esi,0x8(%esp)
80106e7f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e83:	c7 04 24 6c 8f 10 80 	movl   $0x80108f6c,(%esp)
80106e8a:	e8 11 95 ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106e8f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e95:	c7 40 30 01 00 00 00 	movl   $0x1,0x30(%eax)
80106e9c:	eb 01                	jmp    80106e9f <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106ea7:	74 24                	je     80106ecd <trap+0x225>
80106ea9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106eaf:	8b 40 30             	mov    0x30(%eax),%eax
80106eb2:	85 c0                	test   %eax,%eax
80106eb4:	74 17                	je     80106ecd <trap+0x225>
80106eb6:	8b 45 08             	mov    0x8(%ebp),%eax
80106eb9:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106ebd:	0f b7 c0             	movzwl %ax,%eax
80106ec0:	83 e0 03             	and    $0x3,%eax
80106ec3:	83 f8 03             	cmp    $0x3,%eax
80106ec6:	75 05                	jne    80106ecd <trap+0x225>
    exit();
80106ec8:	e8 78 da ff ff       	call   80104945 <exit>
...
80106ed5:	74 1e                	je     80106ef5 <trap+0x24d>
80106ed7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106edd:	8b 40 0c             	mov    0xc(%eax),%eax
80106ee0:	83 f8 04             	cmp    $0x4,%eax
80106ee3:	75 10                	jne    80106ef5 <trap+0x24d>
80106ee5:	8b 45 08             	mov    0x8(%ebp),%eax
80106ee8:	8b 40 30             	mov    0x30(%eax),%eax
80106eeb:	83 f8 20             	cmp    $0x20,%eax
80106eee:	75 05                	jne    80106ef5 <trap+0x24d>
    yield();
80106ef0:	e8 a3 dd ff ff       	call   80104c98 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106ef5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106efb:	85 c0                	test   %eax,%eax
80106efd:	74 24                	je     80106f23 <trap+0x27b>
80106eff:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f05:	8b 40 30             	mov    0x30(%eax),%eax
80106f08:	85 c0                	test   %eax,%eax
80106f0a:	74 17                	je     80106f23 <trap+0x27b>
80106f0c:	8b 45 08             	mov    0x8(%ebp),%eax
80106f0f:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106f13:	0f b7 c0             	movzwl %ax,%eax
80106f16:	83 e0 03             	and    $0x3,%eax
80106f19:	83 f8 03             	cmp    $0x3,%eax
80106f1c:	75 05                	jne    80106f23 <trap+0x27b>
    exit();
80106f1e:	e8 22 da ff ff       	call   80104945 <exit>
}
80106f23:	83 c4 3c             	add    $0x3c,%esp
80106f26:	5b                   	pop    %ebx
80106f27:	5e                   	pop    %esi
80106f28:	5f                   	pop    %edi
80106f29:	5d                   	pop    %ebp
...
80106f2e:	83 ec 14             	sub    $0x14,%esp
80106f31:	8b 45 08             	mov    0x8(%ebp),%eax
80106f34:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106f38:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106f3c:	89 c2                	mov    %eax,%edx
80106f3e:	ec                   	in     (%dx),%al
80106f3f:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106f42:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106f46:	c9                   	leave  
80106f47:	c3                   	ret    
...
80106f54:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106f58:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106f5b:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106f5f:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106f63:	ee                   	out    %al,(%dx)
}
80106f64:	c9                   	leave  
80106f65:	c3                   	ret    
...
80106f69:	83 ec 28             	sub    $0x28,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
80106f6c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106f73:	00 
80106f74:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106f7b:	e8 c8 ff ff ff       	call   80106f48 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106f80:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106f87:	00 
80106f88:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106f8f:	e8 b4 ff ff ff       	call   80106f48 <outb>
  outb(COM1+0, 115200/9600);
80106f94:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106f9b:	00 
80106f9c:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106fa3:	e8 a0 ff ff ff       	call   80106f48 <outb>
  outb(COM1+1, 0);
80106fa8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106faf:	00 
80106fb0:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106fb7:	e8 8c ff ff ff       	call   80106f48 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106fbc:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106fc3:	00 
80106fc4:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106fcb:	e8 78 ff ff ff       	call   80106f48 <outb>
  outb(COM1+4, 0);
80106fd0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106fd7:	00 
80106fd8:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106fdf:	e8 64 ff ff ff       	call   80106f48 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106fe4:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106feb:	00 
80106fec:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106ff3:	e8 50 ff ff ff       	call   80106f48 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106ff8:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106fff:	e8 27 ff ff ff       	call   80106f2b <inb>
80107004:	3c ff                	cmp    $0xff,%al
80107006:	75 02                	jne    8010700a <uartinit+0xa4>
    return;
80107008:	eb 6a                	jmp    80107074 <uartinit+0x10e>
  uart = 1;
8010700a:	c7 05 6c c6 10 80 01 	movl   $0x1,0x8010c66c
80107011:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107014:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010701b:	e8 0b ff ff ff       	call   80106f2b <inb>
  inb(COM1+0);
80107020:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107027:	e8 ff fe ff ff       	call   80106f2b <inb>
  picenable(IRQ_COM1);
8010702c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107033:	e8 23 ce ff ff       	call   80103e5b <picenable>
  ioapicenable(IRQ_COM1, 0);
80107038:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010703f:	00 
80107040:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107047:	e8 c7 b9 ff ff       	call   80102a13 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010704c:	c7 45 f4 30 90 10 80 	movl   $0x80109030,-0xc(%ebp)
80107053:	eb 15                	jmp    8010706a <uartinit+0x104>
    uartputc(*p);
...
80107061:	e8 10 00 00 00       	call   80107076 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80107072:	75 e1                	jne    80107055 <uartinit+0xef>
    uartputc(*p);
}
80107074:	c9                   	leave  
80107075:	c3                   	ret    
...
80107079:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
8010707c:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
80107081:	85 c0                	test   %eax,%eax
80107083:	75 02                	jne    80107087 <uartputc+0x11>
    return;
80107085:	eb 4b                	jmp    801070d2 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107087:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010708e:	eb 10                	jmp    801070a0 <uartputc+0x2a>
    microdelay(10);
80107090:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80107097:	e8 0f bf ff ff       	call   80102fab <microdelay>
{
  int i;
...
801070a0:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801070a4:	7f 16                	jg     801070bc <uartputc+0x46>
801070a6:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801070ad:	e8 79 fe ff ff       	call   80106f2b <inb>
801070b2:	0f b6 c0             	movzbl %al,%eax
801070b5:	83 e0 20             	and    $0x20,%eax
801070b8:	85 c0                	test   %eax,%eax
801070ba:	74 d4                	je     80107090 <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
801070bc:	8b 45 08             	mov    0x8(%ebp),%eax
801070bf:	0f b6 c0             	movzbl %al,%eax
801070c2:	89 44 24 04          	mov    %eax,0x4(%esp)
801070c6:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801070cd:	e8 76 fe ff ff       	call   80106f48 <outb>
}
801070d2:	c9                   	leave  
801070d3:	c3                   	ret    
...
801070e1:	75 07                	jne    801070ea <uartgetc+0x16>
    return -1;
801070e3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801070e8:	eb 2c                	jmp    80107116 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
801070ea:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801070f1:	e8 35 fe ff ff       	call   80106f2b <inb>
801070f6:	0f b6 c0             	movzbl %al,%eax
801070f9:	83 e0 01             	and    $0x1,%eax
801070fc:	85 c0                	test   %eax,%eax
801070fe:	75 07                	jne    80107107 <uartgetc+0x33>
    return -1;
80107100:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107105:	eb 0f                	jmp    80107116 <uartgetc+0x42>
  return inb(COM1+0);
80107107:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010710e:	e8 18 fe ff ff       	call   80106f2b <inb>
...
8010711e:	c7 04 24 d4 70 10 80 	movl   $0x801070d4,(%esp)
80107125:	e8 9e 96 ff ff       	call   801007c8 <consoleintr>
}
8010712a:	c9                   	leave  
8010712b:	c3                   	ret    
...
8010712e:	6a 00                	push   $0x0
  jmp alltraps
80107130:	e9 7e f9 ff ff       	jmp    80106ab3 <alltraps>
...
80107137:	6a 01                	push   $0x1
  jmp alltraps
80107139:	e9 75 f9 ff ff       	jmp    80106ab3 <alltraps>
...
80107140:	6a 02                	push   $0x2
  jmp alltraps
80107142:	e9 6c f9 ff ff       	jmp    80106ab3 <alltraps>
...
80107149:	6a 03                	push   $0x3
  jmp alltraps
8010714b:	e9 63 f9 ff ff       	jmp    80106ab3 <alltraps>
...
80107152:	6a 04                	push   $0x4
  jmp alltraps
80107154:	e9 5a f9 ff ff       	jmp    80106ab3 <alltraps>
...
8010715b:	6a 05                	push   $0x5
  jmp alltraps
8010715d:	e9 51 f9 ff ff       	jmp    80106ab3 <alltraps>
...
80107164:	6a 06                	push   $0x6
  jmp alltraps
80107166:	e9 48 f9 ff ff       	jmp    80106ab3 <alltraps>
...
8010716d:	6a 07                	push   $0x7
  jmp alltraps
8010716f:	e9 3f f9 ff ff       	jmp    80106ab3 <alltraps>
...
80107174:	6a 08                	push   $0x8
  jmp alltraps
80107176:	e9 38 f9 ff ff       	jmp    80106ab3 <alltraps>
...
8010717d:	6a 09                	push   $0x9
  jmp alltraps
8010717f:	e9 2f f9 ff ff       	jmp    80106ab3 <alltraps>
...
80107184:	6a 0a                	push   $0xa
  jmp alltraps
80107186:	e9 28 f9 ff ff       	jmp    80106ab3 <alltraps>
...
8010718b:	6a 0b                	push   $0xb
  jmp alltraps
8010718d:	e9 21 f9 ff ff       	jmp    80106ab3 <alltraps>
...
80107192:	6a 0c                	push   $0xc
  jmp alltraps
80107194:	e9 1a f9 ff ff       	jmp    80106ab3 <alltraps>
...
80107199:	6a 0d                	push   $0xd
  jmp alltraps
8010719b:	e9 13 f9 ff ff       	jmp    80106ab3 <alltraps>
...
801071a0:	6a 0e                	push   $0xe
  jmp alltraps
801071a2:	e9 0c f9 ff ff       	jmp    80106ab3 <alltraps>
...
801071a9:	6a 0f                	push   $0xf
  jmp alltraps
801071ab:	e9 03 f9 ff ff       	jmp    80106ab3 <alltraps>
...
801071b2:	6a 10                	push   $0x10
  jmp alltraps
801071b4:	e9 fa f8 ff ff       	jmp    80106ab3 <alltraps>
...
801071b9:	6a 11                	push   $0x11
  jmp alltraps
801071bb:	e9 f3 f8 ff ff       	jmp    80106ab3 <alltraps>
...
801071c2:	6a 12                	push   $0x12
  jmp alltraps
801071c4:	e9 ea f8 ff ff       	jmp    80106ab3 <alltraps>
...
801071cb:	6a 13                	push   $0x13
  jmp alltraps
801071cd:	e9 e1 f8 ff ff       	jmp    80106ab3 <alltraps>
...
801071d4:	6a 14                	push   $0x14
  jmp alltraps
801071d6:	e9 d8 f8 ff ff       	jmp    80106ab3 <alltraps>
...
801071dd:	6a 15                	push   $0x15
  jmp alltraps
801071df:	e9 cf f8 ff ff       	jmp    80106ab3 <alltraps>
...
801071e6:	6a 16                	push   $0x16
  jmp alltraps
801071e8:	e9 c6 f8 ff ff       	jmp    80106ab3 <alltraps>
...
801071ef:	6a 17                	push   $0x17
  jmp alltraps
801071f1:	e9 bd f8 ff ff       	jmp    80106ab3 <alltraps>
...
801071f8:	6a 18                	push   $0x18
  jmp alltraps
801071fa:	e9 b4 f8 ff ff       	jmp    80106ab3 <alltraps>
...
80107201:	6a 19                	push   $0x19
  jmp alltraps
80107203:	e9 ab f8 ff ff       	jmp    80106ab3 <alltraps>
...
8010720a:	6a 1a                	push   $0x1a
  jmp alltraps
8010720c:	e9 a2 f8 ff ff       	jmp    80106ab3 <alltraps>
...
80107213:	6a 1b                	push   $0x1b
  jmp alltraps
80107215:	e9 99 f8 ff ff       	jmp    80106ab3 <alltraps>
...
8010721c:	6a 1c                	push   $0x1c
  jmp alltraps
8010721e:	e9 90 f8 ff ff       	jmp    80106ab3 <alltraps>
...
80107225:	6a 1d                	push   $0x1d
  jmp alltraps
80107227:	e9 87 f8 ff ff       	jmp    80106ab3 <alltraps>
...
8010722e:	6a 1e                	push   $0x1e
  jmp alltraps
80107230:	e9 7e f8 ff ff       	jmp    80106ab3 <alltraps>
...
80107237:	6a 1f                	push   $0x1f
  jmp alltraps
80107239:	e9 75 f8 ff ff       	jmp    80106ab3 <alltraps>
...
80107240:	6a 20                	push   $0x20
  jmp alltraps
80107242:	e9 6c f8 ff ff       	jmp    80106ab3 <alltraps>
...
80107249:	6a 21                	push   $0x21
  jmp alltraps
8010724b:	e9 63 f8 ff ff       	jmp    80106ab3 <alltraps>
...
80107252:	6a 22                	push   $0x22
  jmp alltraps
80107254:	e9 5a f8 ff ff       	jmp    80106ab3 <alltraps>
...
8010725b:	6a 23                	push   $0x23
  jmp alltraps
8010725d:	e9 51 f8 ff ff       	jmp    80106ab3 <alltraps>
...
80107264:	6a 24                	push   $0x24
  jmp alltraps
80107266:	e9 48 f8 ff ff       	jmp    80106ab3 <alltraps>
...
8010726d:	6a 25                	push   $0x25
  jmp alltraps
8010726f:	e9 3f f8 ff ff       	jmp    80106ab3 <alltraps>
...
80107276:	6a 26                	push   $0x26
  jmp alltraps
80107278:	e9 36 f8 ff ff       	jmp    80106ab3 <alltraps>
...
8010727f:	6a 27                	push   $0x27
  jmp alltraps
80107281:	e9 2d f8 ff ff       	jmp    80106ab3 <alltraps>
...
80107288:	6a 28                	push   $0x28
  jmp alltraps
8010728a:	e9 24 f8 ff ff       	jmp    80106ab3 <alltraps>
...
80107291:	6a 29                	push   $0x29
  jmp alltraps
80107293:	e9 1b f8 ff ff       	jmp    80106ab3 <alltraps>
...
8010729a:	6a 2a                	push   $0x2a
  jmp alltraps
8010729c:	e9 12 f8 ff ff       	jmp    80106ab3 <alltraps>
...
801072a3:	6a 2b                	push   $0x2b
  jmp alltraps
801072a5:	e9 09 f8 ff ff       	jmp    80106ab3 <alltraps>
...
801072ac:	6a 2c                	push   $0x2c
  jmp alltraps
801072ae:	e9 00 f8 ff ff       	jmp    80106ab3 <alltraps>
...
801072b5:	6a 2d                	push   $0x2d
  jmp alltraps
801072b7:	e9 f7 f7 ff ff       	jmp    80106ab3 <alltraps>
...
801072be:	6a 2e                	push   $0x2e
  jmp alltraps
801072c0:	e9 ee f7 ff ff       	jmp    80106ab3 <alltraps>
...
801072c7:	6a 2f                	push   $0x2f
  jmp alltraps
801072c9:	e9 e5 f7 ff ff       	jmp    80106ab3 <alltraps>
...
801072d0:	6a 30                	push   $0x30
  jmp alltraps
801072d2:	e9 dc f7 ff ff       	jmp    80106ab3 <alltraps>
...
801072d9:	6a 31                	push   $0x31
  jmp alltraps
801072db:	e9 d3 f7 ff ff       	jmp    80106ab3 <alltraps>
...
801072e2:	6a 32                	push   $0x32
  jmp alltraps
801072e4:	e9 ca f7 ff ff       	jmp    80106ab3 <alltraps>
...
801072eb:	6a 33                	push   $0x33
  jmp alltraps
801072ed:	e9 c1 f7 ff ff       	jmp    80106ab3 <alltraps>
...
801072f4:	6a 34                	push   $0x34
  jmp alltraps
801072f6:	e9 b8 f7 ff ff       	jmp    80106ab3 <alltraps>
...
801072fd:	6a 35                	push   $0x35
  jmp alltraps
801072ff:	e9 af f7 ff ff       	jmp    80106ab3 <alltraps>
...
80107306:	6a 36                	push   $0x36
  jmp alltraps
80107308:	e9 a6 f7 ff ff       	jmp    80106ab3 <alltraps>
...
8010730f:	6a 37                	push   $0x37
  jmp alltraps
80107311:	e9 9d f7 ff ff       	jmp    80106ab3 <alltraps>
...
80107318:	6a 38                	push   $0x38
  jmp alltraps
8010731a:	e9 94 f7 ff ff       	jmp    80106ab3 <alltraps>
...
80107321:	6a 39                	push   $0x39
  jmp alltraps
80107323:	e9 8b f7 ff ff       	jmp    80106ab3 <alltraps>
...
8010732a:	6a 3a                	push   $0x3a
  jmp alltraps
8010732c:	e9 82 f7 ff ff       	jmp    80106ab3 <alltraps>
...
80107333:	6a 3b                	push   $0x3b
  jmp alltraps
80107335:	e9 79 f7 ff ff       	jmp    80106ab3 <alltraps>
...
8010733c:	6a 3c                	push   $0x3c
  jmp alltraps
8010733e:	e9 70 f7 ff ff       	jmp    80106ab3 <alltraps>
...
80107345:	6a 3d                	push   $0x3d
  jmp alltraps
80107347:	e9 67 f7 ff ff       	jmp    80106ab3 <alltraps>
...
8010734e:	6a 3e                	push   $0x3e
  jmp alltraps
80107350:	e9 5e f7 ff ff       	jmp    80106ab3 <alltraps>
...
80107357:	6a 3f                	push   $0x3f
  jmp alltraps
80107359:	e9 55 f7 ff ff       	jmp    80106ab3 <alltraps>
...
80107360:	6a 40                	push   $0x40
  jmp alltraps
80107362:	e9 4c f7 ff ff       	jmp    80106ab3 <alltraps>
...
80107369:	6a 41                	push   $0x41
  jmp alltraps
8010736b:	e9 43 f7 ff ff       	jmp    80106ab3 <alltraps>
...
80107372:	6a 42                	push   $0x42
  jmp alltraps
80107374:	e9 3a f7 ff ff       	jmp    80106ab3 <alltraps>
...
8010737b:	6a 43                	push   $0x43
  jmp alltraps
8010737d:	e9 31 f7 ff ff       	jmp    80106ab3 <alltraps>
...
80107384:	6a 44                	push   $0x44
  jmp alltraps
80107386:	e9 28 f7 ff ff       	jmp    80106ab3 <alltraps>
...
8010738d:	6a 45                	push   $0x45
  jmp alltraps
8010738f:	e9 1f f7 ff ff       	jmp    80106ab3 <alltraps>
...
80107396:	6a 46                	push   $0x46
  jmp alltraps
80107398:	e9 16 f7 ff ff       	jmp    80106ab3 <alltraps>
...
8010739f:	6a 47                	push   $0x47
  jmp alltraps
801073a1:	e9 0d f7 ff ff       	jmp    80106ab3 <alltraps>
...
801073a8:	6a 48                	push   $0x48
  jmp alltraps
801073aa:	e9 04 f7 ff ff       	jmp    80106ab3 <alltraps>
...
801073b1:	6a 49                	push   $0x49
  jmp alltraps
801073b3:	e9 fb f6 ff ff       	jmp    80106ab3 <alltraps>
...
801073ba:	6a 4a                	push   $0x4a
  jmp alltraps
801073bc:	e9 f2 f6 ff ff       	jmp    80106ab3 <alltraps>
...
801073c3:	6a 4b                	push   $0x4b
  jmp alltraps
801073c5:	e9 e9 f6 ff ff       	jmp    80106ab3 <alltraps>
...
801073cc:	6a 4c                	push   $0x4c
  jmp alltraps
801073ce:	e9 e0 f6 ff ff       	jmp    80106ab3 <alltraps>
...
801073d5:	6a 4d                	push   $0x4d
  jmp alltraps
801073d7:	e9 d7 f6 ff ff       	jmp    80106ab3 <alltraps>
...
801073de:	6a 4e                	push   $0x4e
  jmp alltraps
801073e0:	e9 ce f6 ff ff       	jmp    80106ab3 <alltraps>
...
801073e7:	6a 4f                	push   $0x4f
  jmp alltraps
801073e9:	e9 c5 f6 ff ff       	jmp    80106ab3 <alltraps>
...
801073f0:	6a 50                	push   $0x50
  jmp alltraps
801073f2:	e9 bc f6 ff ff       	jmp    80106ab3 <alltraps>
...
801073f9:	6a 51                	push   $0x51
  jmp alltraps
801073fb:	e9 b3 f6 ff ff       	jmp    80106ab3 <alltraps>
...
80107402:	6a 52                	push   $0x52
  jmp alltraps
80107404:	e9 aa f6 ff ff       	jmp    80106ab3 <alltraps>
...
8010740b:	6a 53                	push   $0x53
  jmp alltraps
8010740d:	e9 a1 f6 ff ff       	jmp    80106ab3 <alltraps>
...
80107414:	6a 54                	push   $0x54
  jmp alltraps
80107416:	e9 98 f6 ff ff       	jmp    80106ab3 <alltraps>
...
8010741d:	6a 55                	push   $0x55
  jmp alltraps
8010741f:	e9 8f f6 ff ff       	jmp    80106ab3 <alltraps>
...
80107426:	6a 56                	push   $0x56
  jmp alltraps
80107428:	e9 86 f6 ff ff       	jmp    80106ab3 <alltraps>
...
8010742f:	6a 57                	push   $0x57
  jmp alltraps
80107431:	e9 7d f6 ff ff       	jmp    80106ab3 <alltraps>
...
80107438:	6a 58                	push   $0x58
  jmp alltraps
8010743a:	e9 74 f6 ff ff       	jmp    80106ab3 <alltraps>
...
80107441:	6a 59                	push   $0x59
  jmp alltraps
80107443:	e9 6b f6 ff ff       	jmp    80106ab3 <alltraps>
...
8010744a:	6a 5a                	push   $0x5a
  jmp alltraps
8010744c:	e9 62 f6 ff ff       	jmp    80106ab3 <alltraps>
...
80107453:	6a 5b                	push   $0x5b
  jmp alltraps
80107455:	e9 59 f6 ff ff       	jmp    80106ab3 <alltraps>
...
8010745c:	6a 5c                	push   $0x5c
  jmp alltraps
8010745e:	e9 50 f6 ff ff       	jmp    80106ab3 <alltraps>
...
80107465:	6a 5d                	push   $0x5d
  jmp alltraps
80107467:	e9 47 f6 ff ff       	jmp    80106ab3 <alltraps>
...
8010746e:	6a 5e                	push   $0x5e
  jmp alltraps
80107470:	e9 3e f6 ff ff       	jmp    80106ab3 <alltraps>
...
80107477:	6a 5f                	push   $0x5f
  jmp alltraps
80107479:	e9 35 f6 ff ff       	jmp    80106ab3 <alltraps>
...
80107480:	6a 60                	push   $0x60
  jmp alltraps
80107482:	e9 2c f6 ff ff       	jmp    80106ab3 <alltraps>
...
80107489:	6a 61                	push   $0x61
  jmp alltraps
8010748b:	e9 23 f6 ff ff       	jmp    80106ab3 <alltraps>
...
80107492:	6a 62                	push   $0x62
  jmp alltraps
80107494:	e9 1a f6 ff ff       	jmp    80106ab3 <alltraps>
...
8010749b:	6a 63                	push   $0x63
  jmp alltraps
8010749d:	e9 11 f6 ff ff       	jmp    80106ab3 <alltraps>
...
801074a4:	6a 64                	push   $0x64
  jmp alltraps
801074a6:	e9 08 f6 ff ff       	jmp    80106ab3 <alltraps>
...
801074ad:	6a 65                	push   $0x65
  jmp alltraps
801074af:	e9 ff f5 ff ff       	jmp    80106ab3 <alltraps>
...
801074b6:	6a 66                	push   $0x66
  jmp alltraps
801074b8:	e9 f6 f5 ff ff       	jmp    80106ab3 <alltraps>
...
801074bf:	6a 67                	push   $0x67
  jmp alltraps
801074c1:	e9 ed f5 ff ff       	jmp    80106ab3 <alltraps>
...
801074c8:	6a 68                	push   $0x68
  jmp alltraps
801074ca:	e9 e4 f5 ff ff       	jmp    80106ab3 <alltraps>
...
801074d1:	6a 69                	push   $0x69
  jmp alltraps
801074d3:	e9 db f5 ff ff       	jmp    80106ab3 <alltraps>
...
801074da:	6a 6a                	push   $0x6a
  jmp alltraps
801074dc:	e9 d2 f5 ff ff       	jmp    80106ab3 <alltraps>
...
801074e3:	6a 6b                	push   $0x6b
  jmp alltraps
801074e5:	e9 c9 f5 ff ff       	jmp    80106ab3 <alltraps>
...
801074ec:	6a 6c                	push   $0x6c
  jmp alltraps
801074ee:	e9 c0 f5 ff ff       	jmp    80106ab3 <alltraps>
...
801074f5:	6a 6d                	push   $0x6d
  jmp alltraps
801074f7:	e9 b7 f5 ff ff       	jmp    80106ab3 <alltraps>
...
801074fe:	6a 6e                	push   $0x6e
  jmp alltraps
80107500:	e9 ae f5 ff ff       	jmp    80106ab3 <alltraps>
...
80107507:	6a 6f                	push   $0x6f
  jmp alltraps
80107509:	e9 a5 f5 ff ff       	jmp    80106ab3 <alltraps>
...
80107510:	6a 70                	push   $0x70
  jmp alltraps
80107512:	e9 9c f5 ff ff       	jmp    80106ab3 <alltraps>
...
80107519:	6a 71                	push   $0x71
  jmp alltraps
8010751b:	e9 93 f5 ff ff       	jmp    80106ab3 <alltraps>
...
80107522:	6a 72                	push   $0x72
  jmp alltraps
80107524:	e9 8a f5 ff ff       	jmp    80106ab3 <alltraps>
...
8010752b:	6a 73                	push   $0x73
  jmp alltraps
8010752d:	e9 81 f5 ff ff       	jmp    80106ab3 <alltraps>
...
80107534:	6a 74                	push   $0x74
  jmp alltraps
80107536:	e9 78 f5 ff ff       	jmp    80106ab3 <alltraps>
...
8010753d:	6a 75                	push   $0x75
  jmp alltraps
8010753f:	e9 6f f5 ff ff       	jmp    80106ab3 <alltraps>
...
80107546:	6a 76                	push   $0x76
  jmp alltraps
80107548:	e9 66 f5 ff ff       	jmp    80106ab3 <alltraps>
...
8010754f:	6a 77                	push   $0x77
  jmp alltraps
80107551:	e9 5d f5 ff ff       	jmp    80106ab3 <alltraps>
...
80107558:	6a 78                	push   $0x78
  jmp alltraps
8010755a:	e9 54 f5 ff ff       	jmp    80106ab3 <alltraps>
...
80107561:	6a 79                	push   $0x79
  jmp alltraps
80107563:	e9 4b f5 ff ff       	jmp    80106ab3 <alltraps>
...
8010756a:	6a 7a                	push   $0x7a
  jmp alltraps
8010756c:	e9 42 f5 ff ff       	jmp    80106ab3 <alltraps>
...
80107573:	6a 7b                	push   $0x7b
  jmp alltraps
80107575:	e9 39 f5 ff ff       	jmp    80106ab3 <alltraps>
...
8010757c:	6a 7c                	push   $0x7c
  jmp alltraps
8010757e:	e9 30 f5 ff ff       	jmp    80106ab3 <alltraps>
...
80107585:	6a 7d                	push   $0x7d
  jmp alltraps
80107587:	e9 27 f5 ff ff       	jmp    80106ab3 <alltraps>
...
8010758e:	6a 7e                	push   $0x7e
  jmp alltraps
80107590:	e9 1e f5 ff ff       	jmp    80106ab3 <alltraps>
...
80107597:	6a 7f                	push   $0x7f
  jmp alltraps
80107599:	e9 15 f5 ff ff       	jmp    80106ab3 <alltraps>
...
801075a0:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801075a5:	e9 09 f5 ff ff       	jmp    80106ab3 <alltraps>
...
801075ac:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801075b1:	e9 fd f4 ff ff       	jmp    80106ab3 <alltraps>
...
801075b8:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801075bd:	e9 f1 f4 ff ff       	jmp    80106ab3 <alltraps>
...
801075c4:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801075c9:	e9 e5 f4 ff ff       	jmp    80106ab3 <alltraps>
...
801075d0:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801075d5:	e9 d9 f4 ff ff       	jmp    80106ab3 <alltraps>
...
801075dc:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801075e1:	e9 cd f4 ff ff       	jmp    80106ab3 <alltraps>
...
801075e8:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801075ed:	e9 c1 f4 ff ff       	jmp    80106ab3 <alltraps>
...
801075f4:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801075f9:	e9 b5 f4 ff ff       	jmp    80106ab3 <alltraps>
...
80107600:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107605:	e9 a9 f4 ff ff       	jmp    80106ab3 <alltraps>
...
8010760c:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107611:	e9 9d f4 ff ff       	jmp    80106ab3 <alltraps>
...
80107618:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010761d:	e9 91 f4 ff ff       	jmp    80106ab3 <alltraps>
...
80107624:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107629:	e9 85 f4 ff ff       	jmp    80106ab3 <alltraps>
...
80107630:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107635:	e9 79 f4 ff ff       	jmp    80106ab3 <alltraps>
...
8010763c:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107641:	e9 6d f4 ff ff       	jmp    80106ab3 <alltraps>
...
80107648:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010764d:	e9 61 f4 ff ff       	jmp    80106ab3 <alltraps>
...
80107654:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107659:	e9 55 f4 ff ff       	jmp    80106ab3 <alltraps>
...
80107660:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107665:	e9 49 f4 ff ff       	jmp    80106ab3 <alltraps>
...
8010766c:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107671:	e9 3d f4 ff ff       	jmp    80106ab3 <alltraps>
...
80107678:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010767d:	e9 31 f4 ff ff       	jmp    80106ab3 <alltraps>
...
80107684:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107689:	e9 25 f4 ff ff       	jmp    80106ab3 <alltraps>
...
80107690:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107695:	e9 19 f4 ff ff       	jmp    80106ab3 <alltraps>
...
8010769c:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801076a1:	e9 0d f4 ff ff       	jmp    80106ab3 <alltraps>
...
801076a8:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801076ad:	e9 01 f4 ff ff       	jmp    80106ab3 <alltraps>
...
801076b4:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801076b9:	e9 f5 f3 ff ff       	jmp    80106ab3 <alltraps>
...
801076c0:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801076c5:	e9 e9 f3 ff ff       	jmp    80106ab3 <alltraps>
...
801076cc:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801076d1:	e9 dd f3 ff ff       	jmp    80106ab3 <alltraps>
...
801076d8:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801076dd:	e9 d1 f3 ff ff       	jmp    80106ab3 <alltraps>
...
801076e4:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801076e9:	e9 c5 f3 ff ff       	jmp    80106ab3 <alltraps>
...
801076f0:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801076f5:	e9 b9 f3 ff ff       	jmp    80106ab3 <alltraps>
...
801076fc:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107701:	e9 ad f3 ff ff       	jmp    80106ab3 <alltraps>
...
80107708:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010770d:	e9 a1 f3 ff ff       	jmp    80106ab3 <alltraps>
...
80107714:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107719:	e9 95 f3 ff ff       	jmp    80106ab3 <alltraps>
...
80107720:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107725:	e9 89 f3 ff ff       	jmp    80106ab3 <alltraps>
...
8010772c:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107731:	e9 7d f3 ff ff       	jmp    80106ab3 <alltraps>
...
80107738:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010773d:	e9 71 f3 ff ff       	jmp    80106ab3 <alltraps>
...
80107744:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107749:	e9 65 f3 ff ff       	jmp    80106ab3 <alltraps>
...
80107750:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107755:	e9 59 f3 ff ff       	jmp    80106ab3 <alltraps>
...
8010775c:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107761:	e9 4d f3 ff ff       	jmp    80106ab3 <alltraps>
...
80107768:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010776d:	e9 41 f3 ff ff       	jmp    80106ab3 <alltraps>
...
80107774:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107779:	e9 35 f3 ff ff       	jmp    80106ab3 <alltraps>
...
80107780:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107785:	e9 29 f3 ff ff       	jmp    80106ab3 <alltraps>
...
8010778c:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107791:	e9 1d f3 ff ff       	jmp    80106ab3 <alltraps>
...
80107798:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010779d:	e9 11 f3 ff ff       	jmp    80106ab3 <alltraps>
...
801077a4:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801077a9:	e9 05 f3 ff ff       	jmp    80106ab3 <alltraps>
...
801077b0:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801077b5:	e9 f9 f2 ff ff       	jmp    80106ab3 <alltraps>
...
801077bc:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801077c1:	e9 ed f2 ff ff       	jmp    80106ab3 <alltraps>
...
801077c8:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801077cd:	e9 e1 f2 ff ff       	jmp    80106ab3 <alltraps>
...
801077d4:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801077d9:	e9 d5 f2 ff ff       	jmp    80106ab3 <alltraps>
...
801077e0:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801077e5:	e9 c9 f2 ff ff       	jmp    80106ab3 <alltraps>
...
801077ec:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801077f1:	e9 bd f2 ff ff       	jmp    80106ab3 <alltraps>
...
801077f8:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801077fd:	e9 b1 f2 ff ff       	jmp    80106ab3 <alltraps>
...
80107804:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107809:	e9 a5 f2 ff ff       	jmp    80106ab3 <alltraps>
...
80107810:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107815:	e9 99 f2 ff ff       	jmp    80106ab3 <alltraps>
...
8010781c:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107821:	e9 8d f2 ff ff       	jmp    80106ab3 <alltraps>
...
80107828:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010782d:	e9 81 f2 ff ff       	jmp    80106ab3 <alltraps>
...
80107834:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107839:	e9 75 f2 ff ff       	jmp    80106ab3 <alltraps>
...
80107840:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107845:	e9 69 f2 ff ff       	jmp    80106ab3 <alltraps>
...
8010784c:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107851:	e9 5d f2 ff ff       	jmp    80106ab3 <alltraps>
...
80107858:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010785d:	e9 51 f2 ff ff       	jmp    80106ab3 <alltraps>
...
80107864:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107869:	e9 45 f2 ff ff       	jmp    80106ab3 <alltraps>
...
80107870:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107875:	e9 39 f2 ff ff       	jmp    80106ab3 <alltraps>
...
8010787c:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107881:	e9 2d f2 ff ff       	jmp    80106ab3 <alltraps>
...
80107888:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010788d:	e9 21 f2 ff ff       	jmp    80106ab3 <alltraps>
...
80107894:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107899:	e9 15 f2 ff ff       	jmp    80106ab3 <alltraps>
...
801078a0:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801078a5:	e9 09 f2 ff ff       	jmp    80106ab3 <alltraps>
...
801078ac:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801078b1:	e9 fd f1 ff ff       	jmp    80106ab3 <alltraps>
...
801078b8:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801078bd:	e9 f1 f1 ff ff       	jmp    80106ab3 <alltraps>
...
801078c4:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801078c9:	e9 e5 f1 ff ff       	jmp    80106ab3 <alltraps>
...
801078d0:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801078d5:	e9 d9 f1 ff ff       	jmp    80106ab3 <alltraps>
...
801078dc:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801078e1:	e9 cd f1 ff ff       	jmp    80106ab3 <alltraps>
...
801078e8:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801078ed:	e9 c1 f1 ff ff       	jmp    80106ab3 <alltraps>
...
801078f4:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801078f9:	e9 b5 f1 ff ff       	jmp    80106ab3 <alltraps>
...
80107900:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107905:	e9 a9 f1 ff ff       	jmp    80106ab3 <alltraps>
...
8010790c:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107911:	e9 9d f1 ff ff       	jmp    80106ab3 <alltraps>
...
80107918:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010791d:	e9 91 f1 ff ff       	jmp    80106ab3 <alltraps>
...
80107924:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107929:	e9 85 f1 ff ff       	jmp    80106ab3 <alltraps>
...
80107930:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107935:	e9 79 f1 ff ff       	jmp    80106ab3 <alltraps>
...
8010793c:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107941:	e9 6d f1 ff ff       	jmp    80106ab3 <alltraps>
...
80107948:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010794d:	e9 61 f1 ff ff       	jmp    80106ab3 <alltraps>
...
80107954:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107959:	e9 55 f1 ff ff       	jmp    80106ab3 <alltraps>
...
80107960:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107965:	e9 49 f1 ff ff       	jmp    80106ab3 <alltraps>
...
8010796c:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107971:	e9 3d f1 ff ff       	jmp    80106ab3 <alltraps>
...
80107978:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010797d:	e9 31 f1 ff ff       	jmp    80106ab3 <alltraps>
...
80107984:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107989:	e9 25 f1 ff ff       	jmp    80106ab3 <alltraps>
...
80107990:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107995:	e9 19 f1 ff ff       	jmp    80106ab3 <alltraps>
...
8010799c:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801079a1:	e9 0d f1 ff ff       	jmp    80106ab3 <alltraps>
...
801079a8:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801079ad:	e9 01 f1 ff ff       	jmp    80106ab3 <alltraps>
...
801079b4:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801079b9:	e9 f5 f0 ff ff       	jmp    80106ab3 <alltraps>
...
801079c0:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801079c5:	e9 e9 f0 ff ff       	jmp    80106ab3 <alltraps>
...
801079cc:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801079d1:	e9 dd f0 ff ff       	jmp    80106ab3 <alltraps>
...
801079d8:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801079dd:	e9 d1 f0 ff ff       	jmp    80106ab3 <alltraps>
...
801079e4:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801079e9:	e9 c5 f0 ff ff       	jmp    80106ab3 <alltraps>
...
801079f0:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801079f5:	e9 b9 f0 ff ff       	jmp    80106ab3 <alltraps>
...
801079fc:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107a01:	e9 ad f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a08:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107a0d:	e9 a1 f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a14:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107a19:	e9 95 f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a20:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107a25:	e9 89 f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a2c:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107a31:	e9 7d f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a38:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107a3d:	e9 71 f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a44:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107a49:	e9 65 f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a50:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107a55:	e9 59 f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a5c:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107a61:	e9 4d f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a68:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107a6d:	e9 41 f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a74:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107a79:	e9 35 f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a80:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107a85:	e9 29 f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a8c:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107a91:	e9 1d f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107a98:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107a9d:	e9 11 f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107aa4:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107aa9:	e9 05 f0 ff ff       	jmp    80106ab3 <alltraps>
...
80107ab0:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107ab5:	e9 f9 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107abc:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107ac1:	e9 ed ef ff ff       	jmp    80106ab3 <alltraps>
...
80107ac8:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107acd:	e9 e1 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107ad4:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107ad9:	e9 d5 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107ae0:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107ae5:	e9 c9 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107aec:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107af1:	e9 bd ef ff ff       	jmp    80106ab3 <alltraps>
...
80107af8:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107afd:	e9 b1 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b04:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107b09:	e9 a5 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b10:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107b15:	e9 99 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b1c:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107b21:	e9 8d ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b28:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107b2d:	e9 81 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b34:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107b39:	e9 75 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b40:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107b45:	e9 69 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b4c:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107b51:	e9 5d ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b58:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107b5d:	e9 51 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b64:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107b69:	e9 45 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b70:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107b75:	e9 39 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b7c:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107b81:	e9 2d ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b88:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107b8d:	e9 21 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107b94:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107b99:	e9 15 ef ff ff       	jmp    80106ab3 <alltraps>
...
80107ba1:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107ba4:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ba7:	83 e8 01             	sub    $0x1,%eax
...
80107bd0:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107bd4:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107bd8:	0f 00 d8             	ltr    %ax
}
80107bdb:	c9                   	leave  
80107bdc:	c3                   	ret    
...
80107c1b:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107c1e:	e8 0b b3 ff ff       	call   80102f2e <cpunum>
...
80107f94:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107f9a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f9d:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107fa4:	83 e1 f0             	and    $0xfffffff0,%ecx
80107fa7:	83 c9 02             	or     $0x2,%ecx
80107faa:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107fb0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb3:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107fba:	83 c9 10             	or     $0x10,%ecx
80107fbd:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107fc3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc6:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107fcd:	83 e1 9f             	and    $0xffffff9f,%ecx
80107fd0:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107fd6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fd9:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107fe0:	83 c9 80             	or     $0xffffff80,%ecx
80107fe3:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107fe9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fec:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107ff3:	83 e1 f0             	and    $0xfffffff0,%ecx
80107ff6:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107ffc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fff:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108006:	83 e1 ef             	and    $0xffffffef,%ecx
80108009:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010800f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108012:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108019:	83 e1 df             	and    $0xffffffdf,%ecx
8010801c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108022:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108025:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010802c:	83 c9 40             	or     $0x40,%ecx
8010802f:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108035:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108038:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010803f:	83 c9 80             	or     $0xffffff80,%ecx
80108042:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108048:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010804b:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80108051:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108054:	83 c0 70             	add    $0x70,%eax
80108057:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
8010805e:	00 
8010805f:	89 04 24             	mov    %eax,(%esp)
80108062:	e8 37 fb ff ff       	call   80107b9e <lgdt>
  loadgs(SEG_KCPU << 3);
80108067:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
8010806e:	e8 6a fb ff ff       	call   80107bdd <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80108073:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108076:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
8010807c:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80108083:	00 00 00 00 
}
80108087:	83 c4 24             	add    $0x24,%esp
8010808a:	5b                   	pop    %ebx
8010808b:	5d                   	pop    %ebp
8010808c:	c3                   	ret    
...
801080ad:	83 e0 01             	and    $0x1,%eax
801080b0:	85 c0                	test   %eax,%eax
801080b2:	74 17                	je     801080cb <walkpgdir+0x3e>
...
801080c1:	e8 44 fb ff ff       	call   80107c0a <p2v>
801080c6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801080c9:	eb 4b                	jmp    80108116 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801080cb:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801080cf:	74 0e                	je     801080df <walkpgdir+0x52>
801080d1:	e8 c2 aa ff ff       	call   80102b98 <kalloc>
801080d6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801080d9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801080dd:	75 07                	jne    801080e6 <walkpgdir+0x59>
      return 0;
801080df:	b8 00 00 00 00       	mov    $0x0,%eax
801080e4:	eb 47                	jmp    8010812d <walkpgdir+0xa0>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801080e6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801080ed:	00 
801080ee:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801080f5:	00 
801080f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080f9:	89 04 24             	mov    %eax,(%esp)
801080fc:	e8 2c d4 ff ff       	call   8010552d <memset>
...
80108107:	e8 f1 fa ff ff       	call   80107bfd <v2p>
8010810c:	83 c8 07             	or     $0x7,%eax
8010810f:	89 c2                	mov    %eax,%edx
80108111:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108114:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80108116:	8b 45 0c             	mov    0xc(%ebp),%eax
80108119:	c1 e8 0c             	shr    $0xc,%eax
8010811c:	25 ff 03 00 00       	and    $0x3ff,%eax
80108121:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80108132:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80108148:	83 e8 01             	sub    $0x1,%eax
8010814b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108150:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80108153:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
8010815a:	00 
8010815b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010815e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108162:	8b 45 08             	mov    0x8(%ebp),%eax
80108165:	89 04 24             	mov    %eax,(%esp)
80108168:	e8 20 ff ff ff       	call   8010808d <walkpgdir>
8010816d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108170:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108174:	75 07                	jne    8010817d <mappages+0x4e>
      return -1;
80108176:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010817b:	eb 48                	jmp    801081c5 <mappages+0x96>
    if(*pte & PTE_P)
8010817d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108180:	8b 00                	mov    (%eax),%eax
80108182:	83 e0 01             	and    $0x1,%eax
80108185:	85 c0                	test   %eax,%eax
80108187:	74 0c                	je     80108195 <mappages+0x66>
      panic("remap");
80108189:	c7 04 24 38 90 10 80 	movl   $0x80109038,(%esp)
80108190:	e8 a5 83 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
80108195:	8b 45 18             	mov    0x18(%ebp),%eax
80108198:	0b 45 14             	or     0x14(%ebp),%eax
8010819b:	83 c8 01             	or     $0x1,%eax
8010819e:	89 c2                	mov    %eax,%edx
801081a0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081a3:	89 10                	mov    %edx,(%eax)
    if(a == last)
801081a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081a8:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801081ab:	75 08                	jne    801081b5 <mappages+0x86>
      break;
801081ad:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
801081b3:	eb 10                	jmp    801081c5 <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
...
801081c3:	eb 8e                	jmp    80108153 <mappages+0x24>
  return 0;
}
801081c5:	c9                   	leave  
801081c6:	c3                   	ret    
...
801081ca:	53                   	push   %ebx
801081cb:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
801081ce:	e8 c5 a9 ff ff       	call   80102b98 <kalloc>
801081d3:	89 45 f0             	mov    %eax,-0x10(%ebp)
801081d6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801081da:	75 0a                	jne    801081e6 <setupkvm+0x1f>
    return 0;
801081dc:	b8 00 00 00 00       	mov    $0x0,%eax
801081e1:	e9 98 00 00 00       	jmp    8010827e <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
801081e6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801081ed:	00 
801081ee:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801081f5:	00 
801081f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081f9:	89 04 24             	mov    %eax,(%esp)
801081fc:	e8 2c d3 ff ff       	call   8010552d <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80108201:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108208:	e8 fd f9 ff ff       	call   80107c0a <p2v>
8010820d:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80108212:	76 0c                	jbe    80108220 <setupkvm+0x59>
    panic("PHYSTOP too high");
80108214:	c7 04 24 3e 90 10 80 	movl   $0x8010903e,(%esp)
8010821b:	e8 1a 83 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108220:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
80108227:	eb 49                	jmp    80108272 <setupkvm+0xab>
...
8010825e:	e8 cc fe ff ff       	call   8010812f <mappages>
80108263:	85 c0                	test   %eax,%eax
80108265:	79 07                	jns    8010826e <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80108267:	b8 00 00 00 00       	mov    $0x0,%eax
8010826c:	eb 10                	jmp    8010827e <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010826e:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80108272:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
80108279:	72 ae                	jb     80108229 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
8010827e:	83 c4 34             	add    $0x34,%esp
80108281:	5b                   	pop    %ebx
80108282:	5d                   	pop    %ebp
80108283:	c3                   	ret    
...
80108287:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
8010828a:	e8 38 ff ff ff       	call   801081c7 <setupkvm>
8010828f:	a3 78 66 11 80       	mov    %eax,0x80116678
  switchkvm();
80108294:	e8 02 00 00 00       	call   8010829b <switchkvm>
}
80108299:	c9                   	leave  
8010829a:	c3                   	ret    
...
801082a1:	a1 78 66 11 80       	mov    0x80116678,%eax
801082a6:	89 04 24             	mov    %eax,(%esp)
801082a9:	e8 4f f9 ff ff       	call   80107bfd <v2p>
801082ae:	89 04 24             	mov    %eax,(%esp)
801082b1:	e8 3c f9 ff ff       	call   80107bf2 <lcr3>
}
801082b6:	c9                   	leave  
801082b7:	c3                   	ret    
...
801082bc:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801082bf:	e8 69 d1 ff ff       	call   8010542d <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
801082c4:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801082ca:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801082d1:	83 c2 08             	add    $0x8,%edx
801082d4:	89 d3                	mov    %edx,%ebx
801082d6:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801082dd:	83 c2 08             	add    $0x8,%edx
801082e0:	c1 ea 10             	shr    $0x10,%edx
801082e3:	89 d1                	mov    %edx,%ecx
801082e5:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801082ec:	83 c2 08             	add    $0x8,%edx
801082ef:	c1 ea 18             	shr    $0x18,%edx
801082f2:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
801082f9:	67 00 
801082fb:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80108302:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108308:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010830f:	83 e1 f0             	and    $0xfffffff0,%ecx
80108312:	83 c9 09             	or     $0x9,%ecx
80108315:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010831b:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108322:	83 c9 10             	or     $0x10,%ecx
80108325:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010832b:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108332:	83 e1 9f             	and    $0xffffff9f,%ecx
80108335:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010833b:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108342:	83 c9 80             	or     $0xffffff80,%ecx
80108345:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010834b:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108352:	83 e1 f0             	and    $0xfffffff0,%ecx
80108355:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010835b:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108362:	83 e1 ef             	and    $0xffffffef,%ecx
80108365:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010836b:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108372:	83 e1 df             	and    $0xffffffdf,%ecx
80108375:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010837b:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108382:	83 c9 40             	or     $0x40,%ecx
80108385:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010838b:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108392:	83 e1 7f             	and    $0x7f,%ecx
80108395:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010839b:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
...
801083b7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801083bd:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
801083c3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801083c9:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801083d0:	8b 52 08             	mov    0x8(%edx),%edx
801083d3:	81 c2 00 10 00 00    	add    $0x1000,%edx
801083d9:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
801083dc:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
801083e3:	e8 df f7 ff ff       	call   80107bc7 <ltr>
  if(p->pgdir == 0)
801083e8:	8b 45 08             	mov    0x8(%ebp),%eax
801083eb:	8b 40 04             	mov    0x4(%eax),%eax
801083ee:	85 c0                	test   %eax,%eax
801083f0:	75 0c                	jne    801083fe <switchuvm+0x146>
    panic("switchuvm: no pgdir");
801083f2:	c7 04 24 4f 90 10 80 	movl   $0x8010904f,(%esp)
801083f9:	e8 3c 81 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
801083fe:	8b 45 08             	mov    0x8(%ebp),%eax
80108401:	8b 40 04             	mov    0x4(%eax),%eax
80108404:	89 04 24             	mov    %eax,(%esp)
80108407:	e8 f1 f7 ff ff       	call   80107bfd <v2p>
8010840c:	89 04 24             	mov    %eax,(%esp)
8010840f:	e8 de f7 ff ff       	call   80107bf2 <lcr3>
  popcli();
80108414:	e8 58 d0 ff ff       	call   80105471 <popcli>
}
80108419:	83 c4 14             	add    $0x14,%esp
8010841c:	5b                   	pop    %ebx
8010841d:	5d                   	pop    %ebp
8010841e:	c3                   	ret    
...
80108422:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80108425:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
8010842c:	76 0c                	jbe    8010843a <inituvm+0x1b>
    panic("inituvm: more than a page");
8010842e:	c7 04 24 63 90 10 80 	movl   $0x80109063,(%esp)
80108435:	e8 00 81 ff ff       	call   8010053a <panic>
  mem = kalloc();
8010843a:	e8 59 a7 ff ff       	call   80102b98 <kalloc>
8010843f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80108442:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108449:	00 
8010844a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108451:	00 
80108452:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108455:	89 04 24             	mov    %eax,(%esp)
80108458:	e8 d0 d0 ff ff       	call   8010552d <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
8010845d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108460:	89 04 24             	mov    %eax,(%esp)
80108463:	e8 95 f7 ff ff       	call   80107bfd <v2p>
80108468:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010846f:	00 
80108470:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108474:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010847b:	00 
8010847c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108483:	00 
80108484:	8b 45 08             	mov    0x8(%ebp),%eax
80108487:	89 04 24             	mov    %eax,(%esp)
8010848a:	e8 a0 fc ff ff       	call   8010812f <mappages>
  memmove(mem, init, sz);
8010848f:	8b 45 10             	mov    0x10(%ebp),%eax
80108492:	89 44 24 08          	mov    %eax,0x8(%esp)
80108496:	8b 45 0c             	mov    0xc(%ebp),%eax
80108499:	89 44 24 04          	mov    %eax,0x4(%esp)
8010849d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084a0:	89 04 24             	mov    %eax,(%esp)
801084a3:	e8 54 d1 ff ff       	call   801055fc <memmove>
}
801084a8:	c9                   	leave  
801084a9:	c3                   	ret    
...
{
801084aa:	55                   	push   %ebp
801084ab:	89 e5                	mov    %esp,%ebp
801084ad:	53                   	push   %ebx
801084ae:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
801084b1:	8b 45 0c             	mov    0xc(%ebp),%eax
801084b4:	25 ff 0f 00 00       	and    $0xfff,%eax
801084b9:	85 c0                	test   %eax,%eax
801084bb:	74 0c                	je     801084c9 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
801084bd:	c7 04 24 80 90 10 80 	movl   $0x80109080,(%esp)
801084c4:	e8 71 80 ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
801084c9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801084d0:	e9 a9 00 00 00       	jmp    8010857e <loaduvm+0xd4>
...
801084e4:	00 
801084e5:	89 44 24 04          	mov    %eax,0x4(%esp)
801084e9:	8b 45 08             	mov    0x8(%ebp),%eax
801084ec:	89 04 24             	mov    %eax,(%esp)
801084ef:	e8 99 fb ff ff       	call   8010808d <walkpgdir>
801084f4:	89 45 ec             	mov    %eax,-0x14(%ebp)
801084f7:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801084fb:	75 0c                	jne    80108509 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
801084fd:	c7 04 24 a3 90 10 80 	movl   $0x801090a3,(%esp)
80108504:	e8 31 80 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
80108509:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010850c:	8b 00                	mov    (%eax),%eax
8010850e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108513:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108516:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108519:	8b 55 18             	mov    0x18(%ebp),%edx
8010851c:	29 c2                	sub    %eax,%edx
8010851e:	89 d0                	mov    %edx,%eax
80108520:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108525:	77 0f                	ja     80108536 <loaduvm+0x8c>
      n = sz - i;
80108527:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010852a:	8b 55 18             	mov    0x18(%ebp),%edx
8010852d:	29 c2                	sub    %eax,%edx
8010852f:	89 d0                	mov    %edx,%eax
80108531:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108534:	eb 07                	jmp    8010853d <loaduvm+0x93>
    else
      n = PGSIZE;
80108536:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
8010853d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108540:	8b 55 14             	mov    0x14(%ebp),%edx
80108543:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108546:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108549:	89 04 24             	mov    %eax,(%esp)
8010854c:	e8 b9 f6 ff ff       	call   80107c0a <p2v>
80108551:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108554:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108558:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010855c:	89 44 24 04          	mov    %eax,0x4(%esp)
80108560:	8b 45 10             	mov    0x10(%ebp),%eax
80108563:	89 04 24             	mov    %eax,(%esp)
80108566:	e8 7c 98 ff ff       	call   80101de7 <readi>
8010856b:	3b 45 f0             	cmp    -0x10(%ebp),%eax
8010856e:	74 07                	je     80108577 <loaduvm+0xcd>
      return -1;
80108570:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108575:	eb 18                	jmp    8010858f <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80108577:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010857e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108581:	3b 45 18             	cmp    0x18(%ebp),%eax
80108584:	0f 82 4b ff ff ff    	jb     801084d5 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
  ...
  return 0;
8010858a:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010858f:	83 c4 24             	add    $0x24,%esp
80108592:	5b                   	pop    %ebx
80108593:	5d                   	pop    %ebp
80108594:	c3                   	ret    
...
80108598:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;

  if(newsz >= KERNBASE)
8010859b:	8b 45 10             	mov    0x10(%ebp),%eax
8010859e:	85 c0                	test   %eax,%eax
801085a0:	79 0a                	jns    801085ac <allocuvm+0x17>
    return 0;
801085a2:	b8 00 00 00 00       	mov    $0x0,%eax
801085a7:	e9 c1 00 00 00       	jmp    8010866d <allocuvm+0xd8>
  if(newsz < oldsz)
801085ac:	8b 45 10             	mov    0x10(%ebp),%eax
801085af:	3b 45 0c             	cmp    0xc(%ebp),%eax
801085b2:	73 08                	jae    801085bc <allocuvm+0x27>
    return oldsz;
801085b4:	8b 45 0c             	mov    0xc(%ebp),%eax
801085b7:	e9 b1 00 00 00       	jmp    8010866d <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
801085bc:	8b 45 0c             	mov    0xc(%ebp),%eax
801085bf:	05 ff 0f 00 00       	add    $0xfff,%eax
801085c4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801085c9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
801085cc:	e9 8d 00 00 00       	jmp    8010865e <allocuvm+0xc9>
    mem = kalloc();
801085d1:	e8 c2 a5 ff ff       	call   80102b98 <kalloc>
801085d6:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
801085d9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801085dd:	75 2c                	jne    8010860b <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
801085df:	c7 04 24 c1 90 10 80 	movl   $0x801090c1,(%esp)
801085e6:	e8 b5 7d ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801085eb:	8b 45 0c             	mov    0xc(%ebp),%eax
801085ee:	89 44 24 08          	mov    %eax,0x8(%esp)
801085f2:	8b 45 10             	mov    0x10(%ebp),%eax
801085f5:	89 44 24 04          	mov    %eax,0x4(%esp)
801085f9:	8b 45 08             	mov    0x8(%ebp),%eax
801085fc:	89 04 24             	mov    %eax,(%esp)
801085ff:	e8 6b 00 00 00       	call   8010866f <deallocuvm>
      return 0;
80108604:	b8 00 00 00 00       	mov    $0x0,%eax
80108609:	eb 62                	jmp    8010866d <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
8010860b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108612:	00 
80108613:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010861a:	00 
8010861b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010861e:	89 04 24             	mov    %eax,(%esp)
80108621:	e8 07 cf ff ff       	call   8010552d <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108626:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108629:	89 04 24             	mov    %eax,(%esp)
8010862c:	e8 cc f5 ff ff       	call   80107bfd <v2p>
80108631:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108634:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010863b:	00 
8010863c:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108640:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108647:	00 
80108648:	89 54 24 04          	mov    %edx,0x4(%esp)
8010864c:	8b 45 08             	mov    0x8(%ebp),%eax
8010864f:	89 04 24             	mov    %eax,(%esp)
80108652:	e8 d8 fa ff ff       	call   8010812f <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80108664:	0f 82 67 ff ff ff    	jb     801085d1 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80108672:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
80108680:	e9 a4 00 00 00       	jmp    80108729 <deallocuvm+0xba>
...
80108695:	e9 80 00 00 00       	jmp    8010871a <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010869a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010869d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801086a4:	00 
801086a5:	89 44 24 04          	mov    %eax,0x4(%esp)
801086a9:	8b 45 08             	mov    0x8(%ebp),%eax
801086ac:	89 04 24             	mov    %eax,(%esp)
801086af:	e8 d9 f9 ff ff       	call   8010808d <walkpgdir>
801086b4:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801086b7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801086bb:	75 09                	jne    801086c6 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801086bd:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
801086c4:	eb 4d                	jmp    80108713 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
801086c6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801086c9:	8b 00                	mov    (%eax),%eax
801086cb:	83 e0 01             	and    $0x1,%eax
801086ce:	85 c0                	test   %eax,%eax
801086d0:	74 41                	je     80108713 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
801086d2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801086d5:	8b 00                	mov    (%eax),%eax
801086d7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801086dc:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
801086df:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801086e3:	75 0c                	jne    801086f1 <deallocuvm+0x82>
        panic("kfree");
801086e5:	c7 04 24 d9 90 10 80 	movl   $0x801090d9,(%esp)
801086ec:	e8 49 7e ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
801086f1:	8b 45 ec             	mov    -0x14(%ebp),%eax
801086f4:	89 04 24             	mov    %eax,(%esp)
801086f7:	e8 0e f5 ff ff       	call   80107c0a <p2v>
801086fc:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
801086ff:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108702:	89 04 24             	mov    %eax,(%esp)
80108705:	e8 f5 a3 ff ff       	call   80102aff <kfree>
      *pte = 0;
...
8010870d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80108713:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010871a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010871d:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108720:	0f 82 74 ff ff ff    	jb     8010869a <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
8010872e:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80108731:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108735:	75 0c                	jne    80108743 <freevm+0x18>
    panic("freevm: no pgdir");
80108737:	c7 04 24 df 90 10 80 	movl   $0x801090df,(%esp)
8010873e:	e8 f7 7d ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108743:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010874a:	00 
8010874b:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108752:	80 
80108753:	8b 45 08             	mov    0x8(%ebp),%eax
80108756:	89 04 24             	mov    %eax,(%esp)
80108759:	e8 11 ff ff ff       	call   8010866f <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010875e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108765:	eb 48                	jmp    801087af <freevm+0x84>
    if(pgdir[i] & PTE_P){
80108767:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010876a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80108771:	8b 45 08             	mov    0x8(%ebp),%eax
80108774:	01 d0                	add    %edx,%eax
80108776:	8b 00                	mov    (%eax),%eax
80108778:	83 e0 01             	and    $0x1,%eax
8010877b:	85 c0                	test   %eax,%eax
8010877d:	74 2c                	je     801087ab <freevm+0x80>
      char * v = p2v(PTE_ADDR(pgdir[i]));
8010877f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108782:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80108798:	e8 6d f4 ff ff       	call   80107c0a <p2v>
8010879d:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
801087a0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801087a3:	89 04 24             	mov    %eax,(%esp)
801087a6:	e8 54 a3 ff ff       	call   80102aff <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801087ab:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801087af:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801087b6:	76 af                	jbe    80108767 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801087be:	e8 3c a3 ff ff       	call   80102aff <kfree>
}
801087c3:	c9                   	leave  
801087c4:	c3                   	ret    
...
801087c8:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
801087e0:	e8 a8 f8 ff ff       	call   8010808d <walkpgdir>
801087e5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
801087e8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801087ec:	75 0c                	jne    801087fa <clearpteu+0x35>
    panic("clearpteu");
801087ee:	c7 04 24 f0 90 10 80 	movl   $0x801090f0,(%esp)
801087f5:	e8 40 7d ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
801087fa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087fd:	8b 00                	mov    (%eax),%eax
801087ff:	83 e0 fb             	and    $0xfffffffb,%eax
80108802:	89 c2                	mov    %eax,%edx
80108804:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108807:	89 10                	mov    %edx,(%eax)
}
80108809:	c9                   	leave  
8010880a:	c3                   	ret    
...
8010880f:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108812:	e8 b0 f9 ff ff       	call   801081c7 <setupkvm>
80108817:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010881a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010881e:	75 0a                	jne    8010882a <copyuvm+0x1f>
    return 0;
80108820:	b8 00 00 00 00       	mov    $0x0,%eax
80108825:	e9 fd 00 00 00       	jmp    80108927 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
8010882a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108831:	e9 d0 00 00 00       	jmp    80108906 <copyuvm+0xfb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108836:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108839:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108840:	00 
80108841:	89 44 24 04          	mov    %eax,0x4(%esp)
80108845:	8b 45 08             	mov    0x8(%ebp),%eax
80108848:	89 04 24             	mov    %eax,(%esp)
8010884b:	e8 3d f8 ff ff       	call   8010808d <walkpgdir>
80108850:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108853:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108857:	75 0c                	jne    80108865 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108859:	c7 04 24 fa 90 10 80 	movl   $0x801090fa,(%esp)
80108860:	e8 d5 7c ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
80108865:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108868:	8b 00                	mov    (%eax),%eax
8010886a:	83 e0 01             	and    $0x1,%eax
8010886d:	85 c0                	test   %eax,%eax
8010886f:	75 0c                	jne    8010887d <copyuvm+0x72>
      panic("copyuvm: page not present");
80108871:	c7 04 24 14 91 10 80 	movl   $0x80109114,(%esp)
80108878:	e8 bd 7c ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
8010887d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108880:	8b 00                	mov    (%eax),%eax
80108882:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108887:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
8010888a:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010888d:	8b 00                	mov    (%eax),%eax
8010888f:	25 ff 0f 00 00       	and    $0xfff,%eax
80108894:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108897:	e8 fc a2 ff ff       	call   80102b98 <kalloc>
8010889c:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010889f:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801088a3:	75 02                	jne    801088a7 <copyuvm+0x9c>
      goto bad;
801088a5:	eb 70                	jmp    80108917 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
801088a7:	8b 45 e8             	mov    -0x18(%ebp),%eax
801088aa:	89 04 24             	mov    %eax,(%esp)
801088ad:	e8 58 f3 ff ff       	call   80107c0a <p2v>
801088b2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801088b9:	00 
801088ba:	89 44 24 04          	mov    %eax,0x4(%esp)
801088be:	8b 45 e0             	mov    -0x20(%ebp),%eax
801088c1:	89 04 24             	mov    %eax,(%esp)
801088c4:	e8 33 cd ff ff       	call   801055fc <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
801088c9:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801088cc:	8b 45 e0             	mov    -0x20(%ebp),%eax
801088cf:	89 04 24             	mov    %eax,(%esp)
801088d2:	e8 26 f3 ff ff       	call   80107bfd <v2p>
801088d7:	8b 55 f4             	mov    -0xc(%ebp),%edx
801088da:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801088de:	89 44 24 0c          	mov    %eax,0xc(%esp)
801088e2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801088e9:	00 
801088ea:	89 54 24 04          	mov    %edx,0x4(%esp)
801088ee:	8b 45 f0             	mov    -0x10(%ebp),%eax
801088f1:	89 04 24             	mov    %eax,(%esp)
801088f4:	e8 36 f8 ff ff       	call   8010812f <mappages>
801088f9:	85 c0                	test   %eax,%eax
801088fb:	79 02                	jns    801088ff <copyuvm+0xf4>
      goto bad;
801088fd:	eb 18                	jmp    80108917 <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801088ff:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108906:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108909:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010890c:	0f 82 24 ff ff ff    	jb     80108836 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108915:	eb 10                	jmp    80108927 <copyuvm+0x11c>

bad:
  freevm(d);
80108917:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010891a:	89 04 24             	mov    %eax,(%esp)
8010891d:	e8 09 fe ff ff       	call   8010872b <freevm>
  return 0;
80108922:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108927:	83 c4 44             	add    $0x44,%esp
8010892a:	5b                   	pop    %ebx
8010892b:	5d                   	pop    %ebp
8010892c:	c3                   	ret    
...
80108930:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108933:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010893a:	00 
8010893b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010893e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108942:	8b 45 08             	mov    0x8(%ebp),%eax
80108945:	89 04 24             	mov    %eax,(%esp)
80108948:	e8 40 f7 ff ff       	call   8010808d <walkpgdir>
8010894d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108950:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108953:	8b 00                	mov    (%eax),%eax
80108955:	83 e0 01             	and    $0x1,%eax
80108958:	85 c0                	test   %eax,%eax
8010895a:	75 07                	jne    80108963 <uva2ka+0x36>
    return 0;
8010895c:	b8 00 00 00 00       	mov    $0x0,%eax
80108961:	eb 25                	jmp    80108988 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108963:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108966:	8b 00                	mov    (%eax),%eax
80108968:	83 e0 04             	and    $0x4,%eax
8010896b:	85 c0                	test   %eax,%eax
8010896d:	75 07                	jne    80108976 <uva2ka+0x49>
    return 0;
8010896f:	b8 00 00 00 00       	mov    $0x0,%eax
80108974:	eb 12                	jmp    80108988 <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
80108976:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108979:	8b 00                	mov    (%eax),%eax
8010897b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108980:	89 04 24             	mov    %eax,(%esp)
80108983:	e8 82 f2 ff ff       	call   80107c0a <p2v>
}
80108988:	c9                   	leave  
80108989:	c3                   	ret    
...
{
8010898a:	55                   	push   %ebp
8010898b:	89 e5                	mov    %esp,%ebp
8010898d:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
80108993:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108996:	e9 87 00 00 00       	jmp    80108a22 <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
8010899b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010899e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801089a3:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
801089a6:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089a9:	89 44 24 04          	mov    %eax,0x4(%esp)
801089ad:	8b 45 08             	mov    0x8(%ebp),%eax
801089b0:	89 04 24             	mov    %eax,(%esp)
801089b3:	e8 75 ff ff ff       	call   8010892d <uva2ka>
801089b8:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801089bb:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801089bf:	75 07                	jne    801089c8 <copyout+0x3e>
      return -1;
801089c1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801089c6:	eb 69                	jmp    80108a31 <copyout+0xa7>
    n = PGSIZE - (va - va0);
801089c8:	8b 45 0c             	mov    0xc(%ebp),%eax
801089cb:	8b 55 ec             	mov    -0x14(%ebp),%edx
801089ce:	29 c2                	sub    %eax,%edx
801089d0:	89 d0                	mov    %edx,%eax
801089d2:	05 00 10 00 00       	add    $0x1000,%eax
801089d7:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801089da:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089dd:	3b 45 14             	cmp    0x14(%ebp),%eax
801089e0:	76 06                	jbe    801089e8 <copyout+0x5e>
      n = len;
801089e2:	8b 45 14             	mov    0x14(%ebp),%eax
801089e5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
801089e8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089eb:	8b 55 0c             	mov    0xc(%ebp),%edx
801089ee:	29 c2                	sub    %eax,%edx
801089f0:	8b 45 e8             	mov    -0x18(%ebp),%eax
801089f3:	01 c2                	add    %eax,%edx
801089f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089f8:	89 44 24 08          	mov    %eax,0x8(%esp)
801089fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80108a03:	89 14 24             	mov    %edx,(%esp)
80108a06:	e8 f1 cb ff ff       	call   801055fc <memmove>
    len -= n;
80108a0b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a0e:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108a11:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a14:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108a17:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a1a:	05 00 10 00 00       	add    $0x1000,%eax
80108a1f:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108a22:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108a26:	0f 85 6f ff ff ff    	jne    8010899b <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
