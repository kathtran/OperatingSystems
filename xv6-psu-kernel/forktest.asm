...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  2f:	c7 44 24 04 60 04 00 	movl   $0x460,0x4(%esp)
  36:	00 
  ...
  62:	e8 16 03 00 00       	call   37d <exit>
{
  ...
  84:	00 
  85:	c7 44 24 04 6c 04 00 	movl   $0x46c,0x4(%esp)
  8c:	00 
  ...
  a9:	c7 44 24 04 8b 04 00 	movl   $0x48b,0x4(%esp)
  b0:	00 
  ...
  d6:	c7 44 24 04 9f 04 00 	movl   $0x49f,0x4(%esp)
  dd:	00 
  ...
  ef:	c7 44 24 04 b2 04 00 	movl   $0x4b2,0x4(%esp)
  f6:	00 
